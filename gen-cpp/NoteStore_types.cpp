...
std::ostream& operator<<(std::ostream& out, const ShareRelationshipPrivilegeLevel::type& val) {
  std::map<int, const char*>::const_iterator it = _ShareRelationshipPrivilegeLevel_VALUES_TO_NAMES.find(val);
  if (it != _ShareRelationshipPrivilegeLevel_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
...
void NoteFilter::__set_includeAllReadableWorkspaces(const bool val) {
  this->includeAllReadableWorkspaces = val;
...
void NoteFilter::__set_rawWords(const std::string& val) {
  this->rawWords = val;
__isset.rawWords = true;
}

void NoteFilter::__set_searchContextBytes(const std::string& val) {
  this->searchContextBytes = val;
...
uint32_t NoteFilter::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 15:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->includeAllReadableWorkspaces);
          this->__isset.includeAllReadableWorkspaces = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      ...
      case 11:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->rawWords);
          this->__isset.rawWords = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 12:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->searchContextBytes);
          this->__isset.searchContextBytes = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t NoteFilter::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.rawWords) {
    xfer += oprot->writeFieldBegin("rawWords", ::apache::thrift::protocol::T_STRING, 11);
    xfer += oprot->writeString(this->rawWords);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.searchContextBytes) {
    xfer += oprot->writeFieldBegin("searchContextBytes", ::apache::thrift::protocol::T_STRING, 12);
    xfer += oprot->writeBinary(this->searchContextBytes);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.includeAllReadableWorkspaces) {
    xfer += oprot->writeFieldBegin("includeAllReadableWorkspaces", ::apache::thrift::protocol::T_BOOL, 15);
    xfer += oprot->writeBool(this->includeAllReadableWorkspaces);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(NoteFilter &a, NoteFilter &b) {
  ...
  swap(a.includeAllReadableWorkspaces, b.includeAllReadableWorkspaces);
  swap(a.context, b.context);
  swap(a.rawWords, b.rawWords);
  swap(a.searchContextBytes, b.searchContextBytes);
  swap(a.__isset, b.__isset);
}
...
NoteFilter::NoteFilter(const NoteFilter& other85) {
  ...
  includeAllReadableWorkspaces = other85.includeAllReadableWorkspaces;
  context = other85.context;
  rawWords = other85.rawWords;
  searchContextBytes = other85.searchContextBytes;
...
NoteFilter& NoteFilter::operator=(const NoteFilter& other86) {
  ...
  includeAllReadableWorkspaces = other86.includeAllReadableWorkspaces;
  context = other86.context;
  rawWords = other86.rawWords;
  searchContextBytes = other86.searchContextBytes;
...
void NoteFilter::printTo(std::ostream& out) const {
  ...
  out << ", " << "includeAllReadableWorkspaces="; (__isset.includeAllReadableWorkspaces ? (out << to_string(includeAllReadableWorkspaces)) : (out << "<null>"));
  out << ", " << "context="; (__isset.context ? (out << to_string(context)) : (out << "<null>"));
  out << ", " << "rawWords="; (__isset.rawWords ? (out << to_string(rawWords)) : (out << "<null>"));
  out << ", " << "searchContextBytes="; (__isset.searchContextBytes ? (out << to_string(searchContextBytes)) : (out << "<null>"));
  out << ")";
}
...
void NoteList::__set_searchContextBytes(const std::string& val) {
  this->searchContextBytes = val;
__isset.searchContextBytes = true;
}

void NoteList::__set_debugInfo(const std::string& val) {
  this->debugInfo = val;
...
uint32_t NoteList::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.searchContextBytes) {
    xfer += oprot->writeFieldBegin("searchContextBytes", ::apache::thrift::protocol::T_STRING, 7);
    xfer += oprot->writeBinary(this->searchContextBytes);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.debugInfo) {
    xfer += oprot->writeFieldBegin("debugInfo", ::apache::thrift::protocol::T_STRING, 8);
...
NoteList::NoteList(const NoteList& other105) {
  ...
  searchContextBytes = other105.searchContextBytes;
  debugInfo = other105.debugInfo;
...
NoteList& NoteList::operator=(const NoteList& other106) {
  ...
  searchContextBytes = other106.searchContextBytes;
  debugInfo = other106.debugInfo;
...
void NoteList::printTo(std::ostream& out) const {
  ...
  out << ", " << "searchContextBytes="; (__isset.searchContextBytes ? (out << to_string(searchContextBytes)) : (out << "<null>"));
  out << ", " << "debugInfo="; (__isset.debugInfo ? (out << to_string(debugInfo)) : (out << "<null>"));
  out << ")";
}
...
void NotesMetadataList::__set_searchContextBytes(const std::string& val) {
  this->searchContextBytes = val;
__isset.searchContextBytes = true;
}

void NotesMetadataList::__set_debugInfo(const std::string& val) {
  this->debugInfo = val;
__isset.debugInfo = true;
}
...
uint32_t NotesMetadataList::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.debugInfo) {
    xfer += oprot->writeFieldBegin("debugInfo", ::apache::thrift::protocol::T_STRING, 9);
    xfer += oprot->writeString(this->debugInfo);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
...
NotesMetadataList::NotesMetadataList(const NotesMetadataList& other133) {
  ...
  searchContextBytes = other133.searchContextBytes;
  debugInfo = other133.debugInfo;
...
NotesMetadataList& NotesMetadataList::operator=(const NotesMetadataList& other134) {
  ...
  searchContextBytes = other134.searchContextBytes;
  debugInfo = other134.debugInfo;
...
void RelatedResult::__set_debugInfo(const std::string& val) {
  this->debugInfo = val;
__isset.debugInfo = true;
}
...
void RelatedResultSpec::__set_includeDebugInfo(const bool val) {
  this->includeDebugInfo = val;
...
void swap(RelatedResultSpec &a, RelatedResultSpec &b) {
  ...
  swap(a.includeDebugInfo, b.includeDebugInfo);
...
RelatedResultSpec::RelatedResultSpec(const RelatedResultSpec& other221) {
  ...
  includeDebugInfo = other221.includeDebugInfo;
...
RelatedResultSpec& RelatedResultSpec::operator=(const RelatedResultSpec& other222) {
  ...
  includeDebugInfo = other222.includeDebugInfo;
...
void RelatedResultSpec::printTo(std::ostream& out) const {
  ...
  out << ", " << "includeDebugInfo="; (__isset.includeDebugInfo ? (out << to_string(includeDebugInfo)) : (out << "<null>"));
