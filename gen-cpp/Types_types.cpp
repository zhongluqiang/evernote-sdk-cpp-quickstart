...
int _kPrivilegeLevelValues[] = {
    PrivilegeLevel::NORMAL,  PrivilegeLevel::PREMIUM, PrivilegeLevel::VIP,
    PrivilegeLevel::MANAGER, PrivilegeLevel::SUPPORT, PrivilegeLevel::ADMIN};
const char *_kPrivilegeLevelNames[] = {"NORMAL",  "PREMIUM", "VIP",
                                       "MANAGER", "SUPPORT", "ADMIN"};
const std::map<int, const char *> _PrivilegeLevel_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(6, _kPrivilegeLevelValues,
                                    _kPrivilegeLevelNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const PrivilegeLevel::type &val) {
    std::map<int, const char *>::const_iterator it =
        _PrivilegeLevel_VALUES_TO_NAMES.find(val);
...
int _kServiceLevelValues[] = {ServiceLevel::BASIC, ServiceLevel::PLUS,
                              ServiceLevel::PREMIUM, ServiceLevel::BUSINESS};
const char *_kServiceLevelNames[] = {"BASIC", "PLUS", "PREMIUM", "BUSINESS"};
const std::map<int, const char *> _ServiceLevel_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(4, _kServiceLevelValues,
                                    _kServiceLevelNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const ServiceLevel::type &val) {
    std::map<int, const char *>::const_iterator it =
        _ServiceLevel_VALUES_TO_NAMES.find(val);
    if (it != _ServiceLevel_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kQueryFormatValues[] = {QueryFormat::USER, QueryFormat::SEXP};
const char *_kQueryFormatNames[] = {"USER", "SEXP"};
const std::map<int, const char *> _QueryFormat_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(2, _kQueryFormatValues, _kQueryFormatNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const QueryFormat::type &val) {
    std::map<int, const char *>::const_iterator it =
        _QueryFormat_VALUES_TO_NAMES.find(val);
    if (it != _QueryFormat_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kNoteSortOrderValues[] = {
    NoteSortOrder::CREATED, NoteSortOrder::UPDATED, NoteSortOrder::RELEVANCE,
    NoteSortOrder::UPDATE_SEQUENCE_NUMBER, NoteSortOrder::TITLE};
const char *_kNoteSortOrderNames[] = {"CREATED", "UPDATED", "RELEVANCE",
                                      "UPDATE_SEQUENCE_NUMBER", "TITLE"};
const std::map<int, const char *> _NoteSortOrder_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(5, _kNoteSortOrderValues,
                                    _kNoteSortOrderNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const NoteSortOrder::type &val) {
    std::map<int, const char *>::const_iterator it =
        _NoteSortOrder_VALUES_TO_NAMES.find(val);
    if (it != _NoteSortOrder_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kPremiumOrderStatusValues[] = {PremiumOrderStatus::NONE,
...
const char *_kPremiumOrderStatusNames[] = {
    "NONE", "PENDING", "ACTIVE", "FAILED", "CANCELLATION_PENDING", "CANCELED"};
const std::map<int, const char *> _PremiumOrderStatus_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(6, _kPremiumOrderStatusValues,
                                    _kPremiumOrderStatusNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const PremiumOrderStatus::type &val) {
    std::map<int, const char *>::const_iterator it =
        _PremiumOrderStatus_VALUES_TO_NAMES.find(val);
    if (it != _PremiumOrderStatus_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
const std::map<int, const char *> _SharedNotebookPrivilegeLevel_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(6, _kSharedNotebookPrivilegeLevelValues,
                                    _kSharedNotebookPrivilegeLevelNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const SharedNotebookPrivilegeLevel::type &val) {
    std::map<int, const char *>::const_iterator it =
        _SharedNotebookPrivilegeLevel_VALUES_TO_NAMES.find(val);
    if (it != _SharedNotebookPrivilegeLevel_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kSharedNotePrivilegeLevelValues[] = {
    SharedNotePrivilegeLevel::READ_NOTE, SharedNotePrivilegeLevel::MODIFY_NOTE,
    SharedNotePrivilegeLevel::FULL_ACCESS};
const char *_kSharedNotePrivilegeLevelNames[] = {"READ_NOTE", "MODIFY_NOTE",
                                                 "FULL_ACCESS"};
const std::map<int, const char *> _SharedNotePrivilegeLevel_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kSharedNotePrivilegeLevelValues,
                                    _kSharedNotePrivilegeLevelNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const SharedNotePrivilegeLevel::type &val) {
    std::map<int, const char *>::const_iterator it =
        _SharedNotePrivilegeLevel_VALUES_TO_NAMES.find(val);
    if (it != _SharedNotePrivilegeLevel_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kSponsoredGroupRoleValues[] = {SponsoredGroupRole::GROUP_MEMBER,
                                    SponsoredGroupRole::GROUP_ADMIN,
                                    SponsoredGroupRole::GROUP_OWNER};
const char *_kSponsoredGroupRoleNames[] = {"GROUP_MEMBER", "GROUP_ADMIN",
                                           "GROUP_OWNER"};
const std::map<int, const char *> _SponsoredGroupRole_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kSponsoredGroupRoleValues,
                                    _kSponsoredGroupRoleNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const SponsoredGroupRole::type &val) {
    std::map<int, const char *>::const_iterator it =
        _SponsoredGroupRole_VALUES_TO_NAMES.find(val);
    if (it != _SponsoredGroupRole_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kBusinessUserRoleValues[] = {BusinessUserRole::ADMIN,
                                  BusinessUserRole::NORMAL};
const char *_kBusinessUserRoleNames[] = {"ADMIN", "NORMAL"};
const std::map<int, const char *> _BusinessUserRole_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(2, _kBusinessUserRoleValues,
                                    _kBusinessUserRoleNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const BusinessUserRole::type &val) {
    std::map<int, const char *>::const_iterator it =
        _BusinessUserRole_VALUES_TO_NAMES.find(val);
    if (it != _BusinessUserRole_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kBusinessUserStatusValues[] = {BusinessUserStatus::ACTIVE,
                                    BusinessUserStatus::DEACTIVATED};
const char *_kBusinessUserStatusNames[] = {"ACTIVE", "DEACTIVATED"};
const std::map<int, const char *> _BusinessUserStatus_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(2, _kBusinessUserStatusValues,
                                    _kBusinessUserStatusNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const BusinessUserStatus::type &val) {
    std::map<int, const char *>::const_iterator it =
        _BusinessUserStatus_VALUES_TO_NAMES.find(val);
    if (it != _BusinessUserStatus_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
const char *_kSharedNotebookInstanceRestrictionsNames[] = {
    "ASSIGNED", "NO_SHARED_NOTEBOOKS"};
const std::map<int, const char *>
    _SharedNotebookInstanceRestrictions_VALUES_TO_NAMES(
        ::apache::thrift::TEnumIterator(
            2, _kSharedNotebookInstanceRestrictionsValues,
            _kSharedNotebookInstanceRestrictionsNames),
        ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const SharedNotebookInstanceRestrictions::type &val) {
    std::map<int, const char *>::const_iterator it =
        _SharedNotebookInstanceRestrictions_VALUES_TO_NAMES.find(val);
    if (it != _SharedNotebookInstanceRestrictions_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kReminderEmailConfigValues[] = {ReminderEmailConfig::DO_NOT_SEND,
                                     ReminderEmailConfig::SEND_DAILY_EMAIL};
const char *_kReminderEmailConfigNames[] = {"DO_NOT_SEND", "SEND_DAILY_EMAIL"};
const std::map<int, const char *> _ReminderEmailConfig_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(2, _kReminderEmailConfigValues,
                                    _kReminderEmailConfigNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const ReminderEmailConfig::type &val) {
    std::map<int, const char *>::const_iterator it =
        _ReminderEmailConfig_VALUES_TO_NAMES.find(val);
    if (it != _ReminderEmailConfig_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kBusinessInvitationStatusValues[] = {BusinessInvitationStatus::APPROVED,
                                          BusinessInvitationStatus::REQUESTED,
                                          BusinessInvitationStatus::REDEEMED};
const char *_kBusinessInvitationStatusNames[] = {"APPROVED", "REQUESTED",
                                                 "REDEEMED"};
const std::map<int, const char *> _BusinessInvitationStatus_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kBusinessInvitationStatusValues,
                                    _kBusinessInvitationStatusNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const BusinessInvitationStatus::type &val) {
    std::map<int, const char *>::const_iterator it =
        _BusinessInvitationStatus_VALUES_TO_NAMES.find(val);
    if (it != _BusinessInvitationStatus_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kContactTypeValues[] = {ContactType::EVERNOTE, ContactType::SMS,
                             ContactType::FACEBOOK, ContactType::EMAIL,
                             ContactType::TWITTER,  ContactType::LINKEDIN};
const char *_kContactTypeNames[] = {"EVERNOTE", "SMS",     "FACEBOOK",
                                    "EMAIL",    "TWITTER", "LINKEDIN"};
const std::map<int, const char *> _ContactType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(6, _kContactTypeValues, _kContactTypeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const ContactType::type &val) {
    std::map<int, const char *>::const_iterator it =
        _ContactType_VALUES_TO_NAMES.find(val);
...
int _kEntityTypeValues[] = {EntityType::NOTE, EntityType::NOTEBOOK,
                            EntityType::WORKSPACE};
const char *_kEntityTypeNames[] = {"NOTE", "NOTEBOOK", "WORKSPACE"};
const std::map<int, const char *> _EntityType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kEntityTypeValues, _kEntityTypeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const EntityType::type &val) {
    std::map<int, const char *>::const_iterator it =
        _EntityType_VALUES_TO_NAMES.find(val);
    if (it != _EntityType_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kRecipientStatusValues[] = {
    RecipientStatus::NOT_IN_MY_LIST, RecipientStatus::IN_MY_LIST,
    RecipientStatus::IN_MY_LIST_AND_DEFAULT_NOTEBOOK};
const char *_kRecipientStatusNames[] = {"NOT_IN_MY_LIST", "IN_MY_LIST",
                                        "IN_MY_LIST_AND_DEFAULT_NOTEBOOK"};
const std::map<int, const char *> _RecipientStatus_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kRecipientStatusValues,
                                    _kRecipientStatusNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const RecipientStatus::type &val) {
    std::map<int, const char *>::const_iterator it =
        _RecipientStatus_VALUES_TO_NAMES.find(val);
    if (it != _RecipientStatus_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kCanMoveToContainerStatusValues[] = {
    CanMoveToContainerStatus::CAN_BE_MOVED,
    CanMoveToContainerStatus::INSUFFICIENT_ENTITY_PRIVILEGE,
    CanMoveToContainerStatus::INSUFFICIENT_CONTAINER_PRIVILEGE};
const char *_kCanMoveToContainerStatusNames[] = {
    "CAN_BE_MOVED", "INSUFFICIENT_ENTITY_PRIVILEGE",
    "INSUFFICIENT_CONTAINER_PRIVILEGE"};
const std::map<int, const char *> _CanMoveToContainerStatus_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kCanMoveToContainerStatusValues,
                                    _kCanMoveToContainerStatusNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const CanMoveToContainerStatus::type &val) {
    std::map<int, const char *>::const_iterator it =
        _CanMoveToContainerStatus_VALUES_TO_NAMES.find(val);
    if (it != _CanMoveToContainerStatus_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kRelatedContentTypeValues[] = {RelatedContentType::NEWS_ARTICLE,
                                    RelatedContentType::PROFILE_PERSON,
                                    RelatedContentType::PROFILE_ORGANIZATION,
                                    RelatedContentType::REFERENCE_MATERIAL};
const char *_kRelatedContentTypeNames[] = {"NEWS_ARTICLE", "PROFILE_PERSON",
                                           "PROFILE_ORGANIZATION",
                                           "REFERENCE_MATERIAL"};
const std::map<int, const char *> _RelatedContentType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(4, _kRelatedContentTypeValues,
                                    _kRelatedContentTypeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const RelatedContentType::type &val) {
    std::map<int, const char *>::const_iterator it =
        _RelatedContentType_VALUES_TO_NAMES.find(val);
    if (it != _RelatedContentType_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
const char *_kRelatedContentAccessNames[] = {
    "NOT_ACCESSIBLE", "DIRECT_LINK_ACCESS_OK", "DIRECT_LINK_LOGIN_REQUIRED",
    "DIRECT_LINK_EMBEDDED_VIEW"};
const std::map<int, const char *> _RelatedContentAccess_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(4, _kRelatedContentAccessValues,
                                    _kRelatedContentAccessNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out,
                         const RelatedContentAccess::type &val) {
    std::map<int, const char *>::const_iterator it =
        _RelatedContentAccess_VALUES_TO_NAMES.find(val);
    if (it != _RelatedContentAccess_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
int _kUserIdentityTypeValues[] = {UserIdentityType::EVERNOTE_USERID,
                                  UserIdentityType::EMAIL,
                                  UserIdentityType::IDENTITYID};
const char *_kUserIdentityTypeNames[] = {"EVERNOTE_USERID", "EMAIL",
                                         "IDENTITYID"};
const std::map<int, const char *> _UserIdentityType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kUserIdentityTypeValues,
                                    _kUserIdentityTypeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream &operator<<(std::ostream &out, const UserIdentityType::type &val) {
    std::map<int, const char *>::const_iterator it =
        _UserIdentityType_VALUES_TO_NAMES.find(val);
    if (it != _UserIdentityType_VALUES_TO_NAMES.end()) {
        out << it->second;
    } else {
        out << static_cast<int>(val);
    }
...
void Data::printTo(std::ostream &out) const {
    ...
    out << "Data(";
    out << "bodyHash=";
    (__isset.bodyHash ? (out << to_string(bodyHash)) : (out << "<null>"));
    out << ", "
        << "size=";
    (__isset.size ? (out << to_string(size)) : (out << "<null>"));
    out << ", "
        << "body=";
    (__isset.body ? (out << to_string(body)) : (out << "<null>"));
    out << ")";
}
...
void UserAttributes::__set_viewedPromotions(
...
void UserAttributes::__set_recentMailedAddresses(
    const std::vector<std::string> &val) {
...
void UserAttributes::__set_reminderEmailConfig(
    const ReminderEmailConfig::type val) {
...
void UserAttributes::__set_optOutMachineLearning(const bool val) {
    this->optOutMachineLearning = val;
...
uint32_t UserAttributes::read(::apache::thrift::protocol::TProtocol *iprot) {
    ...
    while (true) {
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    for (_i11 = 0; _i11 < _size7; ++_i11) {
                        xfer += iprot->readString(
                            this->recentMailedAddresses[_i11]);
                    }
                    xfer += iprot->readListEnd();
                }
        ...
        case 39:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->optOutMachineLearning);
                this->__isset.optOutMachineLearning = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
UserAttributes::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.incomingEmailAddress) {
        xfer += oprot->writeFieldBegin("incomingEmailAddress",
                                       ::apache::thrift::protocol::T_STRING, 6);
        xfer += oprot->writeString(this->incomingEmailAddress);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.recentMailedAddresses) {
        xfer += oprot->writeFieldBegin("recentMailedAddresses",
                                       ::apache::thrift::protocol::T_LIST, 7);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->recentMailedAddresses.size()));
            std::vector<std::string>::const_iterator _iter14;
            for (_iter14 = this->recentMailedAddresses.begin();
                 _iter14 != this->recentMailedAddresses.end(); ++_iter14) {
...
void swap(UserAttributes &a, UserAttributes &b) {
    ...
    swap(a.optOutMachineLearning, b.optOutMachineLearning);
    swap(a.__isset, b.__isset);
}
...
UserAttributes::UserAttributes(const UserAttributes &other15) {
    ...
    optOutMachineLearning = other15.optOutMachineLearning;
...
UserAttributes &UserAttributes::operator=(const UserAttributes &other16) {
    ...
    optOutMachineLearning = other16.optOutMachineLearning;
...
void UserAttributes::printTo(std::ostream &out) const {
    ...
    (__isset.defaultLocationName ? (out << to_string(defaultLocationName))
                                 : (out << "<null>"));
    out << ", "
        << "defaultLatitude=";
    (__isset.defaultLatitude ? (out << to_string(defaultLatitude))
                             : (out << "<null>"));
    out << ", "
        << "defaultLongitude=";
    (__isset.defaultLongitude ? (out << to_string(defaultLongitude))
                              : (out << "<null>"));
    out << ", "
        << "preactivation=";
    (__isset.preactivation ? (out << to_string(preactivation))
                           : (out << "<null>"));
    out << ", "
        << "viewedPromotions=";
    (__isset.viewedPromotions ? (out << to_string(viewedPromotions))
                              : (out << "<null>"));
    out << ", "
        << "incomingEmailAddress=";
    (__isset.incomingEmailAddress ? (out << to_string(incomingEmailAddress))
                                  : (out << "<null>"));
    out << ", "
        << "recentMailedAddresses=";
    (__isset.recentMailedAddresses ? (out << to_string(recentMailedAddresses))
                                   : (out << "<null>"));
    out << ", "
        << "comments=";
    (__isset.comments ? (out << to_string(comments)) : (out << "<null>"));
    out << ", "
        << "dateAgreedToTermsOfService=";
    (__isset.dateAgreedToTermsOfService
         ? (out << to_string(dateAgreedToTermsOfService))
         : (out << "<null>"));
    out << ", "
        << "maxReferrals=";
    (__isset.maxReferrals ? (out << to_string(maxReferrals))
                          : (out << "<null>"));
    out << ", "
        << "referralCount=";
    (__isset.referralCount ? (out << to_string(referralCount))
                           : (out << "<null>"));
    out << ", "
        << "refererCode=";
    (__isset.refererCode ? (out << to_string(refererCode)) : (out << "<null>"));
    out << ", "
        << "sentEmailDate=";
    (__isset.sentEmailDate ? (out << to_string(sentEmailDate))
                           : (out << "<null>"));
    out << ", "
        << "sentEmailCount=";
    (__isset.sentEmailCount ? (out << to_string(sentEmailCount))
                            : (out << "<null>"));
    out << ", "
        << "dailyEmailLimit=";
    (__isset.dailyEmailLimit ? (out << to_string(dailyEmailLimit))
                             : (out << "<null>"));
    out << ", "
        << "emailOptOutDate=";
    (__isset.emailOptOutDate ? (out << to_string(emailOptOutDate))
                             : (out << "<null>"));
    out << ", "
        << "partnerEmailOptInDate=";
    (__isset.partnerEmailOptInDate ? (out << to_string(partnerEmailOptInDate))
                                   : (out << "<null>"));
    out << ", "
        << "preferredLanguage=";
    (__isset.preferredLanguage ? (out << to_string(preferredLanguage))
                               : (out << "<null>"));
    out << ", "
        << "preferredCountry=";
    (__isset.preferredCountry ? (out << to_string(preferredCountry))
                              : (out << "<null>"));
    out << ", "
        << "clipFullPage=";
    (__isset.clipFullPage ? (out << to_string(clipFullPage))
                          : (out << "<null>"));
    out << ", "
        << "twitterUserName=";
    (__isset.twitterUserName ? (out << to_string(twitterUserName))
                             : (out << "<null>"));
    out << ", "
        << "twitterId=";
    (__isset.twitterId ? (out << to_string(twitterId)) : (out << "<null>"));
    out << ", "
        << "groupName=";
    (__isset.groupName ? (out << to_string(groupName)) : (out << "<null>"));
    out << ", "
        << "recognitionLanguage=";
    (__isset.recognitionLanguage ? (out << to_string(recognitionLanguage))
                                 : (out << "<null>"));
    out << ", "
        << "referralProof=";
    (__isset.referralProof ? (out << to_string(referralProof))
                           : (out << "<null>"));
    out << ", "
        << "educationalDiscount=";
    (__isset.educationalDiscount ? (out << to_string(educationalDiscount))
                                 : (out << "<null>"));
    out << ", "
        << "businessAddress=";
    (__isset.businessAddress ? (out << to_string(businessAddress))
                             : (out << "<null>"));
    out << ", "
        << "hideSponsorBilling=";
    (__isset.hideSponsorBilling ? (out << to_string(hideSponsorBilling))
                                : (out << "<null>"));
    out << ", "
        << "useEmailAutoFiling=";
    (__isset.useEmailAutoFiling ? (out << to_string(useEmailAutoFiling))
                                : (out << "<null>"));
    out << ", "
        << "reminderEmailConfig=";
    (__isset.reminderEmailConfig ? (out << to_string(reminderEmailConfig))
                                 : (out << "<null>"));
    out << ", "
        << "emailAddressLastConfirmed=";
    (__isset.emailAddressLastConfirmed
         ? (out << to_string(emailAddressLastConfirmed))
         : (out << "<null>"));
    out << ", "
        << "passwordUpdated=";
    (__isset.passwordUpdated ? (out << to_string(passwordUpdated))
                             : (out << "<null>"));
    out << ", "
        << "salesforcePushEnabled=";
    (__isset.salesforcePushEnabled ? (out << to_string(salesforcePushEnabled))
                                   : (out << "<null>"));
    out << ", "
        << "shouldLogClientEvent=";
    (__isset.shouldLogClientEvent ? (out << to_string(shouldLogClientEvent))
                                  : (out << "<null>"));
    out << ", "
        << "optOutMachineLearning=";
    (__isset.optOutMachineLearning ? (out << to_string(optOutMachineLearning))
                                   : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const BusinessUserAttributes &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
BusinessUserAttributes::read(::apache::thrift::protocol::TProtocol *iprot) {
...
uint32_t BusinessUserAttributes::write(
    ...
    if (this->__isset.title) {
        xfer += oprot->writeFieldBegin("title",
                                       ::apache::thrift::protocol::T_STRING, 1);
...
BusinessUserAttributes::BusinessUserAttributes(
    const BusinessUserAttributes &other17) {
    title = other17.title;
...
BusinessUserAttributes &BusinessUserAttributes::
operator=(const BusinessUserAttributes &other18) {
    title = other18.title;
...
void BusinessUserAttributes::printTo(std::ostream &out) const {
    ...
    out << "title=";
    (__isset.title ? (out << to_string(title)) : (out << "<null>"));
    out << ", "
        << "location=";
    (__isset.location ? (out << to_string(location)) : (out << "<null>"));
    out << ", "
        << "department=";
    (__isset.department ? (out << to_string(department)) : (out << "<null>"));
    out << ", "
        << "mobilePhone=";
    (__isset.mobilePhone ? (out << to_string(mobilePhone)) : (out << "<null>"));
    out << ", "
        << "linkedInProfileUrl=";
    (__isset.linkedInProfileUrl ? (out << to_string(linkedInProfileUrl))
                                : (out << "<null>"));
    out << ", "
        << "workPhone=";
    (__isset.workPhone ? (out << to_string(workPhone)) : (out << "<null>"));
    out << ", "
        << "companyStartDate=";
    (__isset.companyStartDate ? (out << to_string(companyStartDate))
                              : (out << "<null>"));
    out << ")";
}
...
void Accounting::__set_premiumServiceStatus(
    const PremiumOrderStatus::type val) {
...
std::ostream &operator<<(std::ostream &out, const Accounting &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t Accounting::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.premiumSubscriptionNumber) {
        xfer +=
            oprot->writeFieldBegin("premiumSubscriptionNumber",
                                   ::apache::thrift::protocol::T_STRING, 16);
        xfer += oprot->writeString(this->premiumSubscriptionNumber);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.lastRequestedCharge) {
        xfer += oprot->writeFieldBegin("lastRequestedCharge",
...
void Accounting::printTo(std::ostream &out) const {
    ...
    out << "Accounting(";
    out << "uploadLimitEnd=";
    (__isset.uploadLimitEnd ? (out << to_string(uploadLimitEnd))
                            : (out << "<null>"));
    out << ", "
        << "uploadLimitNextMonth=";
    (__isset.uploadLimitNextMonth ? (out << to_string(uploadLimitNextMonth))
                                  : (out << "<null>"));
    out << ", "
        << "premiumServiceStatus=";
    (__isset.premiumServiceStatus ? (out << to_string(premiumServiceStatus))
                                  : (out << "<null>"));
    out << ", "
        << "premiumOrderNumber=";
    (__isset.premiumOrderNumber ? (out << to_string(premiumOrderNumber))
                                : (out << "<null>"));
    out << ", "
        << "premiumCommerceService=";
    (__isset.premiumCommerceService ? (out << to_string(premiumCommerceService))
                                    : (out << "<null>"));
    out << ", "
        << "premiumServiceStart=";
    (__isset.premiumServiceStart ? (out << to_string(premiumServiceStart))
                                 : (out << "<null>"));
    out << ", "
        << "premiumServiceSKU=";
    (__isset.premiumServiceSKU ? (out << to_string(premiumServiceSKU))
                               : (out << "<null>"));
    out << ", "
        << "lastSuccessfulCharge=";
    (__isset.lastSuccessfulCharge ? (out << to_string(lastSuccessfulCharge))
                                  : (out << "<null>"));
    out << ", "
        << "lastFailedCharge=";
    (__isset.lastFailedCharge ? (out << to_string(lastFailedCharge))
                              : (out << "<null>"));
    out << ", "
        << "lastFailedChargeReason=";
    (__isset.lastFailedChargeReason ? (out << to_string(lastFailedChargeReason))
                                    : (out << "<null>"));
    out << ", "
        << "nextPaymentDue=";
    (__isset.nextPaymentDue ? (out << to_string(nextPaymentDue))
                            : (out << "<null>"));
    out << ", "
        << "premiumLockUntil=";
    (__isset.premiumLockUntil ? (out << to_string(premiumLockUntil))
                              : (out << "<null>"));
    out << ", "
        << "updated=";
    (__isset.updated ? (out << to_string(updated)) : (out << "<null>"));
    out << ", "
        << "premiumSubscriptionNumber=";
    (__isset.premiumSubscriptionNumber
         ? (out << to_string(premiumSubscriptionNumber))
         : (out << "<null>"));
    out << ", "
        << "lastRequestedCharge=";
    (__isset.lastRequestedCharge ? (out << to_string(lastRequestedCharge))
                                 : (out << "<null>"));
    out << ", "
        << "currency=";
    (__isset.currency ? (out << to_string(currency)) : (out << "<null>"));
    out << ", "
        << "unitPrice=";
    (__isset.unitPrice ? (out << to_string(unitPrice)) : (out << "<null>"));
    out << ", "
        << "businessId=";
    (__isset.businessId ? (out << to_string(businessId)) : (out << "<null>"));
    out << ", "
        << "businessName=";
    (__isset.businessName ? (out << to_string(businessName))
                          : (out << "<null>"));
    out << ", "
        << "businessRole=";
    (__isset.businessRole ? (out << to_string(businessRole))
                          : (out << "<null>"));
    out << ", "
        << "unitDiscount=";
    (__isset.unitDiscount ? (out << to_string(unitDiscount))
                          : (out << "<null>"));
    out << ", "
        << "nextChargeDate=";
    (__isset.nextChargeDate ? (out << to_string(nextChargeDate))
                            : (out << "<null>"));
    out << ", "
        << "availablePoints=";
    (__isset.availablePoints ? (out << to_string(availablePoints))
                             : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const BusinessUserInfo &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t
BusinessUserInfo::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
void BusinessUserInfo::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "role=";
    (__isset.role ? (out << to_string(role)) : (out << "<null>"));
    out << ", "
        << "email=";
    (__isset.email ? (out << to_string(email)) : (out << "<null>"));
    out << ", "
        << "updated=";
    (__isset.updated ? (out << to_string(updated)) : (out << "<null>"));
    out << ")";
...
std::ostream &operator<<(std::ostream &out, const AccountLimits &obj) {
    obj.printTo(out);
    return out;
}
...
void AccountLimits::printTo(std::ostream &out) const {
    ...
    (__isset.userMailLimitDaily ? (out << to_string(userMailLimitDaily))
                                : (out << "<null>"));
    out << ", "
        << "noteSizeMax=";
    (__isset.noteSizeMax ? (out << to_string(noteSizeMax)) : (out << "<null>"));
    out << ", "
        << "resourceSizeMax=";
    (__isset.resourceSizeMax ? (out << to_string(resourceSizeMax))
                             : (out << "<null>"));
    out << ", "
        << "userLinkedNotebookMax=";
    (__isset.userLinkedNotebookMax ? (out << to_string(userLinkedNotebookMax))
                                   : (out << "<null>"));
    out << ", "
        << "uploadLimit=";
    (__isset.uploadLimit ? (out << to_string(uploadLimit)) : (out << "<null>"));
    out << ", "
        << "userNoteCountMax=";
    (__isset.userNoteCountMax ? (out << to_string(userNoteCountMax))
                              : (out << "<null>"));
    out << ", "
        << "userNotebookCountMax=";
    (__isset.userNotebookCountMax ? (out << to_string(userNotebookCountMax))
                                  : (out << "<null>"));
    out << ", "
        << "userTagCountMax=";
    (__isset.userTagCountMax ? (out << to_string(userTagCountMax))
                             : (out << "<null>"));
    out << ", "
        << "noteTagCountMax=";
    (__isset.noteTagCountMax ? (out << to_string(noteTagCountMax))
                             : (out << "<null>"));
    out << ", "
        << "userSavedSearchesMax=";
    (__isset.userSavedSearchesMax ? (out << to_string(userSavedSearchesMax))
                                  : (out << "<null>"));
    out << ", "
        << "noteResourceCountMax=";
    (__isset.noteResourceCountMax ? (out << to_string(noteResourceCountMax))
                                  : (out << "<null>"));
    out << ")";
}
...
uint32_t User::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.id) {
        xfer +=
            oprot->writeFieldBegin("id", ::apache::thrift::protocol::T_I32, 1);
    ...
    if (this->__isset.timezone) {
        xfer += oprot->writeFieldBegin("timezone",
                                       ::apache::thrift::protocol::T_STRING, 6);
    ...
    if (this->__isset.created) {
        xfer += oprot->writeFieldBegin("created",
                                       ::apache::thrift::protocol::T_I64, 9);
    ...
    if (this->__isset.deleted) {
        xfer += oprot->writeFieldBegin("deleted",
                                       ::apache::thrift::protocol::T_I64, 11);
        xfer += oprot->writeI64(this->deleted);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.active) {
        xfer += oprot->writeFieldBegin("active",
...
void User::printTo(std::ostream &out) const {
    ...
    out << "User(";
    out << "id=";
    (__isset.id ? (out << to_string(id)) : (out << "<null>"));
    out << ", "
        << "username=";
    (__isset.username ? (out << to_string(username)) : (out << "<null>"));
    out << ", "
        << "email=";
    (__isset.email ? (out << to_string(email)) : (out << "<null>"));
    out << ", "
    ...
    out << ", "
        << "timezone=";
    (__isset.timezone ? (out << to_string(timezone)) : (out << "<null>"));
    out << ", "
        << "privilege=";
    (__isset.privilege ? (out << to_string(privilege)) : (out << "<null>"));
    out << ", "
        << "serviceLevel=";
    (__isset.serviceLevel ? (out << to_string(serviceLevel))
                          : (out << "<null>"));
    out << ", "
        << "created=";
    (__isset.created ? (out << to_string(created)) : (out << "<null>"));
    out << ", "
        << "updated=";
    (__isset.updated ? (out << to_string(updated)) : (out << "<null>"));
    out << ", "
        << "deleted=";
    (__isset.deleted ? (out << to_string(deleted)) : (out << "<null>"));
    out << ", "
        << "active=";
    (__isset.active ? (out << to_string(active)) : (out << "<null>"));
    out << ", "
        << "shardId=";
    (__isset.shardId ? (out << to_string(shardId)) : (out << "<null>"));
    out << ", "
        << "attributes=";
    (__isset.attributes ? (out << to_string(attributes)) : (out << "<null>"));
    out << ", "
        << "accounting=";
    (__isset.accounting ? (out << to_string(accounting)) : (out << "<null>"));
    out << ", "
        << "businessUserInfo=";
    (__isset.businessUserInfo ? (out << to_string(businessUserInfo))
                              : (out << "<null>"));
    out << ", "
        << "photoUrl=";
    (__isset.photoUrl ? (out << to_string(photoUrl)) : (out << "<null>"));
    out << ", "
        << "photoLastUpdated=";
    (__isset.photoLastUpdated ? (out << to_string(photoLastUpdated))
                              : (out << "<null>"));
    out << ", "
        << "accountLimits=";
    (__isset.accountLimits ? (out << to_string(accountLimits))
                           : (out << "<null>"));
    out << ")";
}
...
uint32_t Contact::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.photoUrl) {
        xfer += oprot->writeFieldBegin("photoUrl",
                                       ::apache::thrift::protocol::T_STRING, 4);
        xfer += oprot->writeString(this->photoUrl);
        xfer += oprot->writeFieldEnd();
    }
    ...
    if (this->__isset.messagingPermit) {
        xfer += oprot->writeFieldBegin("messagingPermit",
                                       ::apache::thrift::protocol::T_STRING, 6);
        xfer += oprot->writeBinary(this->messagingPermit);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.messagingPermitExpires) {
        xfer += oprot->writeFieldBegin("messagingPermitExpires",
                                       ::apache::thrift::protocol::T_I64, 7);
...
void Contact::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "messagingPermit=";
    (__isset.messagingPermit ? (out << to_string(messagingPermit))
                             : (out << "<null>"));
    out << ", "
        << "messagingPermitExpires=";
    (__isset.messagingPermitExpires ? (out << to_string(messagingPermitExpires))
                                    : (out << "<null>"));
    out << ")";
}
...
void Identity::__set_id(const IdentityID val) { this->id = val; }
...
std::ostream &operator<<(std::ostream &out, const Identity &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t Identity::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.contact) {
        xfer += oprot->writeFieldBegin("contact",
...
void Identity::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "contact=";
    (__isset.contact ? (out << to_string(contact)) : (out << "<null>"));
    out << ", "
        << "userId=";
    (__isset.userId ? (out << to_string(userId)) : (out << "<null>"));
    out << ", "
        << "deactivated=";
    (__isset.deactivated ? (out << to_string(deactivated)) : (out << "<null>"));
    out << ", "
        << "sameBusiness=";
    (__isset.sameBusiness ? (out << to_string(sameBusiness))
                          : (out << "<null>"));
    out << ", "
        << "blocked=";
    (__isset.blocked ? (out << to_string(blocked)) : (out << "<null>"));
    out << ", "
        << "userConnected=";
    (__isset.userConnected ? (out << to_string(userConnected))
                           : (out << "<null>"));
    out << ", "
        << "eventId=";
    (__isset.eventId ? (out << to_string(eventId)) : (out << "<null>"));
    out << ")";
}
...
uint32_t Tag::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.guid) {
        xfer += oprot->writeFieldBegin("guid",
                                       ::apache::thrift::protocol::T_STRING, 1);
    ...
    if (this->__isset.parentGuid) {
        xfer += oprot->writeFieldBegin("parentGuid",
                                       ::apache::thrift::protocol::T_STRING, 3);
        xfer += oprot->writeString(this->parentGuid);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.updateSequenceNum) {
        xfer += oprot->writeFieldBegin("updateSequenceNum",
                                       ::apache::thrift::protocol::T_I32, 4);
...
void Tag::printTo(std::ostream &out) const {
    ...
    out << "Tag(";
    out << "guid=";
    (__isset.guid ? (out << to_string(guid)) : (out << "<null>"));
    out << ", "
        << "name=";
    (__isset.name ? (out << to_string(name)) : (out << "<null>"));
    out << ", "
        << "parentGuid=";
    (__isset.parentGuid ? (out << to_string(parentGuid)) : (out << "<null>"));
    out << ", "
        << "updateSequenceNum=";
    (__isset.updateSequenceNum ? (out << to_string(updateSequenceNum))
                               : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const LazyMap &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t LazyMap::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.keysOnly) {
        xfer += oprot->writeFieldBegin("keysOnly",
                                       ::apache::thrift::protocol::T_SET, 1);
        {
            xfer += oprot->writeSetBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->keysOnly.size()));
            std::set<std::string>::const_iterator _iter52;
            for (_iter52 = this->keysOnly.begin();
                 _iter52 != this->keysOnly.end(); ++_iter52) {
    ...
    if (this->__isset.fullMap) {
        xfer += oprot->writeFieldBegin("fullMap",
                                       ::apache::thrift::protocol::T_MAP, 2);
        {
            xfer += oprot->writeMapBegin(
                ::apache::thrift::protocol::T_STRING,
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->fullMap.size()));
            std::map<std::string, std::string>::const_iterator _iter53;
            for (_iter53 = this->fullMap.begin();
                 _iter53 != this->fullMap.end(); ++_iter53) {
...
void LazyMap::printTo(std::ostream &out) const {
    ...
    out << "LazyMap(";
    out << "keysOnly=";
    (__isset.keysOnly ? (out << to_string(keysOnly)) : (out << "<null>"));
    out << ", "
        << "fullMap=";
    (__isset.fullMap ? (out << to_string(fullMap)) : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const ResourceAttributes &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
ResourceAttributes::read(::apache::thrift::protocol::TProtocol *iprot) {
...
uint32_t
ResourceAttributes::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("ResourceAttributes");

    if (this->__isset.sourceURL) {
        xfer += oprot->writeFieldBegin("sourceURL",
                                       ::apache::thrift::protocol::T_STRING, 1);
    ...
    if (this->__isset.fileName) {
        xfer += oprot->writeFieldBegin(
            "fileName", ::apache::thrift::protocol::T_STRING, 10);
        xfer += oprot->writeString(this->fileName);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.attachment) {
        xfer += oprot->writeFieldBegin("attachment",
    ...
    if (this->__isset.applicationData) {
        xfer += oprot->writeFieldBegin(
            "applicationData", ::apache::thrift::protocol::T_STRUCT, 12);
...
operator=(const ResourceAttributes &other57) {
...
void ResourceAttributes::printTo(std::ostream &out) const {
    ...
    out << "sourceURL=";
    (__isset.sourceURL ? (out << to_string(sourceURL)) : (out << "<null>"));
    out << ", "
        << "timestamp=";
    (__isset.timestamp ? (out << to_string(timestamp)) : (out << "<null>"));
    out << ", "
        << "latitude=";
    (__isset.latitude ? (out << to_string(latitude)) : (out << "<null>"));
    out << ", "
        << "longitude=";
    (__isset.longitude ? (out << to_string(longitude)) : (out << "<null>"));
    out << ", "
        << "altitude=";
    (__isset.altitude ? (out << to_string(altitude)) : (out << "<null>"));
    out << ", "
        << "cameraMake=";
    (__isset.cameraMake ? (out << to_string(cameraMake)) : (out << "<null>"));
    out << ", "
        << "cameraModel=";
    (__isset.cameraModel ? (out << to_string(cameraModel)) : (out << "<null>"));
    out << ", "
        << "clientWillIndex=";
    (__isset.clientWillIndex ? (out << to_string(clientWillIndex))
                             : (out << "<null>"));
    out << ", "
        << "recoType=";
    (__isset.recoType ? (out << to_string(recoType)) : (out << "<null>"));
    out << ", "
        << "fileName=";
    (__isset.fileName ? (out << to_string(fileName)) : (out << "<null>"));
    out << ", "
        << "attachment=";
    (__isset.attachment ? (out << to_string(attachment)) : (out << "<null>"));
    out << ", "
        << "applicationData=";
    (__isset.applicationData ? (out << to_string(applicationData))
                             : (out << "<null>"));
    out << ")";
}
...
uint32_t Resource::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.noteGuid) {
        xfer += oprot->writeFieldBegin("noteGuid",
                                       ::apache::thrift::protocol::T_STRING, 2);
    ...
    if (this->__isset.recognition) {
        xfer += oprot->writeFieldBegin("recognition",
    ...
    if (this->__isset.attributes) {
        xfer += oprot->writeFieldBegin(
            "attributes", ::apache::thrift::protocol::T_STRUCT, 11);
        xfer += this->attributes.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.updateSequenceNum) {
    ...
    if (this->__isset.alternateData) {
        xfer += oprot->writeFieldBegin(
            "alternateData", ::apache::thrift::protocol::T_STRUCT, 13);
...
void Resource::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "noteGuid=";
    (__isset.noteGuid ? (out << to_string(noteGuid)) : (out << "<null>"));
    out << ", "
        << "data=";
    (__isset.data ? (out << to_string(data)) : (out << "<null>"));
    out << ", "
        << "mime=";
    (__isset.mime ? (out << to_string(mime)) : (out << "<null>"));
    out << ", "
        << "width=";
    (__isset.width ? (out << to_string(width)) : (out << "<null>"));
    out << ", "
        << "height=";
    (__isset.height ? (out << to_string(height)) : (out << "<null>"));
    out << ", "
        << "duration=";
    ...
    out << ", "
        << "recognition=";
    (__isset.recognition ? (out << to_string(recognition)) : (out << "<null>"));
    out << ", "
        << "attributes=";
    (__isset.attributes ? (out << to_string(attributes)) : (out << "<null>"));
    out << ", "
    ...
    out << ", "
        << "alternateData=";
    (__isset.alternateData ? (out << to_string(alternateData))
                           : (out << "<null>"));
    out << ")";
}
...
void NoteAttributes::__set_classifications(
...
std::ostream &operator<<(std::ostream &out, const NoteAttributes &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t
NoteAttributes::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("NoteAttributes");

    if (this->__isset.subjectDate) {
        xfer += oprot->writeFieldBegin("subjectDate",
    ...
    if (this->__isset.latitude) {
        xfer += oprot->writeFieldBegin(
            "latitude", ::apache::thrift::protocol::T_DOUBLE, 10);
        xfer += oprot->writeDouble(this->latitude);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.longitude) {
        xfer += oprot->writeFieldBegin(
            "longitude", ::apache::thrift::protocol::T_DOUBLE, 11);
        xfer += oprot->writeDouble(this->longitude);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.altitude) {
        xfer += oprot->writeFieldBegin(
            "altitude", ::apache::thrift::protocol::T_DOUBLE, 12);
        xfer += oprot->writeDouble(this->altitude);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.author) {
        xfer += oprot->writeFieldBegin(
            "author", ::apache::thrift::protocol::T_STRING, 13);
        xfer += oprot->writeString(this->author);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.source) {
        xfer += oprot->writeFieldBegin(
            "source", ::apache::thrift::protocol::T_STRING, 14);
        xfer += oprot->writeString(this->source);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.sourceURL) {
        xfer += oprot->writeFieldBegin(
            "sourceURL", ::apache::thrift::protocol::T_STRING, 15);
        xfer += oprot->writeString(this->sourceURL);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.sourceApplication) {
        xfer += oprot->writeFieldBegin(
            "sourceApplication", ::apache::thrift::protocol::T_STRING, 16);
        xfer += oprot->writeString(this->sourceApplication);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.shareDate) {
        xfer += oprot->writeFieldBegin("shareDate",
                                       ::apache::thrift::protocol::T_I64, 17);
        xfer += oprot->writeI64(this->shareDate);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.reminderOrder) {
        xfer += oprot->writeFieldBegin("reminderOrder",
                                       ::apache::thrift::protocol::T_I64, 18);
        xfer += oprot->writeI64(this->reminderOrder);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.reminderDoneTime) {
        xfer += oprot->writeFieldBegin("reminderDoneTime",
                                       ::apache::thrift::protocol::T_I64, 19);
        xfer += oprot->writeI64(this->reminderDoneTime);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.reminderTime) {
        xfer += oprot->writeFieldBegin("reminderTime",
                                       ::apache::thrift::protocol::T_I64, 20);
    ...
    if (this->__isset.placeName) {
        xfer += oprot->writeFieldBegin(
            "placeName", ::apache::thrift::protocol::T_STRING, 21);
        xfer += oprot->writeString(this->placeName);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.contentClass) {
        xfer += oprot->writeFieldBegin(
            "contentClass", ::apache::thrift::protocol::T_STRING, 22);
        xfer += oprot->writeString(this->contentClass);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.applicationData) {
        xfer += oprot->writeFieldBegin(
            "applicationData", ::apache::thrift::protocol::T_STRUCT, 23);
        xfer += this->applicationData.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.lastEditedBy) {
        xfer += oprot->writeFieldBegin(
            "lastEditedBy", ::apache::thrift::protocol::T_STRING, 24);
        xfer += oprot->writeString(this->lastEditedBy);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.classifications) {
        xfer += oprot->writeFieldBegin("classifications",
                                       ::apache::thrift::protocol::T_MAP, 26);
        {
            xfer += oprot->writeMapBegin(
                ::apache::thrift::protocol::T_STRING,
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->classifications.size()));
            std::map<std::string, std::string>::const_iterator _iter67;
            for (_iter67 = this->classifications.begin();
                 _iter67 != this->classifications.end(); ++_iter67) {
    ...
    if (this->__isset.creatorId) {
        xfer += oprot->writeFieldBegin("creatorId",
                                       ::apache::thrift::protocol::T_I32, 27);
        xfer += oprot->writeI32(this->creatorId);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.lastEditorId) {
        xfer += oprot->writeFieldBegin("lastEditorId",
                                       ::apache::thrift::protocol::T_I32, 28);
        xfer += oprot->writeI32(this->lastEditorId);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.sharedWithBusiness) {
        xfer += oprot->writeFieldBegin("sharedWithBusiness",
                                       ::apache::thrift::protocol::T_BOOL, 29);
    ...
    if (this->__isset.conflictSourceNoteGuid) {
        xfer += oprot->writeFieldBegin(
            "conflictSourceNoteGuid", ::apache::thrift::protocol::T_STRING, 30);
        xfer += oprot->writeString(this->conflictSourceNoteGuid);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noteTitleQuality) {
        xfer += oprot->writeFieldBegin("noteTitleQuality",
                                       ::apache::thrift::protocol::T_I32, 31);
...
void NoteAttributes::printTo(std::ostream &out) const {
    ...
    out << "NoteAttributes(";
    out << "subjectDate=";
    (__isset.subjectDate ? (out << to_string(subjectDate)) : (out << "<null>"));
    out << ", "
        << "latitude=";
    (__isset.latitude ? (out << to_string(latitude)) : (out << "<null>"));
    out << ", "
    ...
    out << ", "
        << "source=";
    (__isset.source ? (out << to_string(source)) : (out << "<null>"));
    out << ", "
        << "sourceURL=";
    (__isset.sourceURL ? (out << to_string(sourceURL)) : (out << "<null>"));
    out << ", "
        << "sourceApplication=";
    (__isset.sourceApplication ? (out << to_string(sourceApplication))
                               : (out << "<null>"));
    out << ", "
        << "shareDate=";
    (__isset.shareDate ? (out << to_string(shareDate)) : (out << "<null>"));
    out << ", "
        << "reminderOrder=";
    (__isset.reminderOrder ? (out << to_string(reminderOrder))
                           : (out << "<null>"));
    out << ", "
        << "reminderDoneTime=";
    (__isset.reminderDoneTime ? (out << to_string(reminderDoneTime))
                              : (out << "<null>"));
    out << ", "
        << "reminderTime=";
    (__isset.reminderTime ? (out << to_string(reminderTime))
                          : (out << "<null>"));
    out << ", "
        << "placeName=";
    (__isset.placeName ? (out << to_string(placeName)) : (out << "<null>"));
    out << ", "
        << "contentClass=";
    (__isset.contentClass ? (out << to_string(contentClass))
                          : (out << "<null>"));
    out << ", "
        << "applicationData=";
    (__isset.applicationData ? (out << to_string(applicationData))
    ...
    out << ", "
        << "lastEditedBy=";
    (__isset.lastEditedBy ? (out << to_string(lastEditedBy))
                          : (out << "<null>"));
    out << ", "
        << "classifications=";
    (__isset.classifications ? (out << to_string(classifications))
                             : (out << "<null>"));
    out << ", "
        << "creatorId=";
    (__isset.creatorId ? (out << to_string(creatorId)) : (out << "<null>"));
    out << ", "
        << "lastEditorId=";
    (__isset.lastEditorId ? (out << to_string(lastEditorId))
                          : (out << "<null>"));
    out << ", "
        << "sharedWithBusiness=";
    (__isset.sharedWithBusiness ? (out << to_string(sharedWithBusiness))
                                : (out << "<null>"));
    out << ", "
        << "conflictSourceNoteGuid=";
    (__isset.conflictSourceNoteGuid ? (out << to_string(conflictSourceNoteGuid))
                                    : (out << "<null>"));
    out << ", "
        << "noteTitleQuality=";
    (__isset.noteTitleQuality ? (out << to_string(noteTitleQuality))
                              : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const SharedNote &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t SharedNote::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.sharerUserID) {
        xfer += oprot->writeFieldBegin("sharerUserID",
                                       ::apache::thrift::protocol::T_I32, 1);
        xfer += oprot->writeI32(this->sharerUserID);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.recipientIdentity) {
        xfer += oprot->writeFieldBegin("recipientIdentity",
                                       ::apache::thrift::protocol::T_STRUCT, 2);
...
void SharedNote::printTo(std::ostream &out) const {
    ...
    out << "SharedNote(";
    out << "sharerUserID=";
    (__isset.sharerUserID ? (out << to_string(sharerUserID))
                          : (out << "<null>"));
    out << ", "
        << "recipientIdentity=";
    (__isset.recipientIdentity ? (out << to_string(recipientIdentity))
                               : (out << "<null>"));
    out << ", "
        << "privilege=";
    (__isset.privilege ? (out << to_string(privilege)) : (out << "<null>"));
    out << ", "
        << "serviceCreated=";
    (__isset.serviceCreated ? (out << to_string(serviceCreated))
                            : (out << "<null>"));
    out << ", "
        << "serviceUpdated=";
    (__isset.serviceUpdated ? (out << to_string(serviceUpdated))
                            : (out << "<null>"));
    out << ", "
        << "serviceAssigned=";
    (__isset.serviceAssigned ? (out << to_string(serviceAssigned))
                             : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const NoteRestrictions &obj) {
    obj.printTo(out);
    return out;
}
...
void NoteRestrictions::printTo(std::ostream &out) const {
    ...
    out << "noUpdateTitle=";
    (__isset.noUpdateTitle ? (out << to_string(noUpdateTitle))
                           : (out << "<null>"));
    out << ", "
        << "noUpdateContent=";
    (__isset.noUpdateContent ? (out << to_string(noUpdateContent))
                             : (out << "<null>"));
    out << ", "
        << "noEmail=";
    (__isset.noEmail ? (out << to_string(noEmail)) : (out << "<null>"));
    out << ", "
        << "noShare=";
    (__isset.noShare ? (out << to_string(noShare)) : (out << "<null>"));
    out << ", "
        << "noSharePublicly=";
    (__isset.noSharePublicly ? (out << to_string(noSharePublicly))
                             : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const NoteLimits &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t NoteLimits::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.uploaded) {
        xfer += oprot->writeFieldBegin("uploaded",
                                       ::apache::thrift::protocol::T_I64, 5);
...
void NoteLimits::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "uploaded=";
    (__isset.uploaded ? (out << to_string(uploaded)) : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const Note &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t Note::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.content) {
        xfer += oprot->writeFieldBegin("content",
                                       ::apache::thrift::protocol::T_STRING, 3);
        xfer += oprot->writeString(this->content);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.contentHash) {
        xfer += oprot->writeFieldBegin("contentHash",
                                       ::apache::thrift::protocol::T_STRING, 4);
        xfer += oprot->writeBinary(this->contentHash);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.contentLength) {
        xfer += oprot->writeFieldBegin("contentLength",
    ...
    if (this->__isset.notebookGuid) {
        xfer += oprot->writeFieldBegin(
            "notebookGuid", ::apache::thrift::protocol::T_STRING, 11);
        xfer += oprot->writeString(this->notebookGuid);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.tagGuids) {
        xfer += oprot->writeFieldBegin("tagGuids",
                                       ::apache::thrift::protocol::T_LIST, 12);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->tagGuids.size()));
            std::vector<Guid>::const_iterator _iter97;
            for (_iter97 = this->tagGuids.begin();
                 _iter97 != this->tagGuids.end(); ++_iter97) {
    ...
    if (this->__isset.resources) {
        xfer += oprot->writeFieldBegin("resources",
                                       ::apache::thrift::protocol::T_LIST, 13);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRUCT,
                static_cast<uint32_t>(this->resources.size()));
            std::vector<Resource>::const_iterator _iter98;
            for (_iter98 = this->resources.begin();
                 _iter98 != this->resources.end(); ++_iter98) {
    ...
    if (this->__isset.attributes) {
        xfer += oprot->writeFieldBegin(
            "attributes", ::apache::thrift::protocol::T_STRUCT, 14);
        xfer += this->attributes.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.tagNames) {
        xfer += oprot->writeFieldBegin("tagNames",
                                       ::apache::thrift::protocol::T_LIST, 15);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->tagNames.size()));
            std::vector<std::string>::const_iterator _iter99;
            for (_iter99 = this->tagNames.begin();
                 _iter99 != this->tagNames.end(); ++_iter99) {
    ...
    if (this->__isset.sharedNotes) {
        xfer += oprot->writeFieldBegin("sharedNotes",
                                       ::apache::thrift::protocol::T_LIST, 16);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRUCT,
                static_cast<uint32_t>(this->sharedNotes.size()));
            std::vector<SharedNote>::const_iterator _iter100;
            for (_iter100 = this->sharedNotes.begin();
                 _iter100 != this->sharedNotes.end(); ++_iter100) {
    ...
    if (this->__isset.restrictions) {
        xfer += oprot->writeFieldBegin(
            "restrictions", ::apache::thrift::protocol::T_STRUCT, 17);
        xfer += this->restrictions.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.limits) {
        xfer += oprot->writeFieldBegin(
            "limits", ::apache::thrift::protocol::T_STRUCT, 18);
...
void Note::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "content=";
    (__isset.content ? (out << to_string(content)) : (out << "<null>"));
    out << ", "
        << "contentHash=";
    (__isset.contentHash ? (out << to_string(contentHash)) : (out << "<null>"));
    out << ", "
        << "contentLength=";
    (__isset.contentLength ? (out << to_string(contentLength))
                           : (out << "<null>"));
    out << ", "
        << "created=";
    (__isset.created ? (out << to_string(created)) : (out << "<null>"));
    ...
    out << ", "
        << "notebookGuid=";
    (__isset.notebookGuid ? (out << to_string(notebookGuid))
                          : (out << "<null>"));
    out << ", "
        << "tagGuids=";
    (__isset.tagGuids ? (out << to_string(tagGuids)) : (out << "<null>"));
    out << ", "
        << "resources=";
    (__isset.resources ? (out << to_string(resources)) : (out << "<null>"));
    out << ", "
        << "attributes=";
    (__isset.attributes ? (out << to_string(attributes)) : (out << "<null>"));
    out << ", "
        << "tagNames=";
    (__isset.tagNames ? (out << to_string(tagNames)) : (out << "<null>"));
    out << ", "
        << "sharedNotes=";
    (__isset.sharedNotes ? (out << to_string(sharedNotes)) : (out << "<null>"));
    out << ", "
        << "restrictions=";
    (__isset.restrictions ? (out << to_string(restrictions))
                          : (out << "<null>"));
    out << ", "
        << "limits=";
    (__isset.limits ? (out << to_string(limits)) : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const Publishing &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t Publishing::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.uri) {
        xfer += oprot->writeFieldBegin("uri",
                                       ::apache::thrift::protocol::T_STRING, 1);
    ...
    if (this->__isset.publicDescription) {
        xfer += oprot->writeFieldBegin("publicDescription",
                                       ::apache::thrift::protocol::T_STRING, 4);
...
void Publishing::printTo(std::ostream &out) const {
    ...
    out << "Publishing(";
    out << "uri=";
    (__isset.uri ? (out << to_string(uri)) : (out << "<null>"));
    out << ", "
        << "order=";
    (__isset.order ? (out << to_string(order)) : (out << "<null>"));
    out << ", "
        << "ascending=";
    (__isset.ascending ? (out << to_string(ascending)) : (out << "<null>"));
    out << ", "
        << "publicDescription=";
    (__isset.publicDescription ? (out << to_string(publicDescription))
                               : (out << "<null>"));
    out << ")";
}
...
void BusinessNotebook::__set_privilege(
    const SharedNotebookPrivilegeLevel::type val) {
    this->privilege = val;
    __isset.privilege = true;
}
...
std::ostream &operator<<(std::ostream &out, const BusinessNotebook &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t
BusinessNotebook::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("BusinessNotebook");

    if (this->__isset.notebookDescription) {
        xfer += oprot->writeFieldBegin("notebookDescription",
                                       ::apache::thrift::protocol::T_STRING, 1);
    ...
    if (this->__isset.recommended) {
        xfer += oprot->writeFieldBegin("recommended",
                                       ::apache::thrift::protocol::T_BOOL, 3);
...
operator=(const BusinessNotebook &other108) {
...
void BusinessNotebook::printTo(std::ostream &out) const {
    ...
    (__isset.notebookDescription ? (out << to_string(notebookDescription))
                                 : (out << "<null>"));
    out << ", "
        << "privilege=";
    (__isset.privilege ? (out << to_string(privilege)) : (out << "<null>"));
    out << ", "
        << "recommended=";
    (__isset.recommended ? (out << to_string(recommended)) : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const SavedSearchScope &obj) {
    obj.printTo(out);
    return out;
}
...
operator=(const SavedSearchScope &other110) {
...
void SavedSearchScope::printTo(std::ostream &out) const {
    ...
    out << "includeAccount=";
    (__isset.includeAccount ? (out << to_string(includeAccount))
                            : (out << "<null>"));
    out << ", "
        << "includePersonalLinkedNotebooks=";
    (__isset.includePersonalLinkedNotebooks
         ? (out << to_string(includePersonalLinkedNotebooks))
         : (out << "<null>"));
    out << ", "
        << "includeBusinessLinkedNotebooks=";
    (__isset.includeBusinessLinkedNotebooks
         ? (out << to_string(includeBusinessLinkedNotebooks))
         : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const SavedSearch &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t
SavedSearch::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.format) {
        xfer += oprot->writeFieldBegin("format",
                                       ::apache::thrift::protocol::T_I32, 4);
    ...
    if (this->__isset.scope) {
        xfer += oprot->writeFieldBegin("scope",
...
void SavedSearch::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "format=";
    (__isset.format ? (out << to_string(format)) : (out << "<null>"));
    out << ", "
        << "updateSequenceNum=";
    (__isset.updateSequenceNum ? (out << to_string(updateSequenceNum))
                               : (out << "<null>"));
    out << ", "
        << "scope=";
    (__isset.scope ? (out << to_string(scope)) : (out << "<null>"));
    out << ")";
}

SharedNotebookRecipientSettings::~SharedNotebookRecipientSettings() throw() {}

void SharedNotebookRecipientSettings::__set_reminderNotifyEmail(
    const bool val) {
    this->reminderNotifyEmail = val;
    __isset.reminderNotifyEmail = true;
}

void SharedNotebookRecipientSettings::__set_reminderNotifyInApp(
    const bool val) {
    this->reminderNotifyInApp = val;
    __isset.reminderNotifyInApp = true;
}
std::ostream &operator<<(std::ostream &out,
                         const SharedNotebookRecipientSettings &obj) {
    obj.printTo(out);
    return out;
}

uint32_t SharedNotebookRecipientSettings::read(
...
uint32_t SharedNotebookRecipientSettings::write(
    ::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.reminderNotifyEmail) {
        xfer += oprot->writeFieldBegin("reminderNotifyEmail",
                                       ::apache::thrift::protocol::T_BOOL, 1);
        xfer += oprot->writeBool(this->reminderNotifyEmail);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.reminderNotifyInApp) {
        xfer += oprot->writeFieldBegin("reminderNotifyInApp",
                                       ::apache::thrift::protocol::T_BOOL, 2);
...
void swap(SharedNotebookRecipientSettings &a,
          SharedNotebookRecipientSettings &b) {
    using ::std::swap;
...
SharedNotebookRecipientSettings::SharedNotebookRecipientSettings(
    const SharedNotebookRecipientSettings &other114) {
    reminderNotifyEmail = other114.reminderNotifyEmail;
    reminderNotifyInApp = other114.reminderNotifyInApp;
    __isset = other114.__isset;
}
SharedNotebookRecipientSettings &SharedNotebookRecipientSettings::
operator=(const SharedNotebookRecipientSettings &other115) {
...
void SharedNotebookRecipientSettings::printTo(std::ostream &out) const {
    ...
    (__isset.reminderNotifyEmail ? (out << to_string(reminderNotifyEmail))
                                 : (out << "<null>"));
    out << ", "
        << "reminderNotifyInApp=";
    (__isset.reminderNotifyInApp ? (out << to_string(reminderNotifyInApp))
                                 : (out << "<null>"));
    out << ")";
}
...
void NotebookRecipientSettings::__set_recipientStatus(
    const RecipientStatus::type val) {
    this->recipientStatus = val;
    __isset.recipientStatus = true;
}
std::ostream &operator<<(std::ostream &out,
                         const NotebookRecipientSettings &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
NotebookRecipientSettings::read(::apache::thrift::protocol::TProtocol *iprot) {
    ...
    while (true) {
        ...
        case 5:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->recipientStatus = (RecipientStatus::type)ecast116;
                this->__isset.recipientStatus = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
uint32_t NotebookRecipientSettings::write(
    ::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.inMyList) {
        xfer += oprot->writeFieldBegin("inMyList",
                                       ::apache::thrift::protocol::T_BOOL, 3);
        xfer += oprot->writeBool(this->inMyList);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.stack) {
        xfer += oprot->writeFieldBegin("stack",
                                       ::apache::thrift::protocol::T_STRING, 4);
        xfer += oprot->writeString(this->stack);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.recipientStatus) {
        xfer += oprot->writeFieldBegin("recipientStatus",
                                       ::apache::thrift::protocol::T_I32, 5);
        xfer += oprot->writeI32((int32_t)this->recipientStatus);
        xfer += oprot->writeFieldEnd();
    }
    xfer += oprot->writeFieldStop();
    xfer += oprot->writeStructEnd();
...
void swap(NotebookRecipientSettings &a, NotebookRecipientSettings &b) {
    ...
    swap(a.recipientStatus, b.recipientStatus);
    swap(a.__isset, b.__isset);
}

NotebookRecipientSettings::NotebookRecipientSettings(
    const NotebookRecipientSettings &other117) {
    ...
    recipientStatus = other117.recipientStatus;
    __isset = other117.__isset;
}
NotebookRecipientSettings &NotebookRecipientSettings::
operator=(const NotebookRecipientSettings &other118) {
    reminderNotifyEmail = other118.reminderNotifyEmail;
    reminderNotifyInApp = other118.reminderNotifyInApp;
    inMyList = other118.inMyList;
    stack = other118.stack;
    recipientStatus = other118.recipientStatus;
...
void NotebookRecipientSettings::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "inMyList=";
    (__isset.inMyList ? (out << to_string(inMyList)) : (out << "<null>"));
    out << ", "
        << "stack=";
    (__isset.stack ? (out << to_string(stack)) : (out << "<null>"));
    out << ", "
        << "recipientStatus=";
    (__isset.recipientStatus ? (out << to_string(recipientStatus))
                             : (out << "<null>"));
    out << ")";
}
...
void SharedNotebook::__set_privilege(
    const SharedNotebookPrivilegeLevel::type val) {
    this->privilege = val;
    __isset.privilege = true;
}

void SharedNotebook::__set_recipientSettings(
    const SharedNotebookRecipientSettings &val) {
...
std::ostream &operator<<(std::ostream &out, const SharedNotebook &obj) {
    obj.printTo(out);
    return out;
}
    ...
    while (true) {
        ...
        case 11:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->privilege = (SharedNotebookPrivilegeLevel::type)ecast119;
                this->__isset.privilege = true;
            } else {
                xfer += iprot->skip(ftype);
            }
...
uint32_t
SharedNotebook::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.id) {
        xfer +=
            oprot->writeFieldBegin("id", ::apache::thrift::protocol::T_I64, 1);
        xfer += oprot->writeI64(this->id);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.userId) {
    ...
    if (this->__isset.notebookGuid) {
        xfer += oprot->writeFieldBegin("notebookGuid",
                                       ::apache::thrift::protocol::T_STRING, 3);
        xfer += oprot->writeString(this->notebookGuid);
        xfer += oprot->writeFieldEnd();
    }
    ...
    if (this->__isset.notebookModifiable) {
        xfer += oprot->writeFieldBegin("notebookModifiable",
                                       ::apache::thrift::protocol::T_BOOL, 5);
    ...
    if (this->__isset.globalId) {
        xfer += oprot->writeFieldBegin("globalId",
                                       ::apache::thrift::protocol::T_STRING, 8);
    ...
    if (this->__isset.recipientSettings) {
        xfer += oprot->writeFieldBegin(
            "recipientSettings", ::apache::thrift::protocol::T_STRUCT, 13);
    ...
    if (this->__isset.recipientUsername) {
        xfer += oprot->writeFieldBegin(
            "recipientUsername", ::apache::thrift::protocol::T_STRING, 15);
    ...
    if (this->__isset.recipientUserId) {
        xfer += oprot->writeFieldBegin("recipientUserId",
                                       ::apache::thrift::protocol::T_I32, 17);
        xfer += oprot->writeI32(this->recipientUserId);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.recipientIdentityId) {
        xfer += oprot->writeFieldBegin("recipientIdentityId",
                                       ::apache::thrift::protocol::T_I64, 18);
...
SharedNotebook::SharedNotebook(const SharedNotebook &other120) {
    id = other120.id;
...
SharedNotebook &SharedNotebook::operator=(const SharedNotebook &other121) {
    id = other121.id;
    userId = other121.userId;
    notebookGuid = other121.notebookGuid;
    email = other121.email;
    recipientIdentityId = other121.recipientIdentityId;
    notebookModifiable = other121.notebookModifiable;
    serviceCreated = other121.serviceCreated;
    serviceUpdated = other121.serviceUpdated;
    globalId = other121.globalId;
    username = other121.username;
    privilege = other121.privilege;
    recipientSettings = other121.recipientSettings;
    sharerUserId = other121.sharerUserId;
    recipientUsername = other121.recipientUsername;
    recipientUserId = other121.recipientUserId;
    serviceAssigned = other121.serviceAssigned;
...
void SharedNotebook::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "recipientIdentityId=";
    (__isset.recipientIdentityId ? (out << to_string(recipientIdentityId))
                                 : (out << "<null>"));
    out << ", "
        << "notebookModifiable=";
    (__isset.notebookModifiable ? (out << to_string(notebookModifiable))
                                : (out << "<null>"));
    out << ", "
        << "serviceCreated=";
    (__isset.serviceCreated ? (out << to_string(serviceCreated))
    ...
    out << ", "
        << "globalId=";
    (__isset.globalId ? (out << to_string(globalId)) : (out << "<null>"));
    out << ", "
        << "username=";
    (__isset.username ? (out << to_string(username)) : (out << "<null>"));
    out << ", "
    ...
    out << ", "
        << "recipientSettings=";
    (__isset.recipientSettings ? (out << to_string(recipientSettings))
                               : (out << "<null>"));
    out << ", "
        << "sharerUserId=";
    (__isset.sharerUserId ? (out << to_string(sharerUserId))
    ...
    out << ", "
        << "recipientUsername=";
    (__isset.recipientUsername ? (out << to_string(recipientUsername))
                               : (out << "<null>"));
    out << ", "
        << "recipientUserId=";
    (__isset.recipientUserId ? (out << to_string(recipientUserId))
                             : (out << "<null>"));
    out << ", "
        << "serviceAssigned=";
    (__isset.serviceAssigned ? (out << to_string(serviceAssigned))
...
CanMoveToContainerRestrictions::~CanMoveToContainerRestrictions() throw() {}

void CanMoveToContainerRestrictions::__set_canMoveToContainer(
    const CanMoveToContainerStatus::type val) {
    this->canMoveToContainer = val;
    __isset.canMoveToContainer = true;
}
std::ostream &operator<<(std::ostream &out,
                         const CanMoveToContainerRestrictions &obj) {
    obj.printTo(out);
    return out;
}

uint32_t CanMoveToContainerRestrictions::read(
    ::apache::thrift::protocol::TProtocol *iprot) {
    ...
    while (true) {
        ...
        case 1:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->canMoveToContainer =
                    (CanMoveToContainerStatus::type)ecast122;
                this->__isset.canMoveToContainer = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
uint32_t CanMoveToContainerRestrictions::write(
    ::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("CanMoveToContainerRestrictions");

    if (this->__isset.canMoveToContainer) {
        xfer += oprot->writeFieldBegin("canMoveToContainer",
                                       ::apache::thrift::protocol::T_I32, 1);
        xfer += oprot->writeI32((int32_t)this->canMoveToContainer);
        xfer += oprot->writeFieldEnd();
    }
    xfer += oprot->writeFieldStop();
    xfer += oprot->writeStructEnd();
...
void swap(CanMoveToContainerRestrictions &a,
          CanMoveToContainerRestrictions &b) {
    using ::std::swap;
    swap(a.canMoveToContainer, b.canMoveToContainer);
    swap(a.__isset, b.__isset);
}

CanMoveToContainerRestrictions::CanMoveToContainerRestrictions(
    const CanMoveToContainerRestrictions &other123) {
    canMoveToContainer = other123.canMoveToContainer;
    __isset = other123.__isset;
}
CanMoveToContainerRestrictions &CanMoveToContainerRestrictions::
operator=(const CanMoveToContainerRestrictions &other124) {
    canMoveToContainer = other124.canMoveToContainer;
    __isset = other124.__isset;
    return *this;
}
void CanMoveToContainerRestrictions::printTo(std::ostream &out) const {
    using ::apache::thrift::to_string;
    out << "CanMoveToContainerRestrictions(";
    out << "canMoveToContainer=";
    (__isset.canMoveToContainer ? (out << to_string(canMoveToContainer))
                                : (out << "<null>"));
    out << ")";
}
...
void NotebookRestrictions::__set_updateWhichSharedNotebookRestrictions(
    const SharedNotebookInstanceRestrictions::type val) {
    this->updateWhichSharedNotebookRestrictions = val;
    __isset.updateWhichSharedNotebookRestrictions = true;
}

void NotebookRestrictions::__set_expungeWhichSharedNotebookRestrictions(
    const SharedNotebookInstanceRestrictions::type val) {
...
void NotebookRestrictions::__set_noSetInMyList(const bool val) {
    this->noSetInMyList = val;
    __isset.noSetInMyList = true;
}

void NotebookRestrictions::__set_noChangeContact(const bool val) {
    this->noChangeContact = val;
    __isset.noChangeContact = true;
}

void NotebookRestrictions::__set_canMoveToContainerRestrictions(
    const CanMoveToContainerRestrictions &val) {
    this->canMoveToContainerRestrictions = val;
    __isset.canMoveToContainerRestrictions = true;
}

void NotebookRestrictions::__set_noSetReminderNotifyEmail(const bool val) {
    this->noSetReminderNotifyEmail = val;
    __isset.noSetReminderNotifyEmail = true;
}

void NotebookRestrictions::__set_noSetReminderNotifyInApp(const bool val) {
    this->noSetReminderNotifyInApp = val;
    __isset.noSetReminderNotifyInApp = true;
}

void NotebookRestrictions::__set_noSetRecipientSettingsStack(const bool val) {
    this->noSetRecipientSettingsStack = val;
    __isset.noSetRecipientSettingsStack = true;
}

void NotebookRestrictions::__set_noCanMoveNote(const bool val) {
    this->noCanMoveNote = val;
    __isset.noCanMoveNote = true;
}
std::ostream &operator<<(std::ostream &out, const NotebookRestrictions &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
NotebookRestrictions::read(::apache::thrift::protocol::TProtocol *iprot) {
    ...
    while (true) {
        ...
        case 19:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->updateWhichSharedNotebookRestrictions =
                    (SharedNotebookInstanceRestrictions::type)ecast125;
        ...
        case 20:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->expungeWhichSharedNotebookRestrictions =
                    (SharedNotebookInstanceRestrictions::type)ecast126;
        ...
        case 23:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->noSetInMyList);
                this->__isset.noSetInMyList = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
        case 24:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->noChangeContact);
                this->__isset.noChangeContact = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
        case 26:
            if (ftype == ::apache::thrift::protocol::T_STRUCT) {
                xfer += this->canMoveToContainerRestrictions.read(iprot);
                this->__isset.canMoveToContainerRestrictions = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
        case 27:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->noSetReminderNotifyEmail);
                this->__isset.noSetReminderNotifyEmail = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
        case 28:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->noSetReminderNotifyInApp);
                this->__isset.noSetReminderNotifyInApp = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
        case 29:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->noSetRecipientSettingsStack);
                this->__isset.noSetRecipientSettingsStack = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
        case 30:
            if (ftype == ::apache::thrift::protocol::T_BOOL) {
                xfer += iprot->readBool(this->noCanMoveNote);
                this->__isset.noCanMoveNote = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
uint32_t NotebookRestrictions::write(
    ::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.noReadNotes) {
        xfer += oprot->writeFieldBegin("noReadNotes",
                                       ::apache::thrift::protocol::T_BOOL, 1);
        xfer += oprot->writeBool(this->noReadNotes);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noCreateNotes) {
        xfer += oprot->writeFieldBegin("noCreateNotes",
                                       ::apache::thrift::protocol::T_BOOL, 2);
        xfer += oprot->writeBool(this->noCreateNotes);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noUpdateNotes) {
        xfer += oprot->writeFieldBegin("noUpdateNotes",
                                       ::apache::thrift::protocol::T_BOOL, 3);
        xfer += oprot->writeBool(this->noUpdateNotes);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noExpungeNotes) {
        xfer += oprot->writeFieldBegin("noExpungeNotes",
                                       ::apache::thrift::protocol::T_BOOL, 4);
        xfer += oprot->writeBool(this->noExpungeNotes);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noShareNotes) {
        xfer += oprot->writeFieldBegin("noShareNotes",
                                       ::apache::thrift::protocol::T_BOOL, 5);
        xfer += oprot->writeBool(this->noShareNotes);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noEmailNotes) {
        xfer += oprot->writeFieldBegin("noEmailNotes",
                                       ::apache::thrift::protocol::T_BOOL, 6);
        xfer += oprot->writeBool(this->noEmailNotes);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSendMessageToRecipients) {
        xfer += oprot->writeFieldBegin("noSendMessageToRecipients",
                                       ::apache::thrift::protocol::T_BOOL, 7);
        xfer += oprot->writeBool(this->noSendMessageToRecipients);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noUpdateNotebook) {
        xfer += oprot->writeFieldBegin("noUpdateNotebook",
                                       ::apache::thrift::protocol::T_BOOL, 8);
        xfer += oprot->writeBool(this->noUpdateNotebook);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noExpungeNotebook) {
        xfer += oprot->writeFieldBegin("noExpungeNotebook",
                                       ::apache::thrift::protocol::T_BOOL, 9);
        xfer += oprot->writeBool(this->noExpungeNotebook);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetDefaultNotebook) {
        xfer += oprot->writeFieldBegin("noSetDefaultNotebook",
                                       ::apache::thrift::protocol::T_BOOL, 10);
        xfer += oprot->writeBool(this->noSetDefaultNotebook);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetNotebookStack) {
        xfer += oprot->writeFieldBegin("noSetNotebookStack",
                                       ::apache::thrift::protocol::T_BOOL, 11);
        xfer += oprot->writeBool(this->noSetNotebookStack);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noPublishToPublic) {
        xfer += oprot->writeFieldBegin("noPublishToPublic",
                                       ::apache::thrift::protocol::T_BOOL, 12);
        xfer += oprot->writeBool(this->noPublishToPublic);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noPublishToBusinessLibrary) {
        xfer += oprot->writeFieldBegin("noPublishToBusinessLibrary",
                                       ::apache::thrift::protocol::T_BOOL, 13);
        xfer += oprot->writeBool(this->noPublishToBusinessLibrary);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noCreateTags) {
        xfer += oprot->writeFieldBegin("noCreateTags",
                                       ::apache::thrift::protocol::T_BOOL, 14);
        xfer += oprot->writeBool(this->noCreateTags);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noUpdateTags) {
        xfer += oprot->writeFieldBegin("noUpdateTags",
                                       ::apache::thrift::protocol::T_BOOL, 15);
        xfer += oprot->writeBool(this->noUpdateTags);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noExpungeTags) {
        xfer += oprot->writeFieldBegin("noExpungeTags",
                                       ::apache::thrift::protocol::T_BOOL, 16);
        xfer += oprot->writeBool(this->noExpungeTags);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetParentTag) {
        xfer += oprot->writeFieldBegin("noSetParentTag",
                                       ::apache::thrift::protocol::T_BOOL, 17);
        xfer += oprot->writeBool(this->noSetParentTag);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noCreateSharedNotebooks) {
        xfer += oprot->writeFieldBegin("noCreateSharedNotebooks",
                                       ::apache::thrift::protocol::T_BOOL, 18);
        xfer += oprot->writeBool(this->noCreateSharedNotebooks);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.updateWhichSharedNotebookRestrictions) {
        xfer += oprot->writeFieldBegin("updateWhichSharedNotebookRestrictions",
                                       ::apache::thrift::protocol::T_I32, 19);
        xfer += oprot->writeI32(
            (int32_t)this->updateWhichSharedNotebookRestrictions);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.expungeWhichSharedNotebookRestrictions) {
        xfer += oprot->writeFieldBegin("expungeWhichSharedNotebookRestrictions",
                                       ::apache::thrift::protocol::T_I32, 20);
        xfer += oprot->writeI32(
            (int32_t)this->expungeWhichSharedNotebookRestrictions);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noShareNotesWithBusiness) {
        xfer += oprot->writeFieldBegin("noShareNotesWithBusiness",
                                       ::apache::thrift::protocol::T_BOOL, 21);
        xfer += oprot->writeBool(this->noShareNotesWithBusiness);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noRenameNotebook) {
        xfer += oprot->writeFieldBegin("noRenameNotebook",
                                       ::apache::thrift::protocol::T_BOOL, 22);
        xfer += oprot->writeBool(this->noRenameNotebook);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetInMyList) {
        xfer += oprot->writeFieldBegin("noSetInMyList",
                                       ::apache::thrift::protocol::T_BOOL, 23);
        xfer += oprot->writeBool(this->noSetInMyList);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noChangeContact) {
        xfer += oprot->writeFieldBegin("noChangeContact",
                                       ::apache::thrift::protocol::T_BOOL, 24);
        xfer += oprot->writeBool(this->noChangeContact);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.canMoveToContainerRestrictions) {
        xfer +=
            oprot->writeFieldBegin("canMoveToContainerRestrictions",
                                   ::apache::thrift::protocol::T_STRUCT, 26);
        xfer += this->canMoveToContainerRestrictions.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetReminderNotifyEmail) {
        xfer += oprot->writeFieldBegin("noSetReminderNotifyEmail",
                                       ::apache::thrift::protocol::T_BOOL, 27);
        xfer += oprot->writeBool(this->noSetReminderNotifyEmail);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetReminderNotifyInApp) {
        xfer += oprot->writeFieldBegin("noSetReminderNotifyInApp",
                                       ::apache::thrift::protocol::T_BOOL, 28);
        xfer += oprot->writeBool(this->noSetReminderNotifyInApp);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noSetRecipientSettingsStack) {
        xfer += oprot->writeFieldBegin("noSetRecipientSettingsStack",
                                       ::apache::thrift::protocol::T_BOOL, 29);
        xfer += oprot->writeBool(this->noSetRecipientSettingsStack);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.noCanMoveNote) {
        xfer += oprot->writeFieldBegin("noCanMoveNote",
                                       ::apache::thrift::protocol::T_BOOL, 30);
        xfer += oprot->writeBool(this->noCanMoveNote);
        xfer += oprot->writeFieldEnd();
    }
    xfer += oprot->writeFieldStop();
    xfer += oprot->writeStructEnd();
...
void swap(NotebookRestrictions &a, NotebookRestrictions &b) {
    ...
    swap(a.updateWhichSharedNotebookRestrictions,
         b.updateWhichSharedNotebookRestrictions);
    swap(a.expungeWhichSharedNotebookRestrictions,
         b.expungeWhichSharedNotebookRestrictions);
    swap(a.noShareNotesWithBusiness, b.noShareNotesWithBusiness);
    swap(a.noRenameNotebook, b.noRenameNotebook);
    swap(a.noSetInMyList, b.noSetInMyList);
    swap(a.noChangeContact, b.noChangeContact);
    swap(a.canMoveToContainerRestrictions, b.canMoveToContainerRestrictions);
    swap(a.noSetReminderNotifyEmail, b.noSetReminderNotifyEmail);
    swap(a.noSetReminderNotifyInApp, b.noSetReminderNotifyInApp);
    swap(a.noSetRecipientSettingsStack, b.noSetRecipientSettingsStack);
    swap(a.noCanMoveNote, b.noCanMoveNote);
    swap(a.__isset, b.__isset);
}

NotebookRestrictions::NotebookRestrictions(
    const NotebookRestrictions &other127) {
    noReadNotes = other127.noReadNotes;
    noCreateNotes = other127.noCreateNotes;
    noUpdateNotes = other127.noUpdateNotes;
    noExpungeNotes = other127.noExpungeNotes;
    noShareNotes = other127.noShareNotes;
    noEmailNotes = other127.noEmailNotes;
    noSendMessageToRecipients = other127.noSendMessageToRecipients;
    noUpdateNotebook = other127.noUpdateNotebook;
    noExpungeNotebook = other127.noExpungeNotebook;
    noSetDefaultNotebook = other127.noSetDefaultNotebook;
    noSetNotebookStack = other127.noSetNotebookStack;
    noPublishToPublic = other127.noPublishToPublic;
    noPublishToBusinessLibrary = other127.noPublishToBusinessLibrary;
    noCreateTags = other127.noCreateTags;
    noUpdateTags = other127.noUpdateTags;
    noExpungeTags = other127.noExpungeTags;
    noSetParentTag = other127.noSetParentTag;
    noCreateSharedNotebooks = other127.noCreateSharedNotebooks;
    updateWhichSharedNotebookRestrictions =
        other127.updateWhichSharedNotebookRestrictions;
    expungeWhichSharedNotebookRestrictions =
        other127.expungeWhichSharedNotebookRestrictions;
    noShareNotesWithBusiness = other127.noShareNotesWithBusiness;
    noRenameNotebook = other127.noRenameNotebook;
    noSetInMyList = other127.noSetInMyList;
    noChangeContact = other127.noChangeContact;
    canMoveToContainerRestrictions = other127.canMoveToContainerRestrictions;
    noSetReminderNotifyEmail = other127.noSetReminderNotifyEmail;
    noSetReminderNotifyInApp = other127.noSetReminderNotifyInApp;
    noSetRecipientSettingsStack = other127.noSetRecipientSettingsStack;
    noCanMoveNote = other127.noCanMoveNote;
    __isset = other127.__isset;
}
NotebookRestrictions &NotebookRestrictions::
operator=(const NotebookRestrictions &other128) {
    noReadNotes = other128.noReadNotes;
    noCreateNotes = other128.noCreateNotes;
    noUpdateNotes = other128.noUpdateNotes;
    noExpungeNotes = other128.noExpungeNotes;
    noShareNotes = other128.noShareNotes;
    noEmailNotes = other128.noEmailNotes;
    noSendMessageToRecipients = other128.noSendMessageToRecipients;
    noUpdateNotebook = other128.noUpdateNotebook;
    noExpungeNotebook = other128.noExpungeNotebook;
    noSetDefaultNotebook = other128.noSetDefaultNotebook;
    noSetNotebookStack = other128.noSetNotebookStack;
    noPublishToPublic = other128.noPublishToPublic;
    noPublishToBusinessLibrary = other128.noPublishToBusinessLibrary;
    noCreateTags = other128.noCreateTags;
    noUpdateTags = other128.noUpdateTags;
    noExpungeTags = other128.noExpungeTags;
    noSetParentTag = other128.noSetParentTag;
    noCreateSharedNotebooks = other128.noCreateSharedNotebooks;
    updateWhichSharedNotebookRestrictions =
        other128.updateWhichSharedNotebookRestrictions;
    expungeWhichSharedNotebookRestrictions =
        other128.expungeWhichSharedNotebookRestrictions;
    noShareNotesWithBusiness = other128.noShareNotesWithBusiness;
    noRenameNotebook = other128.noRenameNotebook;
    noSetInMyList = other128.noSetInMyList;
    noChangeContact = other128.noChangeContact;
    canMoveToContainerRestrictions = other128.canMoveToContainerRestrictions;
    noSetReminderNotifyEmail = other128.noSetReminderNotifyEmail;
    noSetReminderNotifyInApp = other128.noSetReminderNotifyInApp;
    noSetRecipientSettingsStack = other128.noSetRecipientSettingsStack;
    noCanMoveNote = other128.noCanMoveNote;
...
void NotebookRestrictions::printTo(std::ostream &out) const {
    ...
    out << "noReadNotes=";
    (__isset.noReadNotes ? (out << to_string(noReadNotes)) : (out << "<null>"));
    out << ", "
        << "noCreateNotes=";
    (__isset.noCreateNotes ? (out << to_string(noCreateNotes))
                           : (out << "<null>"));
    out << ", "
        << "noUpdateNotes=";
    (__isset.noUpdateNotes ? (out << to_string(noUpdateNotes))
                           : (out << "<null>"));
    out << ", "
        << "noExpungeNotes=";
    (__isset.noExpungeNotes ? (out << to_string(noExpungeNotes))
                            : (out << "<null>"));
    out << ", "
        << "noShareNotes=";
    (__isset.noShareNotes ? (out << to_string(noShareNotes))
                          : (out << "<null>"));
    out << ", "
        << "noEmailNotes=";
    (__isset.noEmailNotes ? (out << to_string(noEmailNotes))
                          : (out << "<null>"));
    out << ", "
        << "noSendMessageToRecipients=";
    (__isset.noSendMessageToRecipients
         ? (out << to_string(noSendMessageToRecipients))
         : (out << "<null>"));
    out << ", "
        << "noUpdateNotebook=";
    (__isset.noUpdateNotebook ? (out << to_string(noUpdateNotebook))
                              : (out << "<null>"));
    out << ", "
        << "noExpungeNotebook=";
    (__isset.noExpungeNotebook ? (out << to_string(noExpungeNotebook))
                               : (out << "<null>"));
    out << ", "
        << "noSetDefaultNotebook=";
    (__isset.noSetDefaultNotebook ? (out << to_string(noSetDefaultNotebook))
                                  : (out << "<null>"));
    out << ", "
        << "noSetNotebookStack=";
    (__isset.noSetNotebookStack ? (out << to_string(noSetNotebookStack))
                                : (out << "<null>"));
    out << ", "
        << "noPublishToPublic=";
    (__isset.noPublishToPublic ? (out << to_string(noPublishToPublic))
                               : (out << "<null>"));
    out << ", "
        << "noPublishToBusinessLibrary=";
    (__isset.noPublishToBusinessLibrary
         ? (out << to_string(noPublishToBusinessLibrary))
         : (out << "<null>"));
    out << ", "
        << "noCreateTags=";
    (__isset.noCreateTags ? (out << to_string(noCreateTags))
                          : (out << "<null>"));
    out << ", "
        << "noUpdateTags=";
    (__isset.noUpdateTags ? (out << to_string(noUpdateTags))
                          : (out << "<null>"));
    out << ", "
        << "noExpungeTags=";
    (__isset.noExpungeTags ? (out << to_string(noExpungeTags))
                           : (out << "<null>"));
    out << ", "
        << "noSetParentTag=";
    (__isset.noSetParentTag ? (out << to_string(noSetParentTag))
                            : (out << "<null>"));
    out << ", "
        << "noCreateSharedNotebooks=";
    (__isset.noCreateSharedNotebooks
         ? (out << to_string(noCreateSharedNotebooks))
         : (out << "<null>"));
    out << ", "
        << "updateWhichSharedNotebookRestrictions=";
    (__isset.updateWhichSharedNotebookRestrictions
         ? (out << to_string(updateWhichSharedNotebookRestrictions))
         : (out << "<null>"));
    out << ", "
        << "expungeWhichSharedNotebookRestrictions=";
    (__isset.expungeWhichSharedNotebookRestrictions
         ? (out << to_string(expungeWhichSharedNotebookRestrictions))
         : (out << "<null>"));
    out << ", "
        << "noShareNotesWithBusiness=";
    (__isset.noShareNotesWithBusiness
         ? (out << to_string(noShareNotesWithBusiness))
         : (out << "<null>"));
    out << ", "
        << "noRenameNotebook=";
    (__isset.noRenameNotebook ? (out << to_string(noRenameNotebook))
                              : (out << "<null>"));
    out << ", "
        << "noSetInMyList=";
    (__isset.noSetInMyList ? (out << to_string(noSetInMyList))
                           : (out << "<null>"));
    out << ", "
        << "noChangeContact=";
    (__isset.noChangeContact ? (out << to_string(noChangeContact))
                             : (out << "<null>"));
    out << ", "
        << "canMoveToContainerRestrictions=";
    (__isset.canMoveToContainerRestrictions
         ? (out << to_string(canMoveToContainerRestrictions))
         : (out << "<null>"));
    out << ", "
        << "noSetReminderNotifyEmail=";
    (__isset.noSetReminderNotifyEmail
         ? (out << to_string(noSetReminderNotifyEmail))
         : (out << "<null>"));
    out << ", "
        << "noSetReminderNotifyInApp=";
    (__isset.noSetReminderNotifyInApp
         ? (out << to_string(noSetReminderNotifyInApp))
         : (out << "<null>"));
    out << ", "
        << "noSetRecipientSettingsStack=";
    (__isset.noSetRecipientSettingsStack
         ? (out << to_string(noSetRecipientSettingsStack))
         : (out << "<null>"));
    out << ", "
        << "noCanMoveNote=";
    (__isset.noCanMoveNote ? (out << to_string(noCanMoveNote))
                           : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const Notebook &obj) {
    obj.printTo(out);
    return out;
}
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->sharedNotebookIds.resize(_size129);
                    uint32_t _i133;
                    for (_i133 = 0; _i133 < _size129; ++_i133) {
                        xfer += iprot->readI64(this->sharedNotebookIds[_i133]);
                    }
                    xfer += iprot->readListEnd();
                }
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->sharedNotebooks.resize(_size134);
                    uint32_t _i138;
                    for (_i138 = 0; _i138 < _size134; ++_i138) {
                        xfer += this->sharedNotebooks[_i138].read(iprot);
                    }
                    xfer += iprot->readListEnd();
                }
...
uint32_t Notebook::write(::apache::thrift::protocol::TProtocol *oprot) const {
    ...
    if (this->__isset.defaultNotebook) {
        xfer += oprot->writeFieldBegin("defaultNotebook",
                                       ::apache::thrift::protocol::T_BOOL, 6);
    ...
    if (this->__isset.publishing) {
        xfer += oprot->writeFieldBegin(
            "publishing", ::apache::thrift::protocol::T_STRUCT, 10);
        xfer += this->publishing.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.published) {
        xfer += oprot->writeFieldBegin("published",
                                       ::apache::thrift::protocol::T_BOOL, 11);
    ...
    if (this->__isset.stack) {
        xfer += oprot->writeFieldBegin(
            "stack", ::apache::thrift::protocol::T_STRING, 12);
        xfer += oprot->writeString(this->stack);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.sharedNotebookIds) {
        xfer += oprot->writeFieldBegin("sharedNotebookIds",
                                       ::apache::thrift::protocol::T_LIST, 13);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_I64,
                static_cast<uint32_t>(this->sharedNotebookIds.size()));
            std::vector<int64_t>::const_iterator _iter139;
            for (_iter139 = this->sharedNotebookIds.begin();
                 _iter139 != this->sharedNotebookIds.end(); ++_iter139) {
    ...
    if (this->__isset.sharedNotebooks) {
        xfer += oprot->writeFieldBegin("sharedNotebooks",
                                       ::apache::thrift::protocol::T_LIST, 14);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRUCT,
                static_cast<uint32_t>(this->sharedNotebooks.size()));
            std::vector<SharedNotebook>::const_iterator _iter140;
            for (_iter140 = this->sharedNotebooks.begin();
                 _iter140 != this->sharedNotebooks.end(); ++_iter140) {
    ...
    if (this->__isset.businessNotebook) {
        xfer += oprot->writeFieldBegin(
            "businessNotebook", ::apache::thrift::protocol::T_STRUCT, 15);
        xfer += this->businessNotebook.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.contact) {
        xfer += oprot->writeFieldBegin(
            "contact", ::apache::thrift::protocol::T_STRUCT, 16);
        xfer += this->contact.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.restrictions) {
    ...
    if (this->__isset.recipientSettings) {
        xfer += oprot->writeFieldBegin(
            "recipientSettings", ::apache::thrift::protocol::T_STRUCT, 18);
        xfer += this->recipientSettings.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    xfer += oprot->writeFieldStop();
...
Notebook::Notebook(const Notebook &other141) {
    guid = other141.guid;
    name = other141.name;
    updateSequenceNum = other141.updateSequenceNum;
    defaultNotebook = other141.defaultNotebook;
    serviceCreated = other141.serviceCreated;
    serviceUpdated = other141.serviceUpdated;
    publishing = other141.publishing;
    published = other141.published;
    stack = other141.stack;
    sharedNotebookIds = other141.sharedNotebookIds;
    sharedNotebooks = other141.sharedNotebooks;
    businessNotebook = other141.businessNotebook;
    contact = other141.contact;
    restrictions = other141.restrictions;
    recipientSettings = other141.recipientSettings;
    __isset = other141.__isset;
}
Notebook &Notebook::operator=(const Notebook &other142) {
    guid = other142.guid;
    name = other142.name;
    updateSequenceNum = other142.updateSequenceNum;
    defaultNotebook = other142.defaultNotebook;
    serviceCreated = other142.serviceCreated;
    serviceUpdated = other142.serviceUpdated;
    publishing = other142.publishing;
    published = other142.published;
    stack = other142.stack;
    sharedNotebookIds = other142.sharedNotebookIds;
    sharedNotebooks = other142.sharedNotebooks;
    businessNotebook = other142.businessNotebook;
    contact = other142.contact;
    restrictions = other142.restrictions;
    recipientSettings = other142.recipientSettings;
...
void Notebook::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "defaultNotebook=";
    (__isset.defaultNotebook ? (out << to_string(defaultNotebook))
                             : (out << "<null>"));
    out << ", "
        << "serviceCreated=";
    (__isset.serviceCreated ? (out << to_string(serviceCreated))
    ...
    out << ", "
        << "publishing=";
    (__isset.publishing ? (out << to_string(publishing)) : (out << "<null>"));
    out << ", "
        << "published=";
    (__isset.published ? (out << to_string(published)) : (out << "<null>"));
    out << ", "
        << "stack=";
    (__isset.stack ? (out << to_string(stack)) : (out << "<null>"));
    out << ", "
        << "sharedNotebookIds=";
    (__isset.sharedNotebookIds ? (out << to_string(sharedNotebookIds))
                               : (out << "<null>"));
    out << ", "
        << "sharedNotebooks=";
    (__isset.sharedNotebooks ? (out << to_string(sharedNotebooks))
                             : (out << "<null>"));
    out << ", "
        << "businessNotebook=";
    (__isset.businessNotebook ? (out << to_string(businessNotebook))
                              : (out << "<null>"));
    out << ", "
        << "contact=";
    (__isset.contact ? (out << to_string(contact)) : (out << "<null>"));
...
std::ostream &operator<<(std::ostream &out, const LinkedNotebook &obj) {
    obj.printTo(out);
    return out;
}
...
uint32_t
LinkedNotebook::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("LinkedNotebook");

    if (this->__isset.shareName) {
        xfer += oprot->writeFieldBegin("shareName",
                                       ::apache::thrift::protocol::T_STRING, 2);
    ...
    if (this->__isset.shardId) {
        xfer += oprot->writeFieldBegin("shardId",
                                       ::apache::thrift::protocol::T_STRING, 4);
        xfer += oprot->writeString(this->shardId);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.sharedNotebookGlobalId) {
        xfer += oprot->writeFieldBegin("sharedNotebookGlobalId",
                                       ::apache::thrift::protocol::T_STRING, 5);
    ...
    if (this->__isset.noteStoreUrl) {
        xfer += oprot->writeFieldBegin("noteStoreUrl",
                                       ::apache::thrift::protocol::T_STRING, 9);
    ...
    if (this->__isset.webApiUrlPrefix) {
        xfer += oprot->writeFieldBegin(
            "webApiUrlPrefix", ::apache::thrift::protocol::T_STRING, 10);
        xfer += oprot->writeString(this->webApiUrlPrefix);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.stack) {
        xfer += oprot->writeFieldBegin(
            "stack", ::apache::thrift::protocol::T_STRING, 11);
        xfer += oprot->writeString(this->stack);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.businessId) {
...
LinkedNotebook::LinkedNotebook(const LinkedNotebook &other143) {
    shareName = other143.shareName;
    username = other143.username;
    shardId = other143.shardId;
    sharedNotebookGlobalId = other143.sharedNotebookGlobalId;
    uri = other143.uri;
    guid = other143.guid;
    updateSequenceNum = other143.updateSequenceNum;
    noteStoreUrl = other143.noteStoreUrl;
    webApiUrlPrefix = other143.webApiUrlPrefix;
    stack = other143.stack;
    businessId = other143.businessId;
    __isset = other143.__isset;
}
LinkedNotebook &LinkedNotebook::operator=(const LinkedNotebook &other144) {
    shareName = other144.shareName;
    username = other144.username;
    shardId = other144.shardId;
    sharedNotebookGlobalId = other144.sharedNotebookGlobalId;
    uri = other144.uri;
    guid = other144.guid;
    updateSequenceNum = other144.updateSequenceNum;
    noteStoreUrl = other144.noteStoreUrl;
    webApiUrlPrefix = other144.webApiUrlPrefix;
    stack = other144.stack;
    businessId = other144.businessId;
...
void LinkedNotebook::printTo(std::ostream &out) const {
    ...
    out << "LinkedNotebook(";
    out << "shareName=";
    (__isset.shareName ? (out << to_string(shareName)) : (out << "<null>"));
    out << ", "
        << "username=";
    (__isset.username ? (out << to_string(username)) : (out << "<null>"));
    out << ", "
    ...
    (__isset.sharedNotebookGlobalId ? (out << to_string(sharedNotebookGlobalId))
                                    : (out << "<null>"));
    out << ", "
        << "uri=";
    (__isset.uri ? (out << to_string(uri)) : (out << "<null>"));
    ...
    out << ", "
        << "noteStoreUrl=";
    (__isset.noteStoreUrl ? (out << to_string(noteStoreUrl))
                          : (out << "<null>"));
    out << ", "
        << "webApiUrlPrefix=";
    (__isset.webApiUrlPrefix ? (out << to_string(webApiUrlPrefix))
                             : (out << "<null>"));
    out << ", "
        << "stack=";
    (__isset.stack ? (out << to_string(stack)) : (out << "<null>"));
...
std::ostream &operator<<(std::ostream &out, const NotebookDescriptor &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
NotebookDescriptor::read(::apache::thrift::protocol::TProtocol *iprot) {
...
uint32_t
NotebookDescriptor::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
...
NotebookDescriptor::NotebookDescriptor(const NotebookDescriptor &other145) {
    guid = other145.guid;
    notebookDisplayName = other145.notebookDisplayName;
    contactName = other145.contactName;
    hasSharedNotebook = other145.hasSharedNotebook;
    joinedUserCount = other145.joinedUserCount;
    __isset = other145.__isset;
}
NotebookDescriptor &NotebookDescriptor::
operator=(const NotebookDescriptor &other146) {
    guid = other146.guid;
    notebookDisplayName = other146.notebookDisplayName;
    contactName = other146.contactName;
    hasSharedNotebook = other146.hasSharedNotebook;
    joinedUserCount = other146.joinedUserCount;
...
void NotebookDescriptor::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "notebookDisplayName=";
    (__isset.notebookDisplayName ? (out << to_string(notebookDisplayName))
                                 : (out << "<null>"));
    out << ", "
        << "contactName=";
    (__isset.contactName ? (out << to_string(contactName)) : (out << "<null>"));
    out << ", "
        << "hasSharedNotebook=";
    (__isset.hasSharedNotebook ? (out << to_string(hasSharedNotebook))
                               : (out << "<null>"));
    out << ", "
        << "joinedUserCount=";
    (__isset.joinedUserCount ? (out << to_string(joinedUserCount))
                             : (out << "<null>"));
    out << ")";
}
...
void UserProfile::__set_status(const BusinessUserStatus::type val) {
    this->status = val;
    __isset.status = true;
}
    ...
    while (true) {
        ...
        case 9:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->role = (BusinessUserRole::type)ecast147;
                this->__isset.role = true;
            } else {
                xfer += iprot->skip(ftype);
            }
        ...
        case 10:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->status = (BusinessUserStatus::type)ecast148;
...
uint32_t
UserProfile::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.attributes) {
        xfer += oprot->writeFieldBegin("attributes",
                                       ::apache::thrift::protocol::T_STRUCT, 5);
        xfer += this->attributes.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.joined) {
        xfer += oprot->writeFieldBegin("joined",
                                       ::apache::thrift::protocol::T_I64, 6);
...
UserProfile::UserProfile(const UserProfile &other149) {
    id = other149.id;
    name = other149.name;
    email = other149.email;
    username = other149.username;
    attributes = other149.attributes;
    joined = other149.joined;
    photoLastUpdated = other149.photoLastUpdated;
    photoUrl = other149.photoUrl;
    role = other149.role;
    status = other149.status;
    __isset = other149.__isset;
}
UserProfile &UserProfile::operator=(const UserProfile &other150) {
    id = other150.id;
    name = other150.name;
    email = other150.email;
    username = other150.username;
    attributes = other150.attributes;
    joined = other150.joined;
    photoLastUpdated = other150.photoLastUpdated;
    photoUrl = other150.photoUrl;
    role = other150.role;
...
void UserProfile::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "joined=";
    (__isset.joined ? (out << to_string(joined)) : (out << "<null>"));
    out << ", "
        << "photoLastUpdated=";
    (__isset.photoLastUpdated ? (out << to_string(photoLastUpdated))
                              : (out << "<null>"));
...
std::ostream &operator<<(std::ostream &out, const RelatedContentImage &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
RelatedContentImage::read(::apache::thrift::protocol::TProtocol *iprot) {
...
uint32_t
RelatedContentImage::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("RelatedContentImage");

    if (this->__isset.url) {
        xfer += oprot->writeFieldBegin("url",
                                       ::apache::thrift::protocol::T_STRING, 1);
    ...
    if (this->__isset.pixelRatio) {
        xfer += oprot->writeFieldBegin("pixelRatio",
                                       ::apache::thrift::protocol::T_DOUBLE, 4);
...
RelatedContentImage::RelatedContentImage(const RelatedContentImage &other151) {
    url = other151.url;
    width = other151.width;
    height = other151.height;
    pixelRatio = other151.pixelRatio;
    fileSize = other151.fileSize;
    __isset = other151.__isset;
}
RelatedContentImage &RelatedContentImage::
operator=(const RelatedContentImage &other152) {
    url = other152.url;
    width = other152.width;
    height = other152.height;
    pixelRatio = other152.pixelRatio;
...
void RelatedContentImage::printTo(std::ostream &out) const {
    ...
    out << "url=";
    (__isset.url ? (out << to_string(url)) : (out << "<null>"));
    out << ", "
        << "width=";
    (__isset.width ? (out << to_string(width)) : (out << "<null>"));
    out << ", "
    ...
    out << ", "
        << "pixelRatio=";
    (__isset.pixelRatio ? (out << to_string(pixelRatio)) : (out << "<null>"));
    out << ", "
        << "fileSize=";
    (__isset.fileSize ? (out << to_string(fileSize)) : (out << "<null>"));
    out << ")";
}
...
void RelatedContent::__set_thumbnails(
    const std::vector<RelatedContentImage> &val) {
    this->thumbnails = val;
...
std::ostream &operator<<(std::ostream &out, const RelatedContent &obj) {
    obj.printTo(out);
    return out;
}
    ...
    while (true) {
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->thumbnails.resize(_size153);
                    uint32_t _i157;
                    for (_i157 = 0; _i157 < _size153; ++_i157) {
                        xfer += this->thumbnails[_i157].read(iprot);
                    }
                    xfer += iprot->readListEnd();
                }
        ...
        case 11:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->contentType = (RelatedContentType::type)ecast158;
        ...
        case 12:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->accessType = (RelatedContentAccess::type)ecast159;
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->authors.resize(_size160);
                    uint32_t _i164;
                    for (_i164 = 0; _i164 < _size160; ++_i164) {
                        xfer += iprot->readString(this->authors[_i164]);
                    }
                    xfer += iprot->readListEnd();
                }
...
uint32_t
RelatedContent::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    xfer += oprot->writeStructBegin("RelatedContent");

    if (this->__isset.contentId) {
        xfer += oprot->writeFieldBegin("contentId",
                                       ::apache::thrift::protocol::T_STRING, 1);
    ...
    if (this->__isset.sourceId) {
        xfer += oprot->writeFieldBegin("sourceId",
                                       ::apache::thrift::protocol::T_STRING, 4);
    ...
    if (this->__isset.sourceFaviconUrl) {
        xfer += oprot->writeFieldBegin("sourceFaviconUrl",
                                       ::apache::thrift::protocol::T_STRING, 6);
        xfer += oprot->writeString(this->sourceFaviconUrl);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.sourceName) {
        xfer += oprot->writeFieldBegin("sourceName",
                                       ::apache::thrift::protocol::T_STRING, 7);
        xfer += oprot->writeString(this->sourceName);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.date) {
        xfer += oprot->writeFieldBegin("date",
                                       ::apache::thrift::protocol::T_I64, 8);
        xfer += oprot->writeI64(this->date);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.teaser) {
        xfer += oprot->writeFieldBegin("teaser",
                                       ::apache::thrift::protocol::T_STRING, 9);
        xfer += oprot->writeString(this->teaser);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.thumbnails) {
        xfer += oprot->writeFieldBegin("thumbnails",
                                       ::apache::thrift::protocol::T_LIST, 10);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRUCT,
                static_cast<uint32_t>(this->thumbnails.size()));
            std::vector<RelatedContentImage>::const_iterator _iter165;
            for (_iter165 = this->thumbnails.begin();
                 _iter165 != this->thumbnails.end(); ++_iter165) {
    ...
    if (this->__isset.contentType) {
        xfer += oprot->writeFieldBegin("contentType",
                                       ::apache::thrift::protocol::T_I32, 11);
        xfer += oprot->writeI32((int32_t)this->contentType);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.accessType) {
        xfer += oprot->writeFieldBegin("accessType",
                                       ::apache::thrift::protocol::T_I32, 12);
    ...
    if (this->__isset.visibleUrl) {
        xfer += oprot->writeFieldBegin(
            "visibleUrl", ::apache::thrift::protocol::T_STRING, 13);
        xfer += oprot->writeString(this->visibleUrl);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.clipUrl) {
        xfer += oprot->writeFieldBegin(
            "clipUrl", ::apache::thrift::protocol::T_STRING, 14);
        xfer += oprot->writeString(this->clipUrl);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.contact) {
        xfer += oprot->writeFieldBegin(
            "contact", ::apache::thrift::protocol::T_STRUCT, 15);
        xfer += this->contact.write(oprot);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.authors) {
        xfer += oprot->writeFieldBegin("authors",
                                       ::apache::thrift::protocol::T_LIST, 16);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->authors.size()));
            std::vector<std::string>::const_iterator _iter166;
            for (_iter166 = this->authors.begin();
                 _iter166 != this->authors.end(); ++_iter166) {
...
RelatedContent::RelatedContent(const RelatedContent &other167) {
    contentId = other167.contentId;
    title = other167.title;
    url = other167.url;
    sourceId = other167.sourceId;
    sourceUrl = other167.sourceUrl;
    sourceFaviconUrl = other167.sourceFaviconUrl;
    sourceName = other167.sourceName;
    date = other167.date;
    teaser = other167.teaser;
    thumbnails = other167.thumbnails;
    contentType = other167.contentType;
    accessType = other167.accessType;
    visibleUrl = other167.visibleUrl;
    clipUrl = other167.clipUrl;
    contact = other167.contact;
    authors = other167.authors;
    __isset = other167.__isset;
}
RelatedContent &RelatedContent::operator=(const RelatedContent &other168) {
    contentId = other168.contentId;
    title = other168.title;
    url = other168.url;
    sourceId = other168.sourceId;
    sourceUrl = other168.sourceUrl;
    sourceFaviconUrl = other168.sourceFaviconUrl;
    sourceName = other168.sourceName;
    date = other168.date;
    teaser = other168.teaser;
    thumbnails = other168.thumbnails;
    contentType = other168.contentType;
    accessType = other168.accessType;
    visibleUrl = other168.visibleUrl;
    clipUrl = other168.clipUrl;
    contact = other168.contact;
    authors = other168.authors;
...
void RelatedContent::printTo(std::ostream &out) const {
    ...
    out << "RelatedContent(";
    out << "contentId=";
    (__isset.contentId ? (out << to_string(contentId)) : (out << "<null>"));
    out << ", "
        << "title=";
    (__isset.title ? (out << to_string(title)) : (out << "<null>"));
    out << ", "
    ...
    out << ", "
        << "sourceId=";
    (__isset.sourceId ? (out << to_string(sourceId)) : (out << "<null>"));
    out << ", "
        << "sourceUrl=";
    (__isset.sourceUrl ? (out << to_string(sourceUrl)) : (out << "<null>"));
    out << ", "
        << "sourceFaviconUrl=";
    (__isset.sourceFaviconUrl ? (out << to_string(sourceFaviconUrl))
                              : (out << "<null>"));
    out << ", "
        << "sourceName=";
    (__isset.sourceName ? (out << to_string(sourceName)) : (out << "<null>"));
    out << ", "
        << "date=";
    (__isset.date ? (out << to_string(date)) : (out << "<null>"));
    out << ", "
        << "teaser=";
    (__isset.teaser ? (out << to_string(teaser)) : (out << "<null>"));
    out << ", "
        << "thumbnails=";
    (__isset.thumbnails ? (out << to_string(thumbnails)) : (out << "<null>"));
    out << ", "
        << "contentType=";
    (__isset.contentType ? (out << to_string(contentType)) : (out << "<null>"));
    out << ", "
        << "accessType=";
    (__isset.accessType ? (out << to_string(accessType)) : (out << "<null>"));
    out << ", "
        << "visibleUrl=";
    (__isset.visibleUrl ? (out << to_string(visibleUrl)) : (out << "<null>"));
    out << ", "
        << "clipUrl=";
    (__isset.clipUrl ? (out << to_string(clipUrl)) : (out << "<null>"));
    out << ", "
        << "contact=";
    (__isset.contact ? (out << to_string(contact)) : (out << "<null>"));
    out << ", "
        << "authors=";
    (__isset.authors ? (out << to_string(authors)) : (out << "<null>"));
    out << ")";
}
...
void BusinessInvitation::__set_status(
    const BusinessInvitationStatus::type val) {
    this->status = val;
    __isset.status = true;
}
...
void BusinessInvitation::__set_mostRecentReminder(const Timestamp val) {
    this->mostRecentReminder = val;
    __isset.mostRecentReminder = true;
}
std::ostream &operator<<(std::ostream &out, const BusinessInvitation &obj) {
    obj.printTo(out);
    return out;
}

uint32_t
BusinessInvitation::read(::apache::thrift::protocol::TProtocol *iprot) {
    ...
    while (true) {
        ...
        case 3:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->role = (BusinessUserRole::type)ecast169;
                this->__isset.role = true;
            } else {
                xfer += iprot->skip(ftype);
            }
        ...
        case 4:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->status = (BusinessInvitationStatus::type)ecast170;
                this->__isset.status = true;
            } else {
                xfer += iprot->skip(ftype);
            }
        ...
        case 8:
            if (ftype == ::apache::thrift::protocol::T_I64) {
                xfer += iprot->readI64(this->mostRecentReminder);
                this->__isset.mostRecentReminder = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            break;
...
uint32_t
BusinessInvitation::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.requesterId) {
        xfer += oprot->writeFieldBegin("requesterId",
                                       ::apache::thrift::protocol::T_I32, 5);
        xfer += oprot->writeI32(this->requesterId);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.fromWorkChat) {
        xfer += oprot->writeFieldBegin("fromWorkChat",
                                       ::apache::thrift::protocol::T_BOOL, 6);
    ...
    if (this->__isset.mostRecentReminder) {
        xfer += oprot->writeFieldBegin("mostRecentReminder",
                                       ::apache::thrift::protocol::T_I64, 8);
        xfer += oprot->writeI64(this->mostRecentReminder);
        xfer += oprot->writeFieldEnd();
    }
    xfer += oprot->writeFieldStop();
    xfer += oprot->writeStructEnd();
...
void swap(BusinessInvitation &a, BusinessInvitation &b) {
    ...
    swap(a.created, b.created);
    swap(a.mostRecentReminder, b.mostRecentReminder);
    swap(a.__isset, b.__isset);
}

BusinessInvitation::BusinessInvitation(const BusinessInvitation &other171) {
    businessId = other171.businessId;
    email = other171.email;
    role = other171.role;
    status = other171.status;
    requesterId = other171.requesterId;
    fromWorkChat = other171.fromWorkChat;
    created = other171.created;
    mostRecentReminder = other171.mostRecentReminder;
    __isset = other171.__isset;
}
BusinessInvitation &BusinessInvitation::
operator=(const BusinessInvitation &other172) {
    businessId = other172.businessId;
    email = other172.email;
    role = other172.role;
    status = other172.status;
    requesterId = other172.requesterId;
    fromWorkChat = other172.fromWorkChat;
    created = other172.created;
    mostRecentReminder = other172.mostRecentReminder;
...
void BusinessInvitation::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "requesterId=";
    (__isset.requesterId ? (out << to_string(requesterId)) : (out << "<null>"));
    out << ", "
        << "fromWorkChat=";
    (__isset.fromWorkChat ? (out << to_string(fromWorkChat))
                          : (out << "<null>"));
    out << ", "
        << "created=";
    (__isset.created ? (out << to_string(created)) : (out << "<null>"));
    out << ", "
        << "mostRecentReminder=";
    (__isset.mostRecentReminder ? (out << to_string(mostRecentReminder))
                                : (out << "<null>"));
    out << ")";
}
...
std::ostream &operator<<(std::ostream &out, const UserIdentity &obj) {
    obj.printTo(out);
    return out;
}
    ...
    while (true) {
        ...
        case 1:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->type = (UserIdentityType::type)ecast173;
                this->__isset.type = true;
            } else {
                xfer += iprot->skip(ftype);
            }
...
uint32_t
UserIdentity::write(::apache::thrift::protocol::TProtocol *oprot) const {
    uint32_t xfer = 0;
    ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
    ...
    if (this->__isset.stringIdentifier) {
        xfer += oprot->writeFieldBegin("stringIdentifier",
                                       ::apache::thrift::protocol::T_STRING, 2);
        xfer += oprot->writeString(this->stringIdentifier);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.longIdentifier) {
        xfer += oprot->writeFieldBegin("longIdentifier",
                                       ::apache::thrift::protocol::T_I64, 3);
...
UserIdentity::UserIdentity(const UserIdentity &other174) {
    type = other174.type;
    stringIdentifier = other174.stringIdentifier;
    longIdentifier = other174.longIdentifier;
    __isset = other174.__isset;
}
UserIdentity &UserIdentity::operator=(const UserIdentity &other175) {
    type = other175.type;
    stringIdentifier = other175.stringIdentifier;
    longIdentifier = other175.longIdentifier;
...
void UserIdentity::printTo(std::ostream &out) const {
    ...
    out << ", "
        << "stringIdentifier=";
    (__isset.stringIdentifier ? (out << to_string(stringIdentifier))
                              : (out << "<null>"));
    out << ", "
        << "longIdentifier=";
    (__isset.longIdentifier ? (out << to_string(longIdentifier))
                            : (out << "<null>"));
    out << ")";
}
