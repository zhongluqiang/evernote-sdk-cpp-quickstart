...
extern const std::map<int, const char *>
    _ShareRelationshipPrivilegeLevel_VALUES_TO_NAMES;

std::ostream &operator<<(std::ostream &out,
                         const ShareRelationshipPrivilegeLevel::type &val);
...
typedef struct _SyncState__isset {
    _SyncState__isset()
        : uploaded(false), userLastUpdated(false),
          userMaxMessageEventId(false) {}
    bool uploaded : 1;
    bool userLastUpdated : 1;
    bool userMaxMessageEventId : 1;
} _SyncState__isset;

class SyncState : public virtual ::apache::thrift::TBase {
  public:
    SyncState(const SyncState &);
    SyncState &operator=(const SyncState &);
    SyncState()
        : currentTime(0), fullSyncBefore(0), updateCount(0), uploaded(0),
          userLastUpdated(0), userMaxMessageEventId(0) {}
    ...
    void
    __set_userMaxMessageEventId(const ::evernote::edam::MessageEventID val);
    ...
    bool operator==(const SyncState &rhs) const {
        ...
        if (__isset.userLastUpdated != rhs.__isset.userLastUpdated)
            return false;
        else if (__isset.userLastUpdated &&
                 !(userLastUpdated == rhs.userLastUpdated))
            return false;
        if (__isset.userMaxMessageEventId != rhs.__isset.userMaxMessageEventId)
            return false;
        else if (__isset.userMaxMessageEventId &&
                 !(userMaxMessageEventId == rhs.userMaxMessageEventId))
            return false;
        return true;
    }
    bool operator!=(const SyncState &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const SyncState &obj);

typedef struct _SyncChunk__isset {
    _SyncChunk__isset()
        : chunkHighUSN(false), notes(false), notebooks(false), tags(false),
          searches(false), resources(false), expungedNotes(false),
          expungedNotebooks(false), expungedTags(false),
          expungedSearches(false), linkedNotebooks(false),
          expungedLinkedNotebooks(false) {}
    bool chunkHighUSN : 1;
    bool notes : 1;
    bool notebooks : 1;
    bool tags : 1;
...
class SyncChunk : public virtual ::apache::thrift::TBase {
  public:
    ...
    void
    __set_expungedNotebooks(const std::vector<::evernote::edam::Guid> &val);
    ...
    void __set_linkedNotebooks(
        const std::vector<::evernote::edam::LinkedNotebook> &val);

    void __set_expungedLinkedNotebooks(
        const std::vector<::evernote::edam::Guid> &val);
    ...
    bool operator==(const SyncChunk &rhs) const {
        ...
        if (__isset.expungedNotebooks != rhs.__isset.expungedNotebooks)
            return false;
        else if (__isset.expungedNotebooks &&
                 !(expungedNotebooks == rhs.expungedNotebooks))
            return false;
        ...
        if (__isset.expungedSearches != rhs.__isset.expungedSearches)
            return false;
        else if (__isset.expungedSearches &&
                 !(expungedSearches == rhs.expungedSearches))
            return false;
        if (__isset.linkedNotebooks != rhs.__isset.linkedNotebooks)
            return false;
        else if (__isset.linkedNotebooks &&
                 !(linkedNotebooks == rhs.linkedNotebooks))
            return false;
        if (__isset.expungedLinkedNotebooks !=
            rhs.__isset.expungedLinkedNotebooks)
            return false;
        else if (__isset.expungedLinkedNotebooks &&
                 !(expungedLinkedNotebooks == rhs.expungedLinkedNotebooks))
            return false;
        return true;
    }
    bool operator!=(const SyncChunk &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const SyncChunk &obj);

typedef struct _SyncChunkFilter__isset {
    _SyncChunkFilter__isset()
        : includeNotes(false), includeNoteResources(false),
          includeNoteAttributes(false), includeNotebooks(false),
          includeTags(false), includeSearches(false), includeResources(false),
          includeLinkedNotebooks(false), includeExpunged(false),
          ...
          includeSharedNotes(false), omitSharedNotebooks(false),
          requireNoteContentClass(false), notebookGuids(false) {}
    bool includeNotes : 1;
...
class SyncChunkFilter : public virtual ::apache::thrift::TBase {
  public:
    SyncChunkFilter(const SyncChunkFilter &);
    SyncChunkFilter &operator=(const SyncChunkFilter &);
    SyncChunkFilter()
        : includeNotes(0), includeNoteResources(0), includeNoteAttributes(0),
          includeNotebooks(0), includeTags(0), includeSearches(0),
          includeResources(0), includeLinkedNotebooks(0), includeExpunged(0),
          includeNoteApplicationDataFullMap(0),
          includeResourceApplicationDataFullMap(0),
          includeNoteResourceApplicationDataFullMap(0), includeSharedNotes(0),
          omitSharedNotebooks(0), requireNoteContentClass() {}
    ...
    bool operator==(const SyncChunkFilter &rhs) const {
        ...
        if (__isset.includeNoteResources != rhs.__isset.includeNoteResources)
            return false;
        else if (__isset.includeNoteResources &&
                 !(includeNoteResources == rhs.includeNoteResources))
            return false;
        if (__isset.includeNoteAttributes != rhs.__isset.includeNoteAttributes)
            return false;
        else if (__isset.includeNoteAttributes &&
                 !(includeNoteAttributes == rhs.includeNoteAttributes))
            return false;
        if (__isset.includeNotebooks != rhs.__isset.includeNotebooks)
            return false;
        else if (__isset.includeNotebooks &&
                 !(includeNotebooks == rhs.includeNotebooks))
            return false;
        ...
        if (__isset.includeSearches != rhs.__isset.includeSearches)
            return false;
        else if (__isset.includeSearches &&
                 !(includeSearches == rhs.includeSearches))
            return false;
        if (__isset.includeResources != rhs.__isset.includeResources)
            return false;
        else if (__isset.includeResources &&
                 !(includeResources == rhs.includeResources))
            return false;
        if (__isset.includeLinkedNotebooks !=
            rhs.__isset.includeLinkedNotebooks)
            return false;
        else if (__isset.includeLinkedNotebooks &&
                 !(includeLinkedNotebooks == rhs.includeLinkedNotebooks))
            return false;
        if (__isset.includeExpunged != rhs.__isset.includeExpunged)
            return false;
        else if (__isset.includeExpunged &&
                 !(includeExpunged == rhs.includeExpunged))
            return false;
        if (__isset.includeNoteApplicationDataFullMap !=
            rhs.__isset.includeNoteApplicationDataFullMap)
            return false;
        else if (__isset.includeNoteApplicationDataFullMap &&
                 !(includeNoteApplicationDataFullMap ==
                   rhs.includeNoteApplicationDataFullMap))
            return false;
        if (__isset.includeResourceApplicationDataFullMap !=
            rhs.__isset.includeResourceApplicationDataFullMap)
            return false;
        else if (__isset.includeResourceApplicationDataFullMap &&
                 !(includeResourceApplicationDataFullMap ==
                   rhs.includeResourceApplicationDataFullMap))
            return false;
        if (__isset.includeNoteResourceApplicationDataFullMap !=
            rhs.__isset.includeNoteResourceApplicationDataFullMap)
            return false;
        else if (__isset.includeNoteResourceApplicationDataFullMap &&
                 !(includeNoteResourceApplicationDataFullMap ==
                   rhs.includeNoteResourceApplicationDataFullMap))
            return false;
        if (__isset.includeSharedNotes != rhs.__isset.includeSharedNotes)
            return false;
        else if (__isset.includeSharedNotes &&
                 !(includeSharedNotes == rhs.includeSharedNotes))
            return false;
        if (__isset.omitSharedNotebooks != rhs.__isset.omitSharedNotebooks)
            return false;
        else if (__isset.omitSharedNotebooks &&
                 !(omitSharedNotebooks == rhs.omitSharedNotebooks))
            return false;
        if (__isset.requireNoteContentClass !=
            rhs.__isset.requireNoteContentClass)
            return false;
        else if (__isset.requireNoteContentClass &&
                 !(requireNoteContentClass == rhs.requireNoteContentClass))
            return false;
...
std::ostream &operator<<(std::ostream &out, const SyncChunkFilter &obj);

typedef struct _NoteFilter__isset {
    _NoteFilter__isset()
        : order(false), ascending(false), words(false), notebookGuid(false),
          tagGuids(false), timeZone(false), inactive(false), emphasized(false),
          includeAllReadableNotebooks(false),
          includeAllReadableWorkspaces(false), context(false), rawWords(false),
          searchContextBytes(false) {}
    bool order : 1;
    bool ascending : 1;
    bool words : 1;
    bool notebookGuid : 1;
    ...
    bool includeAllReadableWorkspaces : 1;
    bool context : 1;
    bool rawWords : 1;
    bool searchContextBytes : 1;
} _NoteFilter__isset;

class NoteFilter : public virtual ::apache::thrift::TBase {
  public:
    NoteFilter(const NoteFilter &);
    NoteFilter &operator=(const NoteFilter &);
    NoteFilter()
        : order(0), ascending(0), words(), notebookGuid(), timeZone(),
          inactive(0), emphasized(), includeAllReadableNotebooks(0),
          includeAllReadableWorkspaces(0), context(), rawWords(),
          searchContextBytes() {}
    ...
    bool includeAllReadableWorkspaces;
    std::string context;
    std::string rawWords;
    std::string searchContextBytes;
    ...
    void __set_includeAllReadableWorkspaces(const bool val);

    void __set_context(const std::string &val);

    void __set_rawWords(const std::string &val);

    void __set_searchContextBytes(const std::string &val);
    ...
    bool operator==(const NoteFilter &rhs) const {
        ...
        if (__isset.includeAllReadableNotebooks !=
            rhs.__isset.includeAllReadableNotebooks)
            return false;
        else if (__isset.includeAllReadableNotebooks &&
                 !(includeAllReadableNotebooks ==
                   rhs.includeAllReadableNotebooks))
            return false;
        if (__isset.includeAllReadableWorkspaces !=
            rhs.__isset.includeAllReadableWorkspaces)
            return false;
        else if (__isset.includeAllReadableWorkspaces &&
                 !(includeAllReadableWorkspaces ==
                   rhs.includeAllReadableWorkspaces))
            return false;
        if (__isset.context != rhs.__isset.context)
            return false;
        else if (__isset.context && !(context == rhs.context))
            return false;
        if (__isset.rawWords != rhs.__isset.rawWords)
            return false;
        else if (__isset.rawWords && !(rawWords == rhs.rawWords))
            return false;
        if (__isset.searchContextBytes != rhs.__isset.searchContextBytes)
            return false;
        else if (__isset.searchContextBytes &&
                 !(searchContextBytes == rhs.searchContextBytes))
            return false;
        return true;
    }
    bool operator!=(const NoteFilter &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const NoteFilter &obj);

typedef struct _NoteList__isset {
    _NoteList__isset()
        : stoppedWords(false), searchedWords(false), updateCount(false),
          searchContextBytes(false), debugInfo(false) {}
    bool stoppedWords : 1;
...
class NoteList : public virtual ::apache::thrift::TBase {
  public:
    NoteList(const NoteList &);
    NoteList &operator=(const NoteList &);
    NoteList()
        : startIndex(0), totalNotes(0), updateCount(0), searchContextBytes(),
          debugInfo() {}
    ...
    void __set_debugInfo(const std::string &val);
    ...
    bool operator!=(const NoteList &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const NoteList &obj);

typedef struct _NoteMetadata__isset {
    _NoteMetadata__isset()
        : title(false), contentLength(false), created(false), updated(false),
          deleted(false), updateSequenceNum(false), notebookGuid(false),
          tagGuids(false), attributes(false), largestResourceMime(false),
          largestResourceSize(false) {}
    bool title : 1;
...
class NoteMetadata : public virtual ::apache::thrift::TBase {
  public:
    NoteMetadata(const NoteMetadata &);
    NoteMetadata &operator=(const NoteMetadata &);
    NoteMetadata()
        : guid(), title(), contentLength(0), created(0), updated(0), deleted(0),
          updateSequenceNum(0), notebookGuid(), largestResourceMime(),
    ...
    bool operator==(const NoteMetadata &rhs) const {
        ...
        if (__isset.largestResourceMime != rhs.__isset.largestResourceMime)
            return false;
        else if (__isset.largestResourceMime &&
                 !(largestResourceMime == rhs.largestResourceMime))
            return false;
        if (__isset.largestResourceSize != rhs.__isset.largestResourceSize)
            return false;
        else if (__isset.largestResourceSize &&
                 !(largestResourceSize == rhs.largestResourceSize))
            return false;
        return true;
    }
    bool operator!=(const NoteMetadata &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const NoteMetadata &obj);
...
class NotesMetadataList : public virtual ::apache::thrift::TBase {
  public:
...
std::ostream &operator<<(std::ostream &out, const NotesMetadataList &obj);

typedef struct _NotesMetadataResultSpec__isset {
    _NotesMetadataResultSpec__isset()
        : includeTitle(false), includeContentLength(false),
          includeCreated(false), includeUpdated(false), includeDeleted(false),
          includeUpdateSequenceNum(false), includeNotebookGuid(false),
          includeTagGuids(false), includeAttributes(false),
          includeLargestResourceMime(false), includeLargestResourceSize(false) {
    }
    bool includeTitle : 1;
...
class NotesMetadataResultSpec : public virtual ::apache::thrift::TBase {
  public:
    NotesMetadataResultSpec(const NotesMetadataResultSpec &);
    NotesMetadataResultSpec &operator=(const NotesMetadataResultSpec &);
    NotesMetadataResultSpec()
        : includeTitle(0), includeContentLength(0), includeCreated(0),
          includeUpdated(0), includeDeleted(0), includeUpdateSequenceNum(0),
          includeNotebookGuid(0), includeTagGuids(0), includeAttributes(0),
          includeLargestResourceMime(0), includeLargestResourceSize(0) {}
    ...
    bool operator==(const NotesMetadataResultSpec &rhs) const {
        ...
        if (__isset.includeContentLength != rhs.__isset.includeContentLength)
            return false;
        else if (__isset.includeContentLength &&
                 !(includeContentLength == rhs.includeContentLength))
            return false;
        if (__isset.includeCreated != rhs.__isset.includeCreated)
            return false;
        else if (__isset.includeCreated &&
                 !(includeCreated == rhs.includeCreated))
            return false;
        if (__isset.includeUpdated != rhs.__isset.includeUpdated)
            return false;
        else if (__isset.includeUpdated &&
                 !(includeUpdated == rhs.includeUpdated))
            return false;
        if (__isset.includeDeleted != rhs.__isset.includeDeleted)
            return false;
        else if (__isset.includeDeleted &&
                 !(includeDeleted == rhs.includeDeleted))
            return false;
        if (__isset.includeUpdateSequenceNum !=
            rhs.__isset.includeUpdateSequenceNum)
            return false;
        else if (__isset.includeUpdateSequenceNum &&
                 !(includeUpdateSequenceNum == rhs.includeUpdateSequenceNum))
            return false;
        if (__isset.includeNotebookGuid != rhs.__isset.includeNotebookGuid)
            return false;
        else if (__isset.includeNotebookGuid &&
                 !(includeNotebookGuid == rhs.includeNotebookGuid))
            return false;
        if (__isset.includeTagGuids != rhs.__isset.includeTagGuids)
            return false;
        else if (__isset.includeTagGuids &&
                 !(includeTagGuids == rhs.includeTagGuids))
            return false;
        if (__isset.includeAttributes != rhs.__isset.includeAttributes)
            return false;
        else if (__isset.includeAttributes &&
                 !(includeAttributes == rhs.includeAttributes))
            return false;
        if (__isset.includeLargestResourceMime !=
            rhs.__isset.includeLargestResourceMime)
            return false;
        else if (__isset.includeLargestResourceMime &&
                 !(includeLargestResourceMime ==
                   rhs.includeLargestResourceMime))
            return false;
        if (__isset.includeLargestResourceSize !=
            rhs.__isset.includeLargestResourceSize)
            return false;
        else if (__isset.includeLargestResourceSize &&
                 !(includeLargestResourceSize ==
                   rhs.includeLargestResourceSize))
            return false;
        return true;
    }
    bool operator!=(const NotesMetadataResultSpec &rhs) const {
...
std::ostream &operator<<(std::ostream &out, const NotesMetadataResultSpec &obj);

typedef struct _NoteCollectionCounts__isset {
    _NoteCollectionCounts__isset()
        : notebookCounts(false), tagCounts(false), trashCount(false) {}
    bool notebookCounts : 1;
    bool tagCounts : 1;
    bool trashCount : 1;
} _NoteCollectionCounts__isset;

class NoteCollectionCounts : public virtual ::apache::thrift::TBase {
  public:
    ...
    void
    __set_notebookCounts(const std::map<::evernote::edam::Guid, int32_t> &val);
    ...
    bool operator==(const NoteCollectionCounts &rhs) const {
        if (__isset.notebookCounts != rhs.__isset.notebookCounts)
            return false;
        else if (__isset.notebookCounts &&
                 !(notebookCounts == rhs.notebookCounts))
            return false;
...
std::ostream &operator<<(std::ostream &out, const NoteCollectionCounts &obj);

typedef struct _NoteResultSpec__isset {
    _NoteResultSpec__isset()
        : includeContent(false), includeResourcesData(false),
          includeResourcesRecognition(false),
          includeResourcesAlternateData(false), includeSharedNotes(false),
          includeNoteAppDataValues(false), includeResourceAppDataValues(false),
...
class NoteResultSpec : public virtual ::apache::thrift::TBase {
  public:
    NoteResultSpec(const NoteResultSpec &);
    NoteResultSpec &operator=(const NoteResultSpec &);
    NoteResultSpec()
        : includeContent(0), includeResourcesData(0),
          includeResourcesRecognition(0), includeResourcesAlternateData(0),
          includeSharedNotes(0), includeNoteAppDataValues(0),
          includeResourceAppDataValues(0), includeAccountLimits(0) {}
    ...
    bool operator==(const NoteResultSpec &rhs) const {
        if (__isset.includeContent != rhs.__isset.includeContent)
            return false;
        else if (__isset.includeContent &&
                 !(includeContent == rhs.includeContent))
            return false;
        if (__isset.includeResourcesData != rhs.__isset.includeResourcesData)
            return false;
        else if (__isset.includeResourcesData &&
                 !(includeResourcesData == rhs.includeResourcesData))
            return false;
        if (__isset.includeResourcesRecognition !=
            rhs.__isset.includeResourcesRecognition)
            return false;
        else if (__isset.includeResourcesRecognition &&
                 !(includeResourcesRecognition ==
                   rhs.includeResourcesRecognition))
            return false;
        if (__isset.includeResourcesAlternateData !=
            rhs.__isset.includeResourcesAlternateData)
            return false;
        else if (__isset.includeResourcesAlternateData &&
                 !(includeResourcesAlternateData ==
                   rhs.includeResourcesAlternateData))
            return false;
        if (__isset.includeSharedNotes != rhs.__isset.includeSharedNotes)
            return false;
        else if (__isset.includeSharedNotes &&
        ...
        if (__isset.includeNoteAppDataValues !=
            rhs.__isset.includeNoteAppDataValues)
            return false;
        else if (__isset.includeNoteAppDataValues &&
                 !(includeNoteAppDataValues == rhs.includeNoteAppDataValues))
            return false;
        if (__isset.includeResourceAppDataValues !=
            rhs.__isset.includeResourceAppDataValues)
            return false;
        else if (__isset.includeResourceAppDataValues &&
                 !(includeResourceAppDataValues ==
                   rhs.includeResourceAppDataValues))
            return false;
        if (__isset.includeAccountLimits != rhs.__isset.includeAccountLimits)
            return false;
        else if (__isset.includeAccountLimits &&
                 !(includeAccountLimits == rhs.includeAccountLimits))
            return false;
        return true;
    }
    bool operator!=(const NoteResultSpec &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const NoteResultSpec &obj);

typedef struct _NoteEmailParameters__isset {
    _NoteEmailParameters__isset()
        : guid(false), note(false), toAddresses(false), ccAddresses(false),
...
class NoteEmailParameters : public virtual ::apache::thrift::TBase {
  public:
...
std::ostream &operator<<(std::ostream &out, const NoteEmailParameters &obj);
...
class NoteVersionId : public virtual ::apache::thrift::TBase {
  public:
    NoteVersionId(const NoteVersionId &);
    NoteVersionId &operator=(const NoteVersionId &);
    NoteVersionId()
        : updateSequenceNum(0), updated(0), saved(0), title(), lastEditorId(0) {
    }
    ...
    bool operator!=(const NoteVersionId &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const NoteVersionId &obj);

typedef struct _RelatedQuery__isset {
    _RelatedQuery__isset()
        : noteGuid(false), plainText(false), filter(false), referenceUri(false),
          context(false), cacheKey(false) {}
    bool noteGuid : 1;
    bool plainText : 1;
    bool filter : 1;
    bool referenceUri : 1;
...
class RelatedQuery : public virtual ::apache::thrift::TBase {
  public:
    RelatedQuery(const RelatedQuery &);
    RelatedQuery &operator=(const RelatedQuery &);
    RelatedQuery()
        : noteGuid(), plainText(), referenceUri(), context(), cacheKey() {}
    ...
    bool operator!=(const RelatedQuery &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const RelatedQuery &obj);

typedef struct _RelatedResult__isset {
    _RelatedResult__isset()
        : notes(false), notebooks(false), tags(false),
          containingNotebooks(false), debugInfo(false), experts(false),
          relatedContent(false), cacheKey(false), cacheExpires(false) {}
    bool notes : 1;
    bool notebooks : 1;
    bool tags : 1;
...
class RelatedResult : public virtual ::apache::thrift::TBase {
  public:
    RelatedResult(const RelatedResult &);
    RelatedResult &operator=(const RelatedResult &);
    RelatedResult() : debugInfo(), cacheKey(), cacheExpires(0) {}
    ...
    void __set_containingNotebooks(
        const std::vector<::evernote::edam::NotebookDescriptor> &val);

    void __set_debugInfo(const std::string &val);

    void __set_experts(const std::vector<::evernote::edam::UserProfile> &val);

    void __set_relatedContent(
        const std::vector<::evernote::edam::RelatedContent> &val);
    ...
    bool operator==(const RelatedResult &rhs) const {
        ...
        if (__isset.containingNotebooks != rhs.__isset.containingNotebooks)
            return false;
        else if (__isset.containingNotebooks &&
                 !(containingNotebooks == rhs.containingNotebooks))
            return false;
        if (__isset.debugInfo != rhs.__isset.debugInfo)
            return false;
        else if (__isset.debugInfo && !(debugInfo == rhs.debugInfo))
        ...
        if (__isset.relatedContent != rhs.__isset.relatedContent)
            return false;
        else if (__isset.relatedContent &&
                 !(relatedContent == rhs.relatedContent))
            return false;
        if (__isset.cacheKey != rhs.__isset.cacheKey)
            return false;
        else if (__isset.cacheKey && !(cacheKey == rhs.cacheKey))
    ...
    bool operator!=(const RelatedResult &rhs) const { return !(*this == rhs); }
...
std::ostream &operator<<(std::ostream &out, const RelatedResult &obj);

typedef struct _RelatedResultSpec__isset {
    _RelatedResultSpec__isset()
        : maxNotes(false), maxNotebooks(false), maxTags(false),
          writableNotebooksOnly(false), includeContainingNotebooks(false),
          includeDebugInfo(false), maxExperts(false), maxRelatedContent(false),
          relatedContentTypes(false) {}
    bool maxNotes : 1;
    bool maxNotebooks : 1;
    bool maxTags : 1;
    bool writableNotebooksOnly : 1;
    bool includeContainingNotebooks : 1;
    bool includeDebugInfo : 1;
    bool maxExperts : 1;
    bool maxRelatedContent : 1;
    bool relatedContentTypes : 1;
} _RelatedResultSpec__isset;

class RelatedResultSpec : public virtual ::apache::thrift::TBase {
  public:
    RelatedResultSpec(const RelatedResultSpec &);
    RelatedResultSpec &operator=(const RelatedResultSpec &);
    RelatedResultSpec()
        : maxNotes(0), maxNotebooks(0), maxTags(0), writableNotebooksOnly(0),
          includeContainingNotebooks(0), includeDebugInfo(0), maxExperts(0),
          maxRelatedContent(0) {}
    ...
    void __set_includeDebugInfo(const bool val);

    void __set_maxExperts(const int32_t val);

    void __set_maxRelatedContent(const int32_t val);

    void __set_relatedContentTypes(
        const std::set<::evernote::edam::RelatedContentType::type> &val);
    ...
    bool operator==(const RelatedResultSpec &rhs) const {
        ...
        if (__isset.writableNotebooksOnly != rhs.__isset.writableNotebooksOnly)
            return false;
        else if (__isset.writableNotebooksOnly &&
                 !(writableNotebooksOnly == rhs.writableNotebooksOnly))
            return false;
        if (__isset.includeContainingNotebooks !=
            rhs.__isset.includeContainingNotebooks)
            return false;
        else if (__isset.includeContainingNotebooks &&
                 !(includeContainingNotebooks ==
                   rhs.includeContainingNotebooks))
            return false;
        if (__isset.includeDebugInfo != rhs.__isset.includeDebugInfo)
            return false;
        else if (__isset.includeDebugInfo &&
                 !(includeDebugInfo == rhs.includeDebugInfo))
            return false;
        ...
        if (__isset.maxRelatedContent != rhs.__isset.maxRelatedContent)
            return false;
        else if (__isset.maxRelatedContent &&
                 !(maxRelatedContent == rhs.maxRelatedContent))
            return false;
        if (__isset.relatedContentTypes != rhs.__isset.relatedContentTypes)
            return false;
        else if (__isset.relatedContentTypes &&
                 !(relatedContentTypes == rhs.relatedContentTypes))
            return false;
        return true;
    }
    bool operator!=(const RelatedResultSpec &rhs) const {
...
std::ostream &operator<<(std::ostream &out, const RelatedResultSpec &obj);
...
class UpdateNoteIfUsnMatchesResult : public virtual ::apache::thrift::TBase {
  public:
    UpdateNoteIfUsnMatchesResult(const UpdateNoteIfUsnMatchesResult &);
    UpdateNoteIfUsnMatchesResult &
    operator=(const UpdateNoteIfUsnMatchesResult &);
...
std::ostream &operator<<(std::ostream &out,
                         const UpdateNoteIfUsnMatchesResult &obj);

typedef struct _ShareRelationshipRestrictions__isset {
    _ShareRelationshipRestrictions__isset()
        : noSetReadOnly(false), noSetReadPlusActivity(false),
          noSetModify(false), noSetFullAccess(false) {}
...
class ShareRelationshipRestrictions : public virtual ::apache::thrift::TBase {
  public:
    ShareRelationshipRestrictions(const ShareRelationshipRestrictions &);
    ShareRelationshipRestrictions &
    operator=(const ShareRelationshipRestrictions &);
    ShareRelationshipRestrictions()
        : noSetReadOnly(0), noSetReadPlusActivity(0), noSetModify(0),
          noSetFullAccess(0) {}
    ...
    bool operator==(const ShareRelationshipRestrictions &rhs) const {
        ...
        if (__isset.noSetReadPlusActivity != rhs.__isset.noSetReadPlusActivity)
            return false;
        else if (__isset.noSetReadPlusActivity &&
                 !(noSetReadPlusActivity == rhs.noSetReadPlusActivity))
            return false;
        ...
        if (__isset.noSetFullAccess != rhs.__isset.noSetFullAccess)
            return false;
        else if (__isset.noSetFullAccess &&
                 !(noSetFullAccess == rhs.noSetFullAccess))
            return false;
        return true;
    }
    bool operator!=(const ShareRelationshipRestrictions &rhs) const {
...
std::ostream &operator<<(std::ostream &out,
                         const ShareRelationshipRestrictions &obj);

typedef struct _InvitationShareRelationship__isset {
    _InvitationShareRelationship__isset()
        : displayName(false), recipientUserIdentity(false), privilege(false),
          sharerUserId(false) {}
    bool displayName : 1;
...
class InvitationShareRelationship : public virtual ::apache::thrift::TBase {
  public:
    ...
    InvitationShareRelationship()
        : displayName(), privilege((ShareRelationshipPrivilegeLevel::type)0),
          sharerUserId(0) {}
    ...
    bool operator==(const InvitationShareRelationship &rhs) const {
        ...
        if (__isset.recipientUserIdentity != rhs.__isset.recipientUserIdentity)
            return false;
        else if (__isset.recipientUserIdentity &&
                 !(recipientUserIdentity == rhs.recipientUserIdentity))
            return false;
...
std::ostream &operator<<(std::ostream &out,
                         const InvitationShareRelationship &obj);

typedef struct _MemberShareRelationship__isset {
    _MemberShareRelationship__isset()
        : displayName(false), recipientUserId(false), bestPrivilege(false),
          individualPrivilege(false), restrictions(false), sharerUserId(false) {
    }
    bool displayName : 1;
...
class MemberShareRelationship : public virtual ::apache::thrift::TBase {
  public:
    ...
    MemberShareRelationship()
        : displayName(), recipientUserId(0),
          bestPrivilege((ShareRelationshipPrivilegeLevel::type)0),
          individualPrivilege((ShareRelationshipPrivilegeLevel::type)0),
          sharerUserId(0) {}
    ...
    void
    __set_individualPrivilege(const ShareRelationshipPrivilegeLevel::type val);
    ...
    bool operator==(const MemberShareRelationship &rhs) const {
        ...
        if (__isset.individualPrivilege != rhs.__isset.individualPrivilege)
            return false;
        else if (__isset.individualPrivilege &&
                 !(individualPrivilege == rhs.individualPrivilege))
            return false;
...
std::ostream &operator<<(std::ostream &out, const MemberShareRelationship &obj);

typedef struct _ShareRelationships__isset {
    _ShareRelationships__isset()
        : invitations(false), memberships(false),
          invitationRestrictions(false) {}
    bool invitations : 1;
    bool memberships : 1;
    bool invitationRestrictions : 1;
} _ShareRelationships__isset;

class ShareRelationships : public virtual ::apache::thrift::TBase {
  public:
    ...
    bool operator==(const ShareRelationships &rhs) const {
        ...
        if (__isset.memberships != rhs.__isset.memberships)
            ...
            return false;
        if (__isset.invitationRestrictions !=
            rhs.__isset.invitationRestrictions)
            return false;
        else if (__isset.invitationRestrictions &&
                 !(invitationRestrictions == rhs.invitationRestrictions))
            return false;
        return true;
    }
    bool operator!=(const ShareRelationships &rhs) const {
...
std::ostream &operator<<(std::ostream &out, const ShareRelationships &obj);

typedef struct _ManageNotebookSharesParameters__isset {
    _ManageNotebookSharesParameters__isset()
        : notebookGuid(false), inviteMessage(false), membershipsToUpdate(false),
          invitationsToCreateOrUpdate(false), unshares(false) {}
    bool notebookGuid : 1;
...
class ManageNotebookSharesParameters : public virtual ::apache::thrift::TBase {
  public:
    ManageNotebookSharesParameters(const ManageNotebookSharesParameters &);
    ManageNotebookSharesParameters &
    operator=(const ManageNotebookSharesParameters &);
    ...
    void
    __set_membershipsToUpdate(const std::vector<MemberShareRelationship> &val);

    void __set_invitationsToCreateOrUpdate(
        const std::vector<InvitationShareRelationship> &val);
    ...
    bool operator==(const ManageNotebookSharesParameters &rhs) const {
        ...
        if (__isset.membershipsToUpdate != rhs.__isset.membershipsToUpdate)
            return false;
        else if (__isset.membershipsToUpdate &&
                 !(membershipsToUpdate == rhs.membershipsToUpdate))
            return false;
        if (__isset.invitationsToCreateOrUpdate !=
            rhs.__isset.invitationsToCreateOrUpdate)
            return false;
        else if (__isset.invitationsToCreateOrUpdate &&
                 !(invitationsToCreateOrUpdate ==
                   rhs.invitationsToCreateOrUpdate))
            return false;
...
std::ostream &operator<<(std::ostream &out,
                         const ManageNotebookSharesParameters &obj);

typedef struct _ManageNotebookSharesError__isset {
    _ManageNotebookSharesError__isset()
        : userIdentity(false), userException(false), notFoundException(false) {}
    bool userIdentity : 1;
    bool userException : 1;
    bool notFoundException : 1;
} _ManageNotebookSharesError__isset;

class ManageNotebookSharesError : public virtual ::apache::thrift::TBase {
  public:
    ...
    void
    __set_notFoundException(const ::evernote::edam::EDAMNotFoundException &val);
    ...
    bool operator==(const ManageNotebookSharesError &rhs) const {
        ...
        if (__isset.notFoundException != rhs.__isset.notFoundException)
            return false;
        else if (__isset.notFoundException &&
                 !(notFoundException == rhs.notFoundException))
            return false;
        return true;
    }
    bool operator!=(const ManageNotebookSharesError &rhs) const {
...
std::ostream &operator<<(std::ostream &out,
                         const ManageNotebookSharesError &obj);
...
class ManageNotebookSharesResult : public virtual ::apache::thrift::TBase {
  public:
...
std::ostream &operator<<(std::ostream &out,
                         const ManageNotebookSharesResult &obj);

typedef struct _SharedNoteTemplate__isset {
    _SharedNoteTemplate__isset()
        : noteGuid(false), recipientThreadId(false), recipientContacts(false),
          privilege(false) {}
    bool noteGuid : 1;
...
class SharedNoteTemplate : public virtual ::apache::thrift::TBase {
  public:
    SharedNoteTemplate(const SharedNoteTemplate &);
    SharedNoteTemplate &operator=(const SharedNoteTemplate &);
    SharedNoteTemplate()
        : noteGuid(), recipientThreadId(0),
          privilege((::evernote::edam::SharedNotePrivilegeLevel::type)0) {}
    ...
    void
    __set_recipientContacts(const std::vector<::evernote::edam::Contact> &val);

    void
    __set_privilege(const ::evernote::edam::SharedNotePrivilegeLevel::type val);
    ...
    bool operator==(const SharedNoteTemplate &rhs) const {
        ...
        if (__isset.recipientThreadId != rhs.__isset.recipientThreadId)
            return false;
        else if (__isset.recipientThreadId &&
                 !(recipientThreadId == rhs.recipientThreadId))
            return false;
        if (__isset.recipientContacts != rhs.__isset.recipientContacts)
            return false;
        else if (__isset.recipientContacts &&
                 !(recipientContacts == rhs.recipientContacts))
            return false;
        if (__isset.privilege != rhs.__isset.privilege)
            return false;
        else if (__isset.privilege && !(privilege == rhs.privilege))
...
std::ostream &operator<<(std::ostream &out, const SharedNoteTemplate &obj);

typedef struct _NotebookShareTemplate__isset {
    _NotebookShareTemplate__isset()
        : notebookGuid(false), recipientThreadId(false),
          recipientContacts(false), privilege(false) {}
    bool notebookGuid : 1;
    bool recipientThreadId : 1;
    bool recipientContacts : 1;
    bool privilege : 1;
...
class NotebookShareTemplate : public virtual ::apache::thrift::TBase {
  public:
    ...
    NotebookShareTemplate()
        : notebookGuid(), recipientThreadId(0),
          privilege((::evernote::edam::SharedNotebookPrivilegeLevel::type)0) {}
    ...
    void __set_privilege(
        const ::evernote::edam::SharedNotebookPrivilegeLevel::type val);
...
std::ostream &operator<<(std::ostream &out, const NotebookShareTemplate &obj);

typedef struct _CreateOrUpdateNotebookSharesResult__isset {
    _CreateOrUpdateNotebookSharesResult__isset()
        : updateSequenceNum(false), matchingShares(false) {}
    bool updateSequenceNum : 1;
...
class CreateOrUpdateNotebookSharesResult
  ...
  public:
    CreateOrUpdateNotebookSharesResult(
        const CreateOrUpdateNotebookSharesResult &);
    CreateOrUpdateNotebookSharesResult &
    operator=(const CreateOrUpdateNotebookSharesResult &);
    ...
    void __set_matchingShares(
        const std::vector<::evernote::edam::SharedNotebook> &val);
    ...
    bool operator==(const CreateOrUpdateNotebookSharesResult &rhs) const {
        ...
        if (__isset.matchingShares != rhs.__isset.matchingShares)
            return false;
        else if (__isset.matchingShares &&
                 !(matchingShares == rhs.matchingShares))
            return false;
        return true;
    }
    bool operator!=(const CreateOrUpdateNotebookSharesResult &rhs) const {
...
void swap(CreateOrUpdateNotebookSharesResult &a,
          CreateOrUpdateNotebookSharesResult &b);

std::ostream &operator<<(std::ostream &out,
                         const CreateOrUpdateNotebookSharesResult &obj);

typedef struct _NoteShareRelationshipRestrictions__isset {
    _NoteShareRelationshipRestrictions__isset()
        : noSetReadNote(false), noSetModifyNote(false), noSetFullAccess(false) {
    }
...
class NoteShareRelationshipRestrictions
  ...
  public:
    NoteShareRelationshipRestrictions(
        const NoteShareRelationshipRestrictions &);
    NoteShareRelationshipRestrictions &
    operator=(const NoteShareRelationshipRestrictions &);
    NoteShareRelationshipRestrictions()
        : noSetReadNote(0), noSetModifyNote(0), noSetFullAccess(0) {}
    ...
    bool operator==(const NoteShareRelationshipRestrictions &rhs) const {
        ...
        if (__isset.noSetModifyNote != rhs.__isset.noSetModifyNote)
            return false;
        else if (__isset.noSetModifyNote &&
                 !(noSetModifyNote == rhs.noSetModifyNote))
            return false;
        if (__isset.noSetFullAccess != rhs.__isset.noSetFullAccess)
            return false;
        else if (__isset.noSetFullAccess &&
...
void swap(NoteShareRelationshipRestrictions &a,
          NoteShareRelationshipRestrictions &b);

std::ostream &operator<<(std::ostream &out,
                         const NoteShareRelationshipRestrictions &obj);

typedef struct _NoteMemberShareRelationship__isset {
    _NoteMemberShareRelationship__isset()
        : displayName(false), recipientUserId(false), privilege(false),
          restrictions(false), sharerUserId(false) {}
    bool displayName : 1;
    bool recipientUserId : 1;
    bool privilege : 1;
    bool restrictions : 1;
...
class NoteMemberShareRelationship : public virtual ::apache::thrift::TBase {
  public:
...
std::ostream &operator<<(std::ostream &out,
                         const NoteMemberShareRelationship &obj);

typedef struct _NoteInvitationShareRelationship__isset {
    _NoteInvitationShareRelationship__isset()
        : displayName(false), recipientIdentityId(false), privilege(false),
          sharerUserId(false) {}
    bool displayName : 1;
...
class NoteInvitationShareRelationship : public virtual ::apache::thrift::TBase {
  public:
    NoteInvitationShareRelationship(const NoteInvitationShareRelationship &);
    NoteInvitationShareRelationship &
    operator=(const NoteInvitationShareRelationship &);
    NoteInvitationShareRelationship()
        : displayName(), recipientIdentityId(0),
          privilege((::evernote::edam::SharedNotePrivilegeLevel::type)0),
          sharerUserId(0) {}
...
void swap(NoteInvitationShareRelationship &a,
          NoteInvitationShareRelationship &b);

std::ostream &operator<<(std::ostream &out,
                         const NoteInvitationShareRelationship &obj);
...
class NoteShareRelationships : public virtual ::apache::thrift::TBase {
  public:
    ...
    void
    __set_invitations(const std::vector<NoteInvitationShareRelationship> &val);

    void __set_memberships(const std::vector<NoteMemberShareRelationship> &val);

    void
    __set_invitationRestrictions(const NoteShareRelationshipRestrictions &val);
...
std::ostream &operator<<(std::ostream &out, const NoteShareRelationships &obj);

typedef struct _ManageNoteSharesParameters__isset {
    _ManageNoteSharesParameters__isset()
        : noteGuid(false), membershipsToUpdate(false),
          invitationsToUpdate(false), membershipsToUnshare(false),
          invitationsToUnshare(false) {}
    bool noteGuid : 1;
    bool membershipsToUpdate : 1;
...
class ManageNoteSharesParameters : public virtual ::apache::thrift::TBase {
  public:
    ...
    void __set_membershipsToUpdate(
        const std::vector<NoteMemberShareRelationship> &val);

    void __set_invitationsToUpdate(
        const std::vector<NoteInvitationShareRelationship> &val);

    void __set_membershipsToUnshare(
        const std::vector<::evernote::edam::UserID> &val);

    void __set_invitationsToUnshare(
        const std::vector<::evernote::edam::IdentityID> &val);
    ...
    bool operator==(const ManageNoteSharesParameters &rhs) const {
        ...
        if (__isset.invitationsToUpdate != rhs.__isset.invitationsToUpdate)
            return false;
        else if (__isset.invitationsToUpdate &&
                 !(invitationsToUpdate == rhs.invitationsToUpdate))
            return false;
        if (__isset.membershipsToUnshare != rhs.__isset.membershipsToUnshare)
            return false;
        else if (__isset.membershipsToUnshare &&
                 !(membershipsToUnshare == rhs.membershipsToUnshare))
            return false;
        if (__isset.invitationsToUnshare != rhs.__isset.invitationsToUnshare)
            return false;
        else if (__isset.invitationsToUnshare &&
                 !(invitationsToUnshare == rhs.invitationsToUnshare))
            return false;
        return true;
    }
    bool operator!=(const ManageNoteSharesParameters &rhs) const {
...
std::ostream &operator<<(std::ostream &out,
                         const ManageNoteSharesParameters &obj);

typedef struct _ManageNoteSharesError__isset {
    _ManageNoteSharesError__isset()
        : identityID(false), userID(false), userException(false),
...
class ManageNoteSharesError : public virtual ::apache::thrift::TBase {
  public:
...
std::ostream &operator<<(std::ostream &out, const ManageNoteSharesError &obj);
...
class ManageNoteSharesResult : public virtual ::apache::thrift::TBase {
  public:
...
std::ostream &operator<<(std::ostream &out, const ManageNoteSharesResult &obj);
