...
std::ostream& operator<<(std::ostream& out, const ShareRelationshipPrivilegeLevel::type& val);
...
typedef struct _NoteFilter__isset {
  _NoteFilter__isset() : order(false), ascending(false), words(false), notebookGuid(false), tagGuids(false), timeZone(false), inactive(false), emphasized(false), includeAllReadableNotebooks(false), includeAllReadableWorkspaces(false), context(false), rawWords(false), searchContextBytes(false) {}
  bool order :1;
  bool ascending :1;
  bool words :1;
  bool notebookGuid :1;
...
class NoteFilter : public virtual ::apache::thrift::TBase {
 public:
  ...
  NoteFilter() : order(0), ascending(0), words(), notebookGuid(), timeZone(), inactive(0), emphasized(), includeAllReadableNotebooks(0), includeAllReadableWorkspaces(0), context(), rawWords(), searchContextBytes() {
  }
  ...
  bool operator == (const NoteFilter & rhs) const
  {
    ...
    if (__isset.includeAllReadableNotebooks != rhs.__isset.includeAllReadableNotebooks)
      ...
      return false;
    if (__isset.includeAllReadableWorkspaces != rhs.__isset.includeAllReadableWorkspaces)
      return false;
    else if (__isset.includeAllReadableWorkspaces && !(includeAllReadableWorkspaces == rhs.includeAllReadableWorkspaces))
      return false;
    ...
    if (__isset.searchContextBytes != rhs.__isset.searchContextBytes)
      return false;
    else if (__isset.searchContextBytes && !(searchContextBytes == rhs.searchContextBytes))
      return false;
    return true;
  }
  bool operator != (const NoteFilter &rhs) const {
...
typedef struct _NoteList__isset {
  _NoteList__isset() : stoppedWords(false), searchedWords(false), updateCount(false), searchContextBytes(false), debugInfo(false) {}
  bool stoppedWords :1;
...
class NoteList : public virtual ::apache::thrift::TBase {
 public:
  ...
  NoteList() : startIndex(0), totalNotes(0), updateCount(0), searchContextBytes(), debugInfo() {
  }
...
typedef struct _NotesMetadataList__isset {
  _NotesMetadataList__isset() : stoppedWords(false), searchedWords(false), updateCount(false), searchContextBytes(false), debugInfo(false) {}
  bool stoppedWords :1;
  bool searchedWords :1;
  bool updateCount :1;
  bool searchContextBytes :1;
...
class NotesMetadataList : public virtual ::apache::thrift::TBase {
 public:
  ...
  NotesMetadataList() : startIndex(0), totalNotes(0), updateCount(0), searchContextBytes(), debugInfo() {
  }
...
typedef struct _RelatedResult__isset {
  _RelatedResult__isset() : notes(false), notebooks(false), tags(false), containingNotebooks(false), debugInfo(false), experts(false), relatedContent(false), cacheKey(false), cacheExpires(false) {}
  bool notes :1;
  bool notebooks :1;
  bool tags :1;
...
typedef struct _RelatedResultSpec__isset {
  _RelatedResultSpec__isset() : maxNotes(false), maxNotebooks(false), maxTags(false), writableNotebooksOnly(false), includeContainingNotebooks(false), includeDebugInfo(false), maxExperts(false), maxRelatedContent(false), relatedContentTypes(false) {}
  bool maxNotes :1;
  bool maxNotebooks :1;
  bool maxTags :1;
...
class RelatedResultSpec : public virtual ::apache::thrift::TBase {
 public:
  ...
  RelatedResultSpec() : maxNotes(0), maxNotebooks(0), maxTags(0), writableNotebooksOnly(0), includeContainingNotebooks(0), includeDebugInfo(0), maxExperts(0), maxRelatedContent(0) {
  }
...
std::ostream& operator<<(std::ostream& out, const UpdateNoteIfUsnMatchesResult& obj);
...
std::ostream& operator<<(std::ostream& out, const ShareRelationshipRestrictions& obj);
...
std::ostream& operator<<(std::ostream& out, const InvitationShareRelationship& obj);
...
std::ostream& operator<<(std::ostream& out, const ManageNotebookSharesParameters& obj);
...
std::ostream& operator<<(std::ostream& out, const ManageNotebookSharesError& obj);
...
std::ostream& operator<<(std::ostream& out, const ManageNotebookSharesResult& obj);
...
class CreateOrUpdateNotebookSharesResult : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const CreateOrUpdateNotebookSharesResult& obj);
...
class NoteShareRelationshipRestrictions : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const NoteShareRelationshipRestrictions& obj);
...
std::ostream& operator<<(std::ostream& out, const NoteMemberShareRelationship& obj);
...
std::ostream& operator<<(std::ostream& out, const NoteInvitationShareRelationship& obj);
...
std::ostream& operator<<(std::ostream& out, const ManageNoteSharesParameters& obj);
