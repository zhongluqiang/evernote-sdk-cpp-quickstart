...
class LimitsConstants {
 public:
  ...
  int32_t EDAM_WORKSPACE_NAME_LEN_MIN;
  int32_t EDAM_WORKSPACE_NAME_LEN_MAX;
  int32_t EDAM_WORKSPACE_DESCRIPTION_LEN_MAX;
  std::string EDAM_WORKSPACE_NAME_REGEX;
  ...
  std::string EDAM_BUSINESS_MARKETING_CODE_REGEX_PATTERN;
  ...
  int32_t EDAM_USER_WORKSPACES_MAX;
  int32_t EDAM_BUSINESS_NOTEBOOKS_MAX;
  int32_t EDAM_BUSINESS_WORKSPACES_MAX;
  ...
  int64_t EDAM_USER_UPLOAD_LIMIT_BUSINESS_FIRST_MONTH;
  int64_t EDAM_USER_UPLOAD_LIMIT_BUSINESS_NEXT_MONTH;
  ...
  std::string EDAM_SOURCE_APPLICATION_ANDROID_SHARE_EXTENSION;
  std::string EDAM_SOURCE_APPLICATION_IOS_SHARE_EXTENSION;
  std::string EDAM_SOURCE_APPLICATION_WEB_CLIPPER;
