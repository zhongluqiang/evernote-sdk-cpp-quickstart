...
class UserStoreIfSingletonFactory : virtual public UserStoreIfFactory {
 public:
  UserStoreIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<UserStoreIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<UserStoreIf> iface_;
};
...
class UserStoreClient : virtual public UserStoreIf {
 public:
  UserStoreClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UserStoreClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class UserStoreProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  UserStoreProcessor(::apache::thrift::stdcxx::shared_ptr<UserStoreIf> iface) :
    iface_(iface) {
...
class UserStoreProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  UserStoreProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< UserStoreIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< UserStoreIfFactory > handlerFactory_;
};

class UserStoreMultiface : virtual public UserStoreIf {
 public:
  UserStoreMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<UserStoreIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~UserStoreMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<UserStoreIf> > ifaces_;
  UserStoreMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<UserStoreIf> iface) {
...
class UserStoreConcurrentClient : virtual public UserStoreIf {
 public:
  UserStoreConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UserStoreConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
