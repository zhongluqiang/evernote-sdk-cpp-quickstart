...
class PublicUserInfo : public virtual ::apache::thrift::TBase {
 public:
...
class UserUrls : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const UserUrls& obj);
...
class AuthenticationResult : public virtual ::apache::thrift::TBase {
 public:
...
class BootstrapSettings : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const BootstrapSettings& obj);


class BootstrapProfile : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const BootstrapProfile& obj);


class BootstrapInfo : public virtual ::apache::thrift::TBase {
 public:
...
std::ostream& operator<<(std::ostream& out, const BootstrapInfo& obj);
