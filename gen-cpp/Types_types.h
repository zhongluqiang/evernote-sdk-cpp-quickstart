...
extern const std::map<int, const char *>
    _SharedNotebookPrivilegeLevel_VALUES_TO_NAMES;
...
extern const std::map<int, const char *>
    _SharedNotePrivilegeLevel_VALUES_TO_NAMES;
...
extern const std::map<int, const char *> _BusinessUserStatus_VALUES_TO_NAMES;
...
extern const std::map<int, const char *>
    _BusinessInvitationStatus_VALUES_TO_NAMES;
...
struct EntityType {
    enum type { NOTE = 1, NOTEBOOK = 2, WORKSPACE = 3 };
};
...
extern const std::map<int, const char *> _RecipientStatus_VALUES_TO_NAMES;
...
extern const std::map<int, const char *>
    _CanMoveToContainerStatus_VALUES_TO_NAMES;
...
struct UserIdentityType {
    enum type { EVERNOTE_USERID = 1, EMAIL = 2, IDENTITYID = 3 };
};
...
typedef struct _UserAttributes__isset {
    _UserAttributes__isset()
        : defaultLocationName(false), defaultLatitude(false),
          defaultLongitude(false), preactivation(false),
          viewedPromotions(false), incomingEmailAddress(false),
          recentMailedAddresses(false), comments(false),
          dateAgreedToTermsOfService(false), maxReferrals(false),
          referralCount(false), refererCode(false), sentEmailDate(false),
          sentEmailCount(false), dailyEmailLimit(false), emailOptOutDate(false),
          partnerEmailOptInDate(false), preferredLanguage(false),
          preferredCountry(false), clipFullPage(false), twitterUserName(false),
          twitterId(false), groupName(false), recognitionLanguage(false),
          referralProof(false), educationalDiscount(false),
          businessAddress(false), hideSponsorBilling(false),
          useEmailAutoFiling(false), reminderEmailConfig(false),
          emailAddressLastConfirmed(false), passwordUpdated(false),
          salesforcePushEnabled(false), shouldLogClientEvent(false),
          optOutMachineLearning(false) {}
...
class UserAttributes : public virtual ::apache::thrift::TBase {
  public:
    ...
    UserAttributes()
        : defaultLocationName(), defaultLatitude(0), defaultLongitude(0),
          preactivation(0), incomingEmailAddress(), comments(),
          dateAgreedToTermsOfService(0), maxReferrals(0), referralCount(0),
          refererCode(), sentEmailDate(0), sentEmailCount(0),
          dailyEmailLimit(0), emailOptOutDate(0), partnerEmailOptInDate(0),
          preferredLanguage(), preferredCountry(), clipFullPage(0),
          twitterUserName(), twitterId(), groupName(), recognitionLanguage(),
          referralProof(), educationalDiscount(0), businessAddress(),
          hideSponsorBilling(0), useEmailAutoFiling(0),
          reminderEmailConfig((ReminderEmailConfig::type)0),
          emailAddressLastConfirmed(0), passwordUpdated(0),
          salesforcePushEnabled(0), shouldLogClientEvent(0),
          optOutMachineLearning(0) {}
    ...
    void __set_optOutMachineLearning(const bool val);

    bool operator==(const UserAttributes &rhs) const {
        if (__isset.defaultLocationName != rhs.__isset.defaultLocationName)
            return false;
        else if (__isset.defaultLocationName &&
                 !(defaultLocationName == rhs.defaultLocationName))
            return false;
        if (__isset.defaultLatitude != rhs.__isset.defaultLatitude)
            return false;
        else if (__isset.defaultLatitude &&
                 !(defaultLatitude == rhs.defaultLatitude))
            return false;
        if (__isset.defaultLongitude != rhs.__isset.defaultLongitude)
            return false;
        else if (__isset.defaultLongitude &&
                 !(defaultLongitude == rhs.defaultLongitude))
            return false;
        ...
        if (__isset.viewedPromotions != rhs.__isset.viewedPromotions)
            return false;
        else if (__isset.viewedPromotions &&
                 !(viewedPromotions == rhs.viewedPromotions))
            return false;
        if (__isset.incomingEmailAddress != rhs.__isset.incomingEmailAddress)
            return false;
        else if (__isset.incomingEmailAddress &&
                 !(incomingEmailAddress == rhs.incomingEmailAddress))
            return false;
        if (__isset.recentMailedAddresses != rhs.__isset.recentMailedAddresses)
            return false;
        else if (__isset.recentMailedAddresses &&
                 !(recentMailedAddresses == rhs.recentMailedAddresses))
            return false;
        ...
        if (__isset.dateAgreedToTermsOfService !=
            rhs.__isset.dateAgreedToTermsOfService)
            return false;
        else if (__isset.dateAgreedToTermsOfService &&
                 !(dateAgreedToTermsOfService ==
                   rhs.dateAgreedToTermsOfService))
            return false;
        ...
        if (__isset.sentEmailCount != rhs.__isset.sentEmailCount)
            return false;
        else if (__isset.sentEmailCount &&
                 !(sentEmailCount == rhs.sentEmailCount))
            return false;
        if (__isset.dailyEmailLimit != rhs.__isset.dailyEmailLimit)
            return false;
        else if (__isset.dailyEmailLimit &&
                 !(dailyEmailLimit == rhs.dailyEmailLimit))
            return false;
        if (__isset.emailOptOutDate != rhs.__isset.emailOptOutDate)
            return false;
        else if (__isset.emailOptOutDate &&
                 !(emailOptOutDate == rhs.emailOptOutDate))
            return false;
        if (__isset.partnerEmailOptInDate != rhs.__isset.partnerEmailOptInDate)
            return false;
        else if (__isset.partnerEmailOptInDate &&
                 !(partnerEmailOptInDate == rhs.partnerEmailOptInDate))
            return false;
        if (__isset.preferredLanguage != rhs.__isset.preferredLanguage)
            return false;
        else if (__isset.preferredLanguage &&
                 !(preferredLanguage == rhs.preferredLanguage))
            return false;
        if (__isset.preferredCountry != rhs.__isset.preferredCountry)
            return false;
        else if (__isset.preferredCountry &&
                 !(preferredCountry == rhs.preferredCountry))
            return false;
        ...
        if (__isset.twitterUserName != rhs.__isset.twitterUserName)
            return false;
        else if (__isset.twitterUserName &&
                 !(twitterUserName == rhs.twitterUserName))
            return false;
        ...
        if (__isset.recognitionLanguage != rhs.__isset.recognitionLanguage)
            return false;
        else if (__isset.recognitionLanguage &&
                 !(recognitionLanguage == rhs.recognitionLanguage))
            return false;
        ...
        if (__isset.educationalDiscount != rhs.__isset.educationalDiscount)
            return false;
        else if (__isset.educationalDiscount &&
                 !(educationalDiscount == rhs.educationalDiscount))
            return false;
        if (__isset.businessAddress != rhs.__isset.businessAddress)
            return false;
        else if (__isset.businessAddress &&
                 !(businessAddress == rhs.businessAddress))
            return false;
        if (__isset.hideSponsorBilling != rhs.__isset.hideSponsorBilling)
            return false;
        else if (__isset.hideSponsorBilling &&
                 !(hideSponsorBilling == rhs.hideSponsorBilling))
            return false;
        if (__isset.useEmailAutoFiling != rhs.__isset.useEmailAutoFiling)
            return false;
        else if (__isset.useEmailAutoFiling &&
                 !(useEmailAutoFiling == rhs.useEmailAutoFiling))
            return false;
        if (__isset.reminderEmailConfig != rhs.__isset.reminderEmailConfig)
            return false;
        else if (__isset.reminderEmailConfig &&
                 !(reminderEmailConfig == rhs.reminderEmailConfig))
            return false;
        if (__isset.emailAddressLastConfirmed !=
            rhs.__isset.emailAddressLastConfirmed)
            return false;
        else if (__isset.emailAddressLastConfirmed &&
                 !(emailAddressLastConfirmed == rhs.emailAddressLastConfirmed))
            return false;
        if (__isset.passwordUpdated != rhs.__isset.passwordUpdated)
            return false;
        else if (__isset.passwordUpdated &&
                 !(passwordUpdated == rhs.passwordUpdated))
            return false;
        if (__isset.salesforcePushEnabled != rhs.__isset.salesforcePushEnabled)
            return false;
        else if (__isset.salesforcePushEnabled &&
                 !(salesforcePushEnabled == rhs.salesforcePushEnabled))
            return false;
        if (__isset.shouldLogClientEvent != rhs.__isset.shouldLogClientEvent)
            return false;
        else if (__isset.shouldLogClientEvent &&
                 !(shouldLogClientEvent == rhs.shouldLogClientEvent))
            return false;
        if (__isset.optOutMachineLearning != rhs.__isset.optOutMachineLearning)
            return false;
        else if (__isset.optOutMachineLearning &&
                 !(optOutMachineLearning == rhs.optOutMachineLearning))
            return false;
        return true;
    }
    bool operator!=(const UserAttributes &rhs) const { return !(*this == rhs); }
...
typedef struct _BusinessUserAttributes__isset {
    _BusinessUserAttributes__isset()
        : title(false), location(false), department(false), mobilePhone(false),
          linkedInProfileUrl(false), workPhone(false), companyStartDate(false) {
    }
    bool title : 1;
    bool location : 1;
    bool department : 1;
...
class BusinessUserAttributes : public virtual ::apache::thrift::TBase {
  public:
    ...
    BusinessUserAttributes()
        : title(), location(), department(), mobilePhone(),
          linkedInProfileUrl(), workPhone(), companyStartDate(0) {}
    ...
    bool operator==(const BusinessUserAttributes &rhs) const {
        ...
        if (__isset.linkedInProfileUrl != rhs.__isset.linkedInProfileUrl)
            return false;
        else if (__isset.linkedInProfileUrl &&
                 !(linkedInProfileUrl == rhs.linkedInProfileUrl))
            return false;
        ...
        if (__isset.companyStartDate != rhs.__isset.companyStartDate)
            return false;
        else if (__isset.companyStartDate &&
                 !(companyStartDate == rhs.companyStartDate))
            return false;
        return true;
    }
    bool operator!=(const BusinessUserAttributes &rhs) const {
...
typedef struct _Accounting__isset {
    _Accounting__isset()
        : uploadLimitEnd(false), uploadLimitNextMonth(false),
          premiumServiceStatus(false), premiumOrderNumber(false),
          premiumCommerceService(false), premiumServiceStart(false),
          premiumServiceSKU(false), lastSuccessfulCharge(false),
          lastFailedCharge(false), lastFailedChargeReason(false),
          nextPaymentDue(false), premiumLockUntil(false), updated(false),
          premiumSubscriptionNumber(false), lastRequestedCharge(false),
          currency(false), unitPrice(false), businessId(false),
          businessName(false), businessRole(false), unitDiscount(false),
          nextChargeDate(false), availablePoints(false) {}
...
class Accounting : public virtual ::apache::thrift::TBase {
  public:
    Accounting(const Accounting &);
    Accounting &operator=(const Accounting &);
    Accounting()
        : uploadLimitEnd(0), uploadLimitNextMonth(0),
          premiumServiceStatus((PremiumOrderStatus::type)0),
          premiumOrderNumber(), premiumCommerceService(),
          premiumServiceStart(0), premiumServiceSKU(), lastSuccessfulCharge(0),
          lastFailedCharge(0), lastFailedChargeReason(), nextPaymentDue(0),
          premiumLockUntil(0), updated(0), premiumSubscriptionNumber(),
          lastRequestedCharge(0), currency(), unitPrice(0), businessId(0),
          businessName(), businessRole((BusinessUserRole::type)0),
          unitDiscount(0), nextChargeDate(0), availablePoints(0) {}
    ...
    bool operator==(const Accounting &rhs) const {
        if (__isset.uploadLimitEnd != rhs.__isset.uploadLimitEnd)
            return false;
        else if (__isset.uploadLimitEnd &&
                 !(uploadLimitEnd == rhs.uploadLimitEnd))
            return false;
        if (__isset.uploadLimitNextMonth != rhs.__isset.uploadLimitNextMonth)
            return false;
        else if (__isset.uploadLimitNextMonth &&
                 !(uploadLimitNextMonth == rhs.uploadLimitNextMonth))
            return false;
        if (__isset.premiumServiceStatus != rhs.__isset.premiumServiceStatus)
            return false;
        else if (__isset.premiumServiceStatus &&
                 !(premiumServiceStatus == rhs.premiumServiceStatus))
            return false;
        if (__isset.premiumOrderNumber != rhs.__isset.premiumOrderNumber)
            return false;
        else if (__isset.premiumOrderNumber &&
                 !(premiumOrderNumber == rhs.premiumOrderNumber))
            return false;
        if (__isset.premiumCommerceService !=
            rhs.__isset.premiumCommerceService)
            return false;
        else if (__isset.premiumCommerceService &&
                 !(premiumCommerceService == rhs.premiumCommerceService))
            return false;
        if (__isset.premiumServiceStart != rhs.__isset.premiumServiceStart)
            return false;
        else if (__isset.premiumServiceStart &&
                 !(premiumServiceStart == rhs.premiumServiceStart))
            return false;
        if (__isset.premiumServiceSKU != rhs.__isset.premiumServiceSKU)
            return false;
        else if (__isset.premiumServiceSKU &&
                 !(premiumServiceSKU == rhs.premiumServiceSKU))
            return false;
        if (__isset.lastSuccessfulCharge != rhs.__isset.lastSuccessfulCharge)
            return false;
        else if (__isset.lastSuccessfulCharge &&
                 !(lastSuccessfulCharge == rhs.lastSuccessfulCharge))
            return false;
        if (__isset.lastFailedCharge != rhs.__isset.lastFailedCharge)
            return false;
        else if (__isset.lastFailedCharge &&
                 !(lastFailedCharge == rhs.lastFailedCharge))
            return false;
        if (__isset.lastFailedChargeReason !=
            rhs.__isset.lastFailedChargeReason)
            return false;
        else if (__isset.lastFailedChargeReason &&
                 !(lastFailedChargeReason == rhs.lastFailedChargeReason))
            return false;
        if (__isset.nextPaymentDue != rhs.__isset.nextPaymentDue)
            return false;
        else if (__isset.nextPaymentDue &&
                 !(nextPaymentDue == rhs.nextPaymentDue))
            return false;
        if (__isset.premiumLockUntil != rhs.__isset.premiumLockUntil)
            return false;
        else if (__isset.premiumLockUntil &&
                 !(premiumLockUntil == rhs.premiumLockUntil))
            return false;
        ...
        if (__isset.premiumSubscriptionNumber !=
            rhs.__isset.premiumSubscriptionNumber)
            return false;
        else if (__isset.premiumSubscriptionNumber &&
                 !(premiumSubscriptionNumber == rhs.premiumSubscriptionNumber))
            return false;
        if (__isset.lastRequestedCharge != rhs.__isset.lastRequestedCharge)
            return false;
        else if (__isset.lastRequestedCharge &&
                 !(lastRequestedCharge == rhs.lastRequestedCharge))
            return false;
        ...
        if (__isset.nextChargeDate != rhs.__isset.nextChargeDate)
            return false;
        else if (__isset.nextChargeDate &&
                 !(nextChargeDate == rhs.nextChargeDate))
            return false;
        if (__isset.availablePoints != rhs.__isset.availablePoints)
            return false;
        else if (__isset.availablePoints &&
                 !(availablePoints == rhs.availablePoints))
            return false;
        return true;
    }
    bool operator!=(const Accounting &rhs) const { return !(*this == rhs); }
...
typedef struct _BusinessUserInfo__isset {
    _BusinessUserInfo__isset()
        : businessId(false), businessName(false), role(false), email(false),
          updated(false) {}
    bool businessId : 1;
    bool businessName : 1;
    bool role : 1;
...
class BusinessUserInfo : public virtual ::apache::thrift::TBase {
  public:
    BusinessUserInfo(const BusinessUserInfo &);
    BusinessUserInfo &operator=(const BusinessUserInfo &);
    BusinessUserInfo()
        : businessId(0), businessName(), role((BusinessUserRole::type)0),
          email(), updated(0) {}
...
typedef struct _AccountLimits__isset {
    _AccountLimits__isset()
        : userMailLimitDaily(false), noteSizeMax(false), resourceSizeMax(false),
          userLinkedNotebookMax(false), uploadLimit(false),
          userNoteCountMax(false), userNotebookCountMax(false),
          userTagCountMax(false), noteTagCountMax(false),
          userSavedSearchesMax(false), noteResourceCountMax(false) {}
...
class AccountLimits : public virtual ::apache::thrift::TBase {
  public:
    AccountLimits(const AccountLimits &);
    AccountLimits &operator=(const AccountLimits &);
    AccountLimits()
        : userMailLimitDaily(0), noteSizeMax(0), resourceSizeMax(0),
          userLinkedNotebookMax(0), uploadLimit(0), userNoteCountMax(0),
          userNotebookCountMax(0), userTagCountMax(0), noteTagCountMax(0),
          userSavedSearchesMax(0), noteResourceCountMax(0) {}
    ...
    bool operator==(const AccountLimits &rhs) const {
        if (__isset.userMailLimitDaily != rhs.__isset.userMailLimitDaily)
            return false;
        else if (__isset.userMailLimitDaily &&
                 !(userMailLimitDaily == rhs.userMailLimitDaily))
            return false;
        ...
        if (__isset.resourceSizeMax != rhs.__isset.resourceSizeMax)
            return false;
        else if (__isset.resourceSizeMax &&
                 !(resourceSizeMax == rhs.resourceSizeMax))
            return false;
        if (__isset.userLinkedNotebookMax != rhs.__isset.userLinkedNotebookMax)
            return false;
        else if (__isset.userLinkedNotebookMax &&
                 !(userLinkedNotebookMax == rhs.userLinkedNotebookMax))
            return false;
        ...
        if (__isset.userNoteCountMax != rhs.__isset.userNoteCountMax)
            return false;
        else if (__isset.userNoteCountMax &&
                 !(userNoteCountMax == rhs.userNoteCountMax))
            return false;
        if (__isset.userNotebookCountMax != rhs.__isset.userNotebookCountMax)
            return false;
        else if (__isset.userNotebookCountMax &&
                 !(userNotebookCountMax == rhs.userNotebookCountMax))
            return false;
        if (__isset.userTagCountMax != rhs.__isset.userTagCountMax)
            return false;
        else if (__isset.userTagCountMax &&
                 !(userTagCountMax == rhs.userTagCountMax))
            return false;
        if (__isset.noteTagCountMax != rhs.__isset.noteTagCountMax)
            return false;
        else if (__isset.noteTagCountMax &&
                 !(noteTagCountMax == rhs.noteTagCountMax))
            return false;
        if (__isset.userSavedSearchesMax != rhs.__isset.userSavedSearchesMax)
            return false;
        else if (__isset.userSavedSearchesMax &&
                 !(userSavedSearchesMax == rhs.userSavedSearchesMax))
            return false;
        if (__isset.noteResourceCountMax != rhs.__isset.noteResourceCountMax)
            return false;
        else if (__isset.noteResourceCountMax &&
                 !(noteResourceCountMax == rhs.noteResourceCountMax))
            return false;
        return true;
    }
    bool operator!=(const AccountLimits &rhs) const { return !(*this == rhs); }
...
typedef struct _User__isset {
    _User__isset()
        : id(false), username(false), email(false), name(false),
          timezone(false), privilege(false), serviceLevel(false),
          created(false), updated(false), deleted(false), active(false),
          shardId(false), attributes(false), accounting(false),
          businessUserInfo(false), photoUrl(false), photoLastUpdated(false),
          accountLimits(false) {}
    bool id : 1;
    bool username : 1;
    bool email : 1;
...
class User : public virtual ::apache::thrift::TBase {
  public:
    ...
    User()
        : id(0), username(), email(), name(), timezone(),
          privilege((PrivilegeLevel::type)0),
          serviceLevel((ServiceLevel::type)0), created(0), updated(0),
          deleted(0), active(0), shardId(), photoUrl(), photoLastUpdated(0) {}
    ...
    bool operator==(const User &rhs) const {
        ...
        if (__isset.businessUserInfo != rhs.__isset.businessUserInfo)
            return false;
        else if (__isset.businessUserInfo &&
                 !(businessUserInfo == rhs.businessUserInfo))
            return false;
        ...
        if (__isset.photoLastUpdated != rhs.__isset.photoLastUpdated)
            return false;
        else if (__isset.photoLastUpdated &&
                 !(photoLastUpdated == rhs.photoLastUpdated))
            return false;
...
typedef struct _Contact__isset {
    _Contact__isset()
        : name(false), id(false), type(false), photoUrl(false),
          photoLastUpdated(false), messagingPermit(false),
          messagingPermitExpires(false) {}
    bool name : 1;
    bool id : 1;
    bool type : 1;
    bool photoUrl : 1;
...
class Contact : public virtual ::apache::thrift::TBase {
  public:
    ...
    Contact()
        : name(), id(), type((ContactType::type)0), photoUrl(),
          photoLastUpdated(0), messagingPermit(), messagingPermitExpires(0) {}
    ...
    bool operator==(const Contact &rhs) const {
        ...
        if (__isset.messagingPermit != rhs.__isset.messagingPermit)
            return false;
        else if (__isset.messagingPermit &&
                 !(messagingPermit == rhs.messagingPermit))
            return false;
        if (__isset.messagingPermitExpires !=
            rhs.__isset.messagingPermitExpires)
            return false;
        else if (__isset.messagingPermitExpires &&
                 !(messagingPermitExpires == rhs.messagingPermitExpires))
            return false;
        return true;
    }
...
typedef struct _Identity__isset {
    _Identity__isset()
        : contact(false), userId(false), deactivated(false),
          sameBusiness(false), blocked(false), userConnected(false),
          eventId(false) {}
    bool contact : 1;
    bool userId : 1;
    bool deactivated : 1;
...
class Identity : public virtual ::apache::thrift::TBase {
  public:
    Identity(const Identity &);
    Identity &operator=(const Identity &);
    Identity()
        : id(0), userId(0), deactivated(0), sameBusiness(0), blocked(0),
          userConnected(0), eventId(0) {}
...
typedef struct _Tag__isset {
    _Tag__isset()
        : guid(false), name(false), parentGuid(false),
          updateSequenceNum(false) {}
    bool guid : 1;
    bool name : 1;
    bool parentGuid : 1;
  ...
  public:
    ...
    bool operator==(const Tag &rhs) const {
        ...
        if (__isset.updateSequenceNum != rhs.__isset.updateSequenceNum)
            return false;
        else if (__isset.updateSequenceNum &&
                 !(updateSequenceNum == rhs.updateSequenceNum))
            return false;
        return true;
    }
    bool operator!=(const Tag &rhs) const { return !(*this == rhs); }
    /* implement to comply with set */
...
class LazyMap : public virtual ::apache::thrift::TBase {
  public:
    ...
    bool operator!=(const LazyMap &rhs) const { return !(*this == rhs); }
...
typedef struct _ResourceAttributes__isset {
    _ResourceAttributes__isset()
        : sourceURL(false), timestamp(false), latitude(false), longitude(false),
          altitude(false), cameraMake(false), cameraModel(false),
          clientWillIndex(false), recoType(false), fileName(false),
          attachment(false), applicationData(false) {}
    bool sourceURL : 1;
    bool timestamp : 1;
    bool latitude : 1;
    bool longitude : 1;
...
class ResourceAttributes : public virtual ::apache::thrift::TBase {
  public:
    ResourceAttributes(const ResourceAttributes &);
    ResourceAttributes &operator=(const ResourceAttributes &);
    ResourceAttributes()
        : sourceURL(), timestamp(0), latitude(0), longitude(0), altitude(0),
          cameraMake(), cameraModel(), clientWillIndex(0), recoType(),
    ...
    bool operator==(const ResourceAttributes &rhs) const {
        ...
        if (__isset.clientWillIndex != rhs.__isset.clientWillIndex)
            return false;
        else if (__isset.clientWillIndex &&
                 !(clientWillIndex == rhs.clientWillIndex))
            return false;
        ...
        if (__isset.applicationData != rhs.__isset.applicationData)
            return false;
        else if (__isset.applicationData &&
                 !(applicationData == rhs.applicationData))
            return false;
        return true;
    }
    bool operator!=(const ResourceAttributes &rhs) const {
...
typedef struct _Resource__isset {
    _Resource__isset()
        : guid(false), noteGuid(false), data(false), mime(false), width(false),
          height(false), duration(false), active(false), recognition(false),
          attributes(false), updateSequenceNum(false), alternateData(false) {}
    bool guid : 1;
    bool noteGuid : 1;
    bool data : 1;
    bool mime : 1;
...
class Resource : public virtual ::apache::thrift::TBase {
  public:
    ...
    Resource()
        : guid(), noteGuid(), mime(), width(0), height(0), duration(0),
          active(0), updateSequenceNum(0) {}
...
typedef struct _NoteAttributes__isset {
    _NoteAttributes__isset()
        : subjectDate(false), latitude(false), longitude(false),
          altitude(false), author(false), source(false), sourceURL(false),
          sourceApplication(false), shareDate(false), reminderOrder(false),
          reminderDoneTime(false), reminderTime(false), placeName(false),
          contentClass(false), applicationData(false), lastEditedBy(false),
          classifications(false), creatorId(false), lastEditorId(false),
          sharedWithBusiness(false), conflictSourceNoteGuid(false),
          noteTitleQuality(false) {}
    bool subjectDate : 1;
    bool latitude : 1;
    bool longitude : 1;
    bool altitude : 1;
...
class NoteAttributes : public virtual ::apache::thrift::TBase {
  public:
    NoteAttributes(const NoteAttributes &);
    NoteAttributes &operator=(const NoteAttributes &);
    NoteAttributes()
        : subjectDate(0), latitude(0), longitude(0), altitude(0), author(),
          source(), sourceURL(), sourceApplication(), shareDate(0),
          reminderOrder(0), reminderDoneTime(0), reminderTime(0), placeName(),
          contentClass(), lastEditedBy(), creatorId(0), lastEditorId(0),
          sharedWithBusiness(0), conflictSourceNoteGuid(), noteTitleQuality(0) {
    }
    ...
    bool operator==(const NoteAttributes &rhs) const {
        ...
        if (__isset.sourceApplication != rhs.__isset.sourceApplication)
            return false;
        else if (__isset.sourceApplication &&
                 !(sourceApplication == rhs.sourceApplication))
            return false;
        ...
        if (__isset.reminderDoneTime != rhs.__isset.reminderDoneTime)
            return false;
        else if (__isset.reminderDoneTime &&
                 !(reminderDoneTime == rhs.reminderDoneTime))
            return false;
        ...
        if (__isset.classifications != rhs.__isset.classifications)
            return false;
        else if (__isset.classifications &&
                 !(classifications == rhs.classifications))
            return false;
        ...
        if (__isset.sharedWithBusiness != rhs.__isset.sharedWithBusiness)
            return false;
        else if (__isset.sharedWithBusiness &&
                 !(sharedWithBusiness == rhs.sharedWithBusiness))
            return false;
        if (__isset.conflictSourceNoteGuid !=
            rhs.__isset.conflictSourceNoteGuid)
            return false;
        else if (__isset.conflictSourceNoteGuid &&
                 !(conflictSourceNoteGuid == rhs.conflictSourceNoteGuid))
            return false;
        if (__isset.noteTitleQuality != rhs.__isset.noteTitleQuality)
            return false;
        else if (__isset.noteTitleQuality &&
                 !(noteTitleQuality == rhs.noteTitleQuality))
            return false;
        return true;
    }
    bool operator!=(const NoteAttributes &rhs) const { return !(*this == rhs); }
...
typedef struct _SharedNote__isset {
    _SharedNote__isset()
        : sharerUserID(false), recipientIdentity(false), privilege(false),
          serviceCreated(false), serviceUpdated(false), serviceAssigned(false) {
    }
    bool sharerUserID : 1;
...
class SharedNote : public virtual ::apache::thrift::TBase {
  public:
    SharedNote(const SharedNote &);
    SharedNote &operator=(const SharedNote &);
    SharedNote()
        : sharerUserID(0), privilege((SharedNotePrivilegeLevel::type)0),
          serviceCreated(0), serviceUpdated(0), serviceAssigned(0) {}
    ...
    bool operator==(const SharedNote &rhs) const {
        ...
        if (__isset.recipientIdentity != rhs.__isset.recipientIdentity)
            return false;
        else if (__isset.recipientIdentity &&
                 !(recipientIdentity == rhs.recipientIdentity))
            return false;
        if (__isset.privilege != rhs.__isset.privilege)
            return false;
        else if (__isset.privilege && !(privilege == rhs.privilege))
        ...
        if (__isset.serviceCreated != rhs.__isset.serviceCreated)
            return false;
        else if (__isset.serviceCreated &&
                 !(serviceCreated == rhs.serviceCreated))
            return false;
        if (__isset.serviceUpdated != rhs.__isset.serviceUpdated)
            return false;
        else if (__isset.serviceUpdated &&
                 !(serviceUpdated == rhs.serviceUpdated))
            return false;
        if (__isset.serviceAssigned != rhs.__isset.serviceAssigned)
            return false;
        else if (__isset.serviceAssigned &&
                 !(serviceAssigned == rhs.serviceAssigned))
            return false;
        return true;
    }
    bool operator!=(const SharedNote &rhs) const { return !(*this == rhs); }
...
typedef struct _NoteRestrictions__isset {
    _NoteRestrictions__isset()
        : noUpdateTitle(false), noUpdateContent(false), noEmail(false),
          noShare(false), noSharePublicly(false) {}
...
class NoteRestrictions : public virtual ::apache::thrift::TBase {
  public:
    NoteRestrictions(const NoteRestrictions &);
    NoteRestrictions &operator=(const NoteRestrictions &);
    NoteRestrictions()
        : noUpdateTitle(0), noUpdateContent(0), noEmail(0), noShare(0),
          noSharePublicly(0) {}
    ...
    bool operator==(const NoteRestrictions &rhs) const {
        ...
        if (__isset.noUpdateContent != rhs.__isset.noUpdateContent)
            return false;
        else if (__isset.noUpdateContent &&
                 !(noUpdateContent == rhs.noUpdateContent))
            return false;
        ...
        if (__isset.noSharePublicly != rhs.__isset.noSharePublicly)
            return false;
        else if (__isset.noSharePublicly &&
                 !(noSharePublicly == rhs.noSharePublicly))
            return false;
        return true;
    }
    bool operator!=(const NoteRestrictions &rhs) const {
...
typedef struct _NoteLimits__isset {
    _NoteLimits__isset()
        : noteResourceCountMax(false), uploadLimit(false),
          resourceSizeMax(false), noteSizeMax(false), uploaded(false) {}
    bool noteResourceCountMax : 1;
    bool uploadLimit : 1;
    bool resourceSizeMax : 1;
    bool noteSizeMax : 1;
...
class NoteLimits : public virtual ::apache::thrift::TBase {
  public:
    NoteLimits(const NoteLimits &);
    NoteLimits &operator=(const NoteLimits &);
    NoteLimits()
        : noteResourceCountMax(0), uploadLimit(0), resourceSizeMax(0),
          noteSizeMax(0), uploaded(0) {}
    ...
    bool operator!=(const NoteLimits &rhs) const { return !(*this == rhs); }
...
typedef struct _Note__isset {
    _Note__isset()
        : guid(false), title(false), content(false), contentHash(false),
          contentLength(false), created(false), updated(false), deleted(false),
          active(false), updateSequenceNum(false), notebookGuid(false),
          tagGuids(false), resources(false), attributes(false), tagNames(false),
          sharedNotes(false), restrictions(false), limits(false) {}
    bool guid : 1;
    bool title : 1;
    bool content : 1;
    bool contentHash : 1;
...
class Note : public virtual ::apache::thrift::TBase {
  public:
    Note(const Note &);
    Note &operator=(const Note &);
    Note()
        : guid(), title(), content(), contentHash(), contentLength(0),
          created(0), updated(0), deleted(0), active(0), updateSequenceNum(0),
          notebookGuid() {}
...
typedef struct _Publishing__isset {
    _Publishing__isset()
        : uri(false), order(false), ascending(false), publicDescription(false) {
    }
    bool uri : 1;
    bool order : 1;
    bool ascending : 1;
...
class Publishing : public virtual ::apache::thrift::TBase {
  public:
    Publishing(const Publishing &);
    Publishing &operator=(const Publishing &);
    Publishing()
        : uri(), order((NoteSortOrder::type)0), ascending(0),
          publicDescription() {}
    ...
    bool operator==(const Publishing &rhs) const {
        ...
        if (__isset.publicDescription != rhs.__isset.publicDescription)
            return false;
        else if (__isset.publicDescription &&
                 !(publicDescription == rhs.publicDescription))
            return false;
        return true;
    }
    bool operator!=(const Publishing &rhs) const { return !(*this == rhs); }
...
typedef struct _BusinessNotebook__isset {
    _BusinessNotebook__isset()
        : notebookDescription(false), privilege(false), recommended(false) {}
    bool notebookDescription : 1;
    bool privilege : 1;
    bool recommended : 1;
} _BusinessNotebook__isset;

class BusinessNotebook : public virtual ::apache::thrift::TBase {
  public:
    BusinessNotebook(const BusinessNotebook &);
    BusinessNotebook &operator=(const BusinessNotebook &);
    BusinessNotebook()
        : notebookDescription(),
          privilege((SharedNotebookPrivilegeLevel::type)0), recommended(0) {}
    ...
    bool operator==(const BusinessNotebook &rhs) const {
        if (__isset.notebookDescription != rhs.__isset.notebookDescription)
            return false;
        else if (__isset.notebookDescription &&
                 !(notebookDescription == rhs.notebookDescription))
            return false;
        if (__isset.privilege != rhs.__isset.privilege)
            return false;
        else if (__isset.privilege && !(privilege == rhs.privilege))
...
typedef struct _SavedSearchScope__isset {
    _SavedSearchScope__isset()
        : includeAccount(false), includePersonalLinkedNotebooks(false),
...
class SavedSearchScope : public virtual ::apache::thrift::TBase {
  public:
    SavedSearchScope(const SavedSearchScope &);
    SavedSearchScope &operator=(const SavedSearchScope &);
    SavedSearchScope()
        : includeAccount(0), includePersonalLinkedNotebooks(0),
          includeBusinessLinkedNotebooks(0) {}
    ...
    bool operator==(const SavedSearchScope &rhs) const {
        if (__isset.includeAccount != rhs.__isset.includeAccount)
            return false;
        else if (__isset.includeAccount &&
                 !(includeAccount == rhs.includeAccount))
            return false;
        if (__isset.includePersonalLinkedNotebooks !=
            rhs.__isset.includePersonalLinkedNotebooks)
            return false;
        else if (__isset.includePersonalLinkedNotebooks &&
                 !(includePersonalLinkedNotebooks ==
                   rhs.includePersonalLinkedNotebooks))
            return false;
        if (__isset.includeBusinessLinkedNotebooks !=
            rhs.__isset.includeBusinessLinkedNotebooks)
            return false;
        else if (__isset.includeBusinessLinkedNotebooks &&
                 !(includeBusinessLinkedNotebooks ==
                   rhs.includeBusinessLinkedNotebooks))
            return false;
        return true;
    }
    bool operator!=(const SavedSearchScope &rhs) const {
...
typedef struct _SavedSearch__isset {
    _SavedSearch__isset()
        : guid(false), name(false), query(false), format(false),
          updateSequenceNum(false), scope(false) {}
    bool guid : 1;
    bool name : 1;
    bool query : 1;
    bool format : 1;
...
class SavedSearch : public virtual ::apache::thrift::TBase {
  public:
    SavedSearch(const SavedSearch &);
    SavedSearch &operator=(const SavedSearch &);
    SavedSearch()
        : guid(), name(), query(), format((QueryFormat::type)0),
          updateSequenceNum(0) {}
    ...
    bool operator!=(const SavedSearch &rhs) const { return !(*this == rhs); }
...
typedef struct _SharedNotebookRecipientSettings__isset {
    _SharedNotebookRecipientSettings__isset()
        : reminderNotifyEmail(false), reminderNotifyInApp(false) {}
    bool reminderNotifyEmail : 1;
    bool reminderNotifyInApp : 1;
} _SharedNotebookRecipientSettings__isset;

class SharedNotebookRecipientSettings : public virtual ::apache::thrift::TBase {
  public:
    SharedNotebookRecipientSettings(const SharedNotebookRecipientSettings &);
    SharedNotebookRecipientSettings &
    operator=(const SharedNotebookRecipientSettings &);
    SharedNotebookRecipientSettings()
        : reminderNotifyEmail(0), reminderNotifyInApp(0) {}
    ...
    bool operator==(const SharedNotebookRecipientSettings &rhs) const {
        if (__isset.reminderNotifyEmail != rhs.__isset.reminderNotifyEmail)
            return false;
        else if (__isset.reminderNotifyEmail &&
                 !(reminderNotifyEmail == rhs.reminderNotifyEmail))
            return false;
        if (__isset.reminderNotifyInApp != rhs.__isset.reminderNotifyInApp)
            return false;
        else if (__isset.reminderNotifyInApp &&
                 !(reminderNotifyInApp == rhs.reminderNotifyInApp))
            return false;
        return true;
    }
    bool operator!=(const SharedNotebookRecipientSettings &rhs) const {
...
typedef struct _NotebookRecipientSettings__isset {
    _NotebookRecipientSettings__isset()
        : reminderNotifyEmail(false), reminderNotifyInApp(false),
          inMyList(false), stack(false), recipientStatus(false) {}
    bool reminderNotifyEmail : 1;
    bool reminderNotifyInApp : 1;
    bool inMyList : 1;
    bool stack : 1;
    bool recipientStatus : 1;
} _NotebookRecipientSettings__isset;

class NotebookRecipientSettings : public virtual ::apache::thrift::TBase {
  public:
    ...
    NotebookRecipientSettings()
        : reminderNotifyEmail(0), reminderNotifyInApp(0), inMyList(0), stack(),
          recipientStatus((RecipientStatus::type)0) {}
    ...
    void __set_recipientStatus(const RecipientStatus::type val);
    ...
    bool operator==(const NotebookRecipientSettings &rhs) const {
        ...
        if (__isset.stack != rhs.__isset.stack)
            ...
            return false;
        if (__isset.recipientStatus != rhs.__isset.recipientStatus)
            return false;
        else if (__isset.recipientStatus &&
                 !(recipientStatus == rhs.recipientStatus))
            return false;
        return true;
    }
    bool operator!=(const NotebookRecipientSettings &rhs) const {
...
typedef struct _SharedNotebook__isset {
    _SharedNotebook__isset()
        : id(false), userId(false), notebookGuid(false), email(false),
          recipientIdentityId(false), notebookModifiable(false),
          serviceCreated(false), serviceUpdated(false), globalId(false),
          username(false), privilege(false), recipientSettings(false),
          sharerUserId(false), recipientUsername(false), recipientUserId(false),
...
class SharedNotebook : public virtual ::apache::thrift::TBase {
  public:
    SharedNotebook(const SharedNotebook &);
    SharedNotebook &operator=(const SharedNotebook &);
    SharedNotebook()
        : id(0), userId(0), notebookGuid(), email(), recipientIdentityId(0),
          notebookModifiable(0), serviceCreated(0), serviceUpdated(0),
          globalId(), username(),
          privilege((SharedNotebookPrivilegeLevel::type)0), sharerUserId(0),
          recipientUsername(), recipientUserId(0), serviceAssigned(0) {}
    ...
    bool operator==(const SharedNotebook &rhs) const {
        ...
        if (__isset.recipientIdentityId != rhs.__isset.recipientIdentityId)
            return false;
        else if (__isset.recipientIdentityId &&
                 !(recipientIdentityId == rhs.recipientIdentityId))
            return false;
        if (__isset.notebookModifiable != rhs.__isset.notebookModifiable)
            return false;
        else if (__isset.notebookModifiable &&
                 !(notebookModifiable == rhs.notebookModifiable))
            return false;
        if (__isset.serviceCreated != rhs.__isset.serviceCreated)
            return false;
        else if (__isset.serviceCreated &&
        ...
        if (__isset.recipientSettings != rhs.__isset.recipientSettings)
            return false;
        else if (__isset.recipientSettings &&
                 !(recipientSettings == rhs.recipientSettings))
            return false;
        if (__isset.sharerUserId != rhs.__isset.sharerUserId)
            return false;
        else if (__isset.sharerUserId && !(sharerUserId == rhs.sharerUserId))
        ...
        if (__isset.recipientUsername != rhs.__isset.recipientUsername)
            return false;
        else if (__isset.recipientUsername &&
                 !(recipientUsername == rhs.recipientUsername))
            return false;
        if (__isset.recipientUserId != rhs.__isset.recipientUserId)
            return false;
        else if (__isset.recipientUserId &&
                 !(recipientUserId == rhs.recipientUserId))
            return false;
        if (__isset.serviceAssigned != rhs.__isset.serviceAssigned)
            return false;
        else if (__isset.serviceAssigned &&
    ...
    bool operator!=(const SharedNotebook &rhs) const { return !(*this == rhs); }
...
typedef struct _CanMoveToContainerRestrictions__isset {
    _CanMoveToContainerRestrictions__isset() : canMoveToContainer(false) {}
    bool canMoveToContainer : 1;
} _CanMoveToContainerRestrictions__isset;

class CanMoveToContainerRestrictions : public virtual ::apache::thrift::TBase {
  public:
    CanMoveToContainerRestrictions(const CanMoveToContainerRestrictions &);
    CanMoveToContainerRestrictions &
    operator=(const CanMoveToContainerRestrictions &);
    CanMoveToContainerRestrictions()
        : canMoveToContainer((CanMoveToContainerStatus::type)0) {}

    virtual ~CanMoveToContainerRestrictions() throw();
    CanMoveToContainerStatus::type canMoveToContainer;

    _CanMoveToContainerRestrictions__isset __isset;

    void __set_canMoveToContainer(const CanMoveToContainerStatus::type val);

    bool operator==(const CanMoveToContainerRestrictions &rhs) const {
        if (__isset.canMoveToContainer != rhs.__isset.canMoveToContainer)
            return false;
        else if (__isset.canMoveToContainer &&
                 !(canMoveToContainer == rhs.canMoveToContainer))
            return false;
        return true;
    }
    bool operator!=(const CanMoveToContainerRestrictions &rhs) const {
    ...
    bool operator<(const CanMoveToContainerRestrictions &) const;
...
void swap(CanMoveToContainerRestrictions &a, CanMoveToContainerRestrictions &b);
...
typedef struct _NotebookRestrictions__isset {
    _NotebookRestrictions__isset()
        : noReadNotes(false), noCreateNotes(false), noUpdateNotes(false),
          noExpungeNotes(false), noShareNotes(false), noEmailNotes(false),
          noSendMessageToRecipients(false), noUpdateNotebook(false),
          noExpungeNotebook(false), noSetDefaultNotebook(false),
          noSetNotebookStack(false), noPublishToPublic(false),
          noPublishToBusinessLibrary(false), noCreateTags(false),
          noUpdateTags(false), noExpungeTags(false), noSetParentTag(false),
          noCreateSharedNotebooks(false),
          updateWhichSharedNotebookRestrictions(false),
          expungeWhichSharedNotebookRestrictions(false),
          noShareNotesWithBusiness(false), noRenameNotebook(false),
          noSetInMyList(false), noChangeContact(false),
          canMoveToContainerRestrictions(false),
          noSetReminderNotifyEmail(false), noSetReminderNotifyInApp(false),
          noSetRecipientSettingsStack(false), noCanMoveNote(false) {}
    bool noReadNotes : 1;
    ...
    bool noSetInMyList : 1;
    bool noChangeContact : 1;
    bool canMoveToContainerRestrictions : 1;
    bool noSetReminderNotifyEmail : 1;
    bool noSetReminderNotifyInApp : 1;
    bool noSetRecipientSettingsStack : 1;
    bool noCanMoveNote : 1;
} _NotebookRestrictions__isset;

class NotebookRestrictions : public virtual ::apache::thrift::TBase {
  public:
    NotebookRestrictions(const NotebookRestrictions &);
    NotebookRestrictions &operator=(const NotebookRestrictions &);
    NotebookRestrictions()
        : noReadNotes(0), noCreateNotes(0), noUpdateNotes(0), noExpungeNotes(0),
          noShareNotes(0), noEmailNotes(0), noSendMessageToRecipients(0),
          noUpdateNotebook(0), noExpungeNotebook(0), noSetDefaultNotebook(0),
          noSetNotebookStack(0), noPublishToPublic(0),
          noPublishToBusinessLibrary(0), noCreateTags(0), noUpdateTags(0),
          noExpungeTags(0), noSetParentTag(0), noCreateSharedNotebooks(0),
          updateWhichSharedNotebookRestrictions(
              (SharedNotebookInstanceRestrictions::type)0),
          expungeWhichSharedNotebookRestrictions(
              (SharedNotebookInstanceRestrictions::type)0),
          noShareNotesWithBusiness(0), noRenameNotebook(0), noSetInMyList(0),
          noChangeContact(0), noSetReminderNotifyEmail(0),
          noSetReminderNotifyInApp(0), noSetRecipientSettingsStack(0),
          noCanMoveNote(0) {}
    ...
    bool noSetInMyList;
    bool noChangeContact;
    CanMoveToContainerRestrictions canMoveToContainerRestrictions;
    bool noSetReminderNotifyEmail;
    bool noSetReminderNotifyInApp;
    bool noSetRecipientSettingsStack;
    bool noCanMoveNote;
    ...
    void __set_updateWhichSharedNotebookRestrictions(
        const SharedNotebookInstanceRestrictions::type val);

    void __set_expungeWhichSharedNotebookRestrictions(
        const SharedNotebookInstanceRestrictions::type val);
    ...
    void __set_noSetInMyList(const bool val);

    void __set_noChangeContact(const bool val);

    void __set_canMoveToContainerRestrictions(
        const CanMoveToContainerRestrictions &val);

    void __set_noSetReminderNotifyEmail(const bool val);

    void __set_noSetReminderNotifyInApp(const bool val);

    void __set_noSetRecipientSettingsStack(const bool val);

    void __set_noCanMoveNote(const bool val);
    ...
    bool operator==(const NotebookRestrictions &rhs) const {
        ...
        if (__isset.noExpungeNotes != rhs.__isset.noExpungeNotes)
            return false;
        else if (__isset.noExpungeNotes &&
                 !(noExpungeNotes == rhs.noExpungeNotes))
            return false;
        ...
        if (__isset.noSendMessageToRecipients !=
            rhs.__isset.noSendMessageToRecipients)
            return false;
        else if (__isset.noSendMessageToRecipients &&
                 !(noSendMessageToRecipients == rhs.noSendMessageToRecipients))
            return false;
        if (__isset.noUpdateNotebook != rhs.__isset.noUpdateNotebook)
            return false;
        else if (__isset.noUpdateNotebook &&
                 !(noUpdateNotebook == rhs.noUpdateNotebook))
            return false;
        if (__isset.noExpungeNotebook != rhs.__isset.noExpungeNotebook)
            return false;
        else if (__isset.noExpungeNotebook &&
                 !(noExpungeNotebook == rhs.noExpungeNotebook))
            return false;
        if (__isset.noSetDefaultNotebook != rhs.__isset.noSetDefaultNotebook)
            return false;
        else if (__isset.noSetDefaultNotebook &&
                 !(noSetDefaultNotebook == rhs.noSetDefaultNotebook))
            return false;
        if (__isset.noSetNotebookStack != rhs.__isset.noSetNotebookStack)
            return false;
        else if (__isset.noSetNotebookStack &&
                 !(noSetNotebookStack == rhs.noSetNotebookStack))
            return false;
        if (__isset.noPublishToPublic != rhs.__isset.noPublishToPublic)
            return false;
        else if (__isset.noPublishToPublic &&
                 !(noPublishToPublic == rhs.noPublishToPublic))
            return false;
        if (__isset.noPublishToBusinessLibrary !=
            rhs.__isset.noPublishToBusinessLibrary)
            return false;
        else if (__isset.noPublishToBusinessLibrary &&
                 !(noPublishToBusinessLibrary ==
                   rhs.noPublishToBusinessLibrary))
            return false;
        ...
        if (__isset.noSetParentTag != rhs.__isset.noSetParentTag)
            return false;
        else if (__isset.noSetParentTag &&
                 !(noSetParentTag == rhs.noSetParentTag))
            return false;
        if (__isset.noCreateSharedNotebooks !=
            rhs.__isset.noCreateSharedNotebooks)
            return false;
        else if (__isset.noCreateSharedNotebooks &&
                 !(noCreateSharedNotebooks == rhs.noCreateSharedNotebooks))
            return false;
        if (__isset.updateWhichSharedNotebookRestrictions !=
            rhs.__isset.updateWhichSharedNotebookRestrictions)
            return false;
        else if (__isset.updateWhichSharedNotebookRestrictions &&
                 !(updateWhichSharedNotebookRestrictions ==
                   rhs.updateWhichSharedNotebookRestrictions))
            return false;
        if (__isset.expungeWhichSharedNotebookRestrictions !=
            rhs.__isset.expungeWhichSharedNotebookRestrictions)
            return false;
        else if (__isset.expungeWhichSharedNotebookRestrictions &&
                 !(expungeWhichSharedNotebookRestrictions ==
                   rhs.expungeWhichSharedNotebookRestrictions))
            return false;
        if (__isset.noShareNotesWithBusiness !=
            rhs.__isset.noShareNotesWithBusiness)
            return false;
        else if (__isset.noShareNotesWithBusiness &&
                 !(noShareNotesWithBusiness == rhs.noShareNotesWithBusiness))
            return false;
        if (__isset.noRenameNotebook != rhs.__isset.noRenameNotebook)
            return false;
        else if (__isset.noRenameNotebook &&
                 !(noRenameNotebook == rhs.noRenameNotebook))
            return false;
        if (__isset.noSetInMyList != rhs.__isset.noSetInMyList)
            return false;
        else if (__isset.noSetInMyList && !(noSetInMyList == rhs.noSetInMyList))
            return false;
        if (__isset.noChangeContact != rhs.__isset.noChangeContact)
            return false;
        else if (__isset.noChangeContact &&
                 !(noChangeContact == rhs.noChangeContact))
            return false;
        if (__isset.canMoveToContainerRestrictions !=
            rhs.__isset.canMoveToContainerRestrictions)
            return false;
        else if (__isset.canMoveToContainerRestrictions &&
                 !(canMoveToContainerRestrictions ==
                   rhs.canMoveToContainerRestrictions))
            return false;
        if (__isset.noSetReminderNotifyEmail !=
            rhs.__isset.noSetReminderNotifyEmail)
            return false;
        else if (__isset.noSetReminderNotifyEmail &&
                 !(noSetReminderNotifyEmail == rhs.noSetReminderNotifyEmail))
            return false;
        if (__isset.noSetReminderNotifyInApp !=
            rhs.__isset.noSetReminderNotifyInApp)
            return false;
        else if (__isset.noSetReminderNotifyInApp &&
                 !(noSetReminderNotifyInApp == rhs.noSetReminderNotifyInApp))
            return false;
        if (__isset.noSetRecipientSettingsStack !=
            rhs.__isset.noSetRecipientSettingsStack)
            return false;
        else if (__isset.noSetRecipientSettingsStack &&
                 !(noSetRecipientSettingsStack ==
                   rhs.noSetRecipientSettingsStack))
            return false;
        if (__isset.noCanMoveNote != rhs.__isset.noCanMoveNote)
            return false;
        else if (__isset.noCanMoveNote && !(noCanMoveNote == rhs.noCanMoveNote))
            return false;
        return true;
    }
    bool operator!=(const NotebookRestrictions &rhs) const {
...
typedef struct _Notebook__isset {
    _Notebook__isset()
        : guid(false), name(false), updateSequenceNum(false),
          defaultNotebook(false), serviceCreated(false), serviceUpdated(false),
          publishing(false), published(false), stack(false),
          sharedNotebookIds(false), sharedNotebooks(false),
          businessNotebook(false), contact(false), restrictions(false),
          recipientSettings(false) {}
    bool guid : 1;
    bool name : 1;
    bool updateSequenceNum : 1;
...
class Notebook : public virtual ::apache::thrift::TBase {
  public:
    Notebook(const Notebook &);
    Notebook &operator=(const Notebook &);
    Notebook()
        : guid(), name(), updateSequenceNum(0), defaultNotebook(0),
          serviceCreated(0), serviceUpdated(0), published(0), stack() {}
    ...
    bool operator==(const Notebook &rhs) const {
        ...
        if (__isset.defaultNotebook != rhs.__isset.defaultNotebook)
            return false;
        else if (__isset.defaultNotebook &&
                 !(defaultNotebook == rhs.defaultNotebook))
            return false;
        if (__isset.serviceCreated != rhs.__isset.serviceCreated)
            return false;
        else if (__isset.serviceCreated &&
        ...
        if (__isset.sharedNotebookIds != rhs.__isset.sharedNotebookIds)
            return false;
        else if (__isset.sharedNotebookIds &&
                 !(sharedNotebookIds == rhs.sharedNotebookIds))
            return false;
        if (__isset.sharedNotebooks != rhs.__isset.sharedNotebooks)
            return false;
        else if (__isset.sharedNotebooks &&
                 !(sharedNotebooks == rhs.sharedNotebooks))
            return false;
        if (__isset.businessNotebook != rhs.__isset.businessNotebook)
            return false;
        else if (__isset.businessNotebook &&
                 !(businessNotebook == rhs.businessNotebook))
            return false;
        if (__isset.contact != rhs.__isset.contact)
            return false;
        else if (__isset.contact && !(contact == rhs.contact))
    ...
    bool operator!=(const Notebook &rhs) const { return !(*this == rhs); }
    /* implement to comply with set */
...
typedef struct _LinkedNotebook__isset {
    _LinkedNotebook__isset()
        : shareName(false), username(false), shardId(false),
          sharedNotebookGlobalId(false), uri(false), guid(false),
          updateSequenceNum(false), noteStoreUrl(false), webApiUrlPrefix(false),
          stack(false), businessId(false) {}
    bool shareName : 1;
    bool username : 1;
    bool shardId : 1;
...
class LinkedNotebook : public virtual ::apache::thrift::TBase {
  public:
    LinkedNotebook(const LinkedNotebook &);
    LinkedNotebook &operator=(const LinkedNotebook &);
    LinkedNotebook()
        : shareName(), username(), shardId(), sharedNotebookGlobalId(), uri(),
          guid(), updateSequenceNum(0), noteStoreUrl(), webApiUrlPrefix(),
          stack(), businessId(0) {}
    ...
    bool operator==(const LinkedNotebook &rhs) const {
        ...
        if (__isset.shardId != rhs.__isset.shardId)
            ...
            return false;
        if (__isset.sharedNotebookGlobalId !=
            rhs.__isset.sharedNotebookGlobalId)
            return false;
        else if (__isset.sharedNotebookGlobalId &&
                 !(sharedNotebookGlobalId == rhs.sharedNotebookGlobalId))
            return false;
        if (__isset.uri != rhs.__isset.uri)
            return false;
        else if (__isset.uri && !(uri == rhs.uri))
        ...
        if (__isset.webApiUrlPrefix != rhs.__isset.webApiUrlPrefix)
            return false;
        else if (__isset.webApiUrlPrefix &&
                 !(webApiUrlPrefix == rhs.webApiUrlPrefix))
            return false;
        if (__isset.stack != rhs.__isset.stack)
            return false;
        else if (__isset.stack && !(stack == rhs.stack))
    ...
    bool operator!=(const LinkedNotebook &rhs) const { return !(*this == rhs); }
...
typedef struct _NotebookDescriptor__isset {
    _NotebookDescriptor__isset()
        : guid(false), notebookDisplayName(false), contactName(false),
          hasSharedNotebook(false), joinedUserCount(false) {}
    bool guid : 1;
...
class NotebookDescriptor : public virtual ::apache::thrift::TBase {
  public:
    NotebookDescriptor(const NotebookDescriptor &);
    NotebookDescriptor &operator=(const NotebookDescriptor &);
    NotebookDescriptor()
        : guid(), notebookDisplayName(), contactName(), hasSharedNotebook(0),
          joinedUserCount(0) {}
    ...
    bool operator==(const NotebookDescriptor &rhs) const {
        ...
        if (__isset.notebookDisplayName != rhs.__isset.notebookDisplayName)
            return false;
        else if (__isset.notebookDisplayName &&
                 !(notebookDisplayName == rhs.notebookDisplayName))
            return false;
        ...
        if (__isset.hasSharedNotebook != rhs.__isset.hasSharedNotebook)
            return false;
        else if (__isset.hasSharedNotebook &&
                 !(hasSharedNotebook == rhs.hasSharedNotebook))
            return false;
        if (__isset.joinedUserCount != rhs.__isset.joinedUserCount)
            return false;
        else if (__isset.joinedUserCount &&
                 !(joinedUserCount == rhs.joinedUserCount))
            return false;
        return true;
    }
    bool operator!=(const NotebookDescriptor &rhs) const {
...
typedef struct _UserProfile__isset {
    _UserProfile__isset()
        : id(false), name(false), email(false), username(false),
          attributes(false), joined(false), photoLastUpdated(false),
          photoUrl(false), role(false), status(false) {}
    bool id : 1;
    bool name : 1;
    bool email : 1;
    bool username : 1;
...
class UserProfile : public virtual ::apache::thrift::TBase {
  public:
    ...
    UserProfile()
        : id(0), name(), email(), username(), joined(0), photoLastUpdated(0),
          photoUrl(), role((BusinessUserRole::type)0),
          status((BusinessUserStatus::type)0) {}
    ...
    std::string photoUrl;
    BusinessUserRole::type role;
    BusinessUserStatus::type status;
    ...
    void __set_status(const BusinessUserStatus::type val);
    ...
    bool operator!=(const UserProfile &rhs) const { return !(*this == rhs); }
...
typedef struct _RelatedContentImage__isset {
    _RelatedContentImage__isset()
        : url(false), width(false), height(false), pixelRatio(false),
          fileSize(false) {}
    bool url : 1;
    bool width : 1;
    bool height : 1;
...
class RelatedContentImage : public virtual ::apache::thrift::TBase {
  public:
    RelatedContentImage(const RelatedContentImage &);
    RelatedContentImage &operator=(const RelatedContentImage &);
    RelatedContentImage()
        : url(), width(0), height(0), pixelRatio(0), fileSize(0) {}
...
typedef struct _RelatedContent__isset {
    _RelatedContent__isset()
        : contentId(false), title(false), url(false), sourceId(false),
          sourceUrl(false), sourceFaviconUrl(false), sourceName(false),
          date(false), teaser(false), thumbnails(false), contentType(false),
          accessType(false), visibleUrl(false), clipUrl(false), contact(false),
          authors(false) {}
    bool contentId : 1;
    bool title : 1;
    bool url : 1;
...
class RelatedContent : public virtual ::apache::thrift::TBase {
  public:
    RelatedContent(const RelatedContent &);
    RelatedContent &operator=(const RelatedContent &);
    RelatedContent()
        : contentId(), title(), url(), sourceId(), sourceUrl(),
          sourceFaviconUrl(), sourceName(), date(0), teaser(),
          contentType((RelatedContentType::type)0),
          accessType((RelatedContentAccess::type)0), visibleUrl(), clipUrl() {}
    ...
    bool operator==(const RelatedContent &rhs) const {
        ...
        if (__isset.sourceFaviconUrl != rhs.__isset.sourceFaviconUrl)
            return false;
        else if (__isset.sourceFaviconUrl &&
                 !(sourceFaviconUrl == rhs.sourceFaviconUrl))
            return false;
    ...
    bool operator!=(const RelatedContent &rhs) const { return !(*this == rhs); }
...
typedef struct _BusinessInvitation__isset {
    _BusinessInvitation__isset()
        : businessId(false), email(false), role(false), status(false),
          requesterId(false), fromWorkChat(false), created(false),
          mostRecentReminder(false) {}
    bool businessId : 1;
    bool email : 1;
    bool role : 1;
    bool status : 1;
    ...
    bool fromWorkChat : 1;
    bool created : 1;
    bool mostRecentReminder : 1;
} _BusinessInvitation__isset;

class BusinessInvitation : public virtual ::apache::thrift::TBase {
  public:
    BusinessInvitation(const BusinessInvitation &);
    BusinessInvitation &operator=(const BusinessInvitation &);
    BusinessInvitation()
        : businessId(0), email(), role((BusinessUserRole::type)0),
          status((BusinessInvitationStatus::type)0), requesterId(0),
          fromWorkChat(0), created(0), mostRecentReminder(0) {}
    ...
    void __set_mostRecentReminder(const Timestamp val);
    ...
    bool operator==(const BusinessInvitation &rhs) const {
        ...
        if (__isset.created != rhs.__isset.created)
            ...
            return false;
        if (__isset.mostRecentReminder != rhs.__isset.mostRecentReminder)
            return false;
        else if (__isset.mostRecentReminder &&
                 !(mostRecentReminder == rhs.mostRecentReminder))
            return false;
        return true;
    }
    bool operator!=(const BusinessInvitation &rhs) const {
...
typedef struct _UserIdentity__isset {
    _UserIdentity__isset()
        : type(false), stringIdentifier(false), longIdentifier(false) {}
    bool type : 1;
    bool stringIdentifier : 1;
    bool longIdentifier : 1;
} _UserIdentity__isset;

class UserIdentity : public virtual ::apache::thrift::TBase {
  public:
    UserIdentity(const UserIdentity &);
    UserIdentity &operator=(const UserIdentity &);
    UserIdentity()
        : type((UserIdentityType::type)0), stringIdentifier(),
          longIdentifier(0) {}
    ...
    bool operator==(const UserIdentity &rhs) const {
        ...
        if (__isset.stringIdentifier != rhs.__isset.stringIdentifier)
            return false;
        else if (__isset.stringIdentifier &&
                 !(stringIdentifier == rhs.stringIdentifier))
            return false;
        if (__isset.longIdentifier != rhs.__isset.longIdentifier)
            return false;
        else if (__isset.longIdentifier &&
                 !(longIdentifier == rhs.longIdentifier))
            return false;
        return true;
    }
    bool operator!=(const UserIdentity &rhs) const { return !(*this == rhs); }
