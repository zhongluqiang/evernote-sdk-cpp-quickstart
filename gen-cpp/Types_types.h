...
extern const std::map<int, const char*> _CanMoveToContainerStatus_VALUES_TO_NAMES;
 ...
 public:
  ...
  bool operator == (const UserAttributes & rhs) const
  {
    ...
    if (__isset.optOutMachineLearning != rhs.__isset.optOutMachineLearning)
      return false;
    else if (__isset.optOutMachineLearning && !(optOutMachineLearning == rhs.optOutMachineLearning))
      return false;
    return true;
  }
  bool operator != (const UserAttributes &rhs) const {
...
typedef struct _NotebookRecipientSettings__isset {
  _NotebookRecipientSettings__isset() : reminderNotifyEmail(false), reminderNotifyInApp(false), inMyList(false), stack(false), recipientStatus(false) {}
  bool reminderNotifyEmail :1;
  bool reminderNotifyInApp :1;
  bool inMyList :1;
  bool stack :1;
...
class NotebookRecipientSettings : public virtual ::apache::thrift::TBase {
 public:
  ...
  NotebookRecipientSettings() : reminderNotifyEmail(0), reminderNotifyInApp(0), inMyList(0), stack(), recipientStatus((RecipientStatus::type)0) {
  }
  ...
  bool operator == (const NotebookRecipientSettings & rhs) const
  {
    ...
    if (__isset.recipientStatus != rhs.__isset.recipientStatus)
      return false;
    else if (__isset.recipientStatus && !(recipientStatus == rhs.recipientStatus))
      return false;
    return true;
  }
  bool operator != (const NotebookRecipientSettings &rhs) const {
...
class CanMoveToContainerRestrictions : public virtual ::apache::thrift::TBase {
 public:
  ...
  CanMoveToContainerRestrictions& operator=(const CanMoveToContainerRestrictions&);
  CanMoveToContainerRestrictions() : canMoveToContainer((CanMoveToContainerStatus::type)0) {
  }
  ...
  bool operator == (const CanMoveToContainerRestrictions & rhs) const
  {
    if (__isset.canMoveToContainer != rhs.__isset.canMoveToContainer)
      return false;
    else if (__isset.canMoveToContainer && !(canMoveToContainer == rhs.canMoveToContainer))
      return false;
    return true;
  }
  bool operator != (const CanMoveToContainerRestrictions &rhs) const {
...
class NotebookRestrictions : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_canMoveToContainerRestrictions(const CanMoveToContainerRestrictions& val);
  ...
  bool operator == (const NotebookRestrictions & rhs) const
  {
    ...
    if (__isset.noChangeContact != rhs.__isset.noChangeContact)
      return false;
    else if (__isset.noChangeContact && !(noChangeContact == rhs.noChangeContact))
      return false;
    if (__isset.canMoveToContainerRestrictions != rhs.__isset.canMoveToContainerRestrictions)
      return false;
    else if (__isset.canMoveToContainerRestrictions && !(canMoveToContainerRestrictions == rhs.canMoveToContainerRestrictions))
      return false;
    if (__isset.noSetReminderNotifyEmail != rhs.__isset.noSetReminderNotifyEmail)
      return false;
    else if (__isset.noSetReminderNotifyEmail && !(noSetReminderNotifyEmail == rhs.noSetReminderNotifyEmail))
      return false;
    if (__isset.noSetReminderNotifyInApp != rhs.__isset.noSetReminderNotifyInApp)
      return false;
    else if (__isset.noSetReminderNotifyInApp && !(noSetReminderNotifyInApp == rhs.noSetReminderNotifyInApp))
      return false;
    if (__isset.noSetRecipientSettingsStack != rhs.__isset.noSetRecipientSettingsStack)
      return false;
    else if (__isset.noSetRecipientSettingsStack && !(noSetRecipientSettingsStack == rhs.noSetRecipientSettingsStack))
      return false;
...
typedef struct _UserProfile__isset {
  _UserProfile__isset() : id(false), name(false), email(false), username(false), attributes(false), joined(false), photoLastUpdated(false), photoUrl(false), role(false), status(false) {}
  bool id :1;
  bool name :1;
  bool email :1;
  bool username :1;
...
class UserProfile : public virtual ::apache::thrift::TBase {
 public:
  ...
  UserProfile() : id(0), name(), email(), username(), joined(0), photoLastUpdated(0), photoUrl(), role((BusinessUserRole::type)0), status((BusinessUserStatus::type)0) {
  }
...
typedef struct _BusinessInvitation__isset {
  _BusinessInvitation__isset() : businessId(false), email(false), role(false), status(false), requesterId(false), fromWorkChat(false), created(false), mostRecentReminder(false) {}
  bool businessId :1;
  bool email :1;
  bool role :1;
  bool status :1;
...
class BusinessInvitation : public virtual ::apache::thrift::TBase {
 public:
  ...
  BusinessInvitation() : businessId(0), email(), role((BusinessUserRole::type)0), status((BusinessInvitationStatus::type)0), requesterId(0), fromWorkChat(0), created(0), mostRecentReminder(0) {
  }
  ...
  bool operator == (const BusinessInvitation & rhs) const
  {
    ...
    if (__isset.mostRecentReminder != rhs.__isset.mostRecentReminder)
      return false;
    else if (__isset.mostRecentReminder && !(mostRecentReminder == rhs.mostRecentReminder))
      return false;
    return true;
  }
  bool operator != (const BusinessInvitation &rhs) const {
